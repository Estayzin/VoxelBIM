 ...
 */
const Bs = globalThis, qo = Bs.ShadowRoot && (Bs.ShadyCSS === void 0 || Bs.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Yo = Symbol(), Kr = /* @__PURE__ */ new WeakMap();
let uc = class {
  constructor(t, e, s) {
...
const Bd = (i) => new uc(typeof i == "string" ? i : i + "", void 0, Yo), H = (i, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: jd, defineProperty: Hd, getOwnPropertyDescriptor: Nd, getOwnPropertyNames: Vd, getOwnPropertySymbols: Wd, getPrototypeOf: Ud } = Object, he = globalThis, Zr = he.trustedTypes, qd = Zr ? Zr.emptyScript : "", Fn = he.reactiveElementPolyfillSupport, Ri = (i, t) => i, Qs = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? qd : null;
      break;
...
Ze.elementStyles = [], Ze.shadowRootOptions = { mode: "open" }, Ze[Ri("elementProperties")] = /* @__PURE__ */ new Map(), Ze[Ri("finalized")] = /* @__PURE__ */ new Map(), Fn == null || Fn({ ReactiveElement: Ze }), (he.reactiveElementVersions ?? (he.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const Vn = /* @__PURE__ */ new WeakMap(), Bt = yc(class extends lu {
  render(i) {
    return V;
  }
  update(i, [t]) {
...
const Fu = /(-?[0-9.]*[0-9]+[0-9.]*)/g, ju = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function go(i, t, e) {
  if (t === 1)
    return i;
...
const Jo = (ot = class extends B {
  ...
  async updatePosition() {
    ...
    const t = this.placement ?? "right", e = await Uo(this._previousContainer, this, {
      placement: t,
      middleware: [Fo(10), Wo(), Vo(), No({ padding: 5 })]
    }), { x: s, y: n } = e;
    ...
    super(), this.labelHidden = !1, this.active = !1, this.disabled = !1, this.vertical = !1, this.tooltipVisible = !1, this._stateBeforeLoading = {
      ...
      if (t) {
        ...
        for (const n of t.children)
          n instanceof Fe && n.setAttribute("data-context-group", s);
        t.visible = !0;
      }
    }, this.mouseLeave = !0;
  }
      ...
      for (const e of Hs.dialog.children) {
        ...
        if (e instanceof Hs && s === t) {
          ...
          for (const n of e.children)
            n instanceof Fe && (n.closeNestedContexts(), n.removeAttribute("data-context-group"));
        }
      }
  }
  click() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const jc = "important", Bf = " !" + jc, vo = yc(class extends vc {
  constructor(i) {
    var t;
...
const ut = (mi = class extends B {
  constructor() {
    ...
    >`, this._stringFilterFunction = (t, e) => Object.values(e.data).some((n) => String(n).toLowerCase().includes(t.toLowerCase())), this._queryFilterFunction = (t, e) => {
      ...
      return s;
    }, this.selection.onItemAdded.add((t) => this.emitDataSelected({ data: t })), this.selection.onItemDeleted.add(
...
let _s;
function jp(i) {
  _s || (_s = Fp(), _s.transparent = [0, 0, 0, 0]);
...
const F = Math.PI, G = 2 * F, tg = G + F, dn = Number.POSITIVE_INFINITY, eg = F / 180, it = F / 2, Pe = F / 4, $a = F * 2 / 3, re = Math.log10, Lt = Math.sign;
function Fi(i, t, e) {
  ...
  if (!(isNaN(g) || g <= 0)) {
    switch (i.beginPath(), f) {
      ...
      case "triangle":
        ...
        break;
      case "rectRounded":
        c = g * 0.516, l = g - c, r = Math.cos(m + Pe) * l, d = Math.cos(m + Pe) * (n ? n / 2 - c : l), a = Math.sin(m + Pe) * l, u = Math.sin(m + Pe) * (n ? n / 2 - c : l), i.arc(e - d, s - a, c, m - F, m - it), i.arc(e + u, s - r, c, m - it, m), i.arc(e + d, s + a, c, m, m + it), i.arc(e - u, s + r, c, m + it, m + F), i.closePath();
        break;
      case "rect":
        if (!p) {
...
function pr(i, t, e, s) {
  ...
  return l === null || typeof o < "u" && o !== e && (l = Fa(a, r, o, l, s), l === null) ? !1 : ur(Array.from(a), [
    ""
  ], n, o, () => Bg(t, e, s));
}
...
function gn(i, t, e, s, n, o) {
  ...
  const g = Math.max(1e-3, p * d - e / F) / d, m = (p - g) / 2, b = l + m + f, y = n - m - f, { outerStart: x, outerEnd: w, innerStart: _, innerEnd: S } = Kb(t, u, d, y - b), k = d - x, M = d - w, E = b + x / k, P = y - w / M, $ = u + _, T = u + S, Q = b + _ / $, Z = y - S / T;
  if (i.beginPath(), o) {
    const L = (E + P) / 2;
...
class yr extends ee {
  ...
  _drawArgs(t) {
    ...
    let l = 0, c, h, d;
    return this.isHorizontal() ? (h = ct(a, s, o), d = e + t, c = o - s) : (r.position === "left" ? (h = s + t, d = ct(a, n, e), l = F * -0.5) : (h = o - t, d = ct(a, e, n), l = F * 0.5), c = n - e), {
      titleX: h,
      titleY: d,
      maxWidth: c,
      rotation: l
...
function uv(i, t) {
  ...
  for (b && (u && k !== r ? (e.push({
    value: r
  }), k < r && $++, Fi(Math.round((k + $ * _) * S) / S, r, Bl(r, w, i)) && $++) : k < r && $++); $ < E; ++$) {
  ...
  return y && u && M !== a ? e.length && Fi(e[e.length - 1].value, a, Bl(a, w, i)) ? e[e.length - 1].value = a : e.push({
    value: a
  }) : (!y || M === a) && e.push({
    value: M
  }), e;
...
function Lv(i, t) {
  for (var e = i.x0, s = i.y0, n = i.x1, o = i.y1, r = Ts(e, s, t), a = Ts(n, o, t), l, c, h; !(!(r | a) || r & a); )
    l = r || a, l & Nh ? (c = e + (n - e) * (t.top - s) / (o - s), h = t.top) : l & Hh ? (c = e + (n - e) * (t.bottom - s) / (o - s), h = t.bottom) : l & jh ? (h = s + (o - s) * (t.right - e) / (n - e), c = t.right) : l & Fh && (h = s + (o - s) * (t.left - e) / (n - e), c = t.left), l === r ? (e = c, s = h, r = Ts(e, s, t)) : (n = c, o = h, a = Ts(n, o, t));
  return {
    x0: e,
    x1: n,
    y0: s,
...
const Bn = (rt = class extends B {
  ...
  async computePosition() {
    ...
    const { x: s, y: n } = await Uo(t, this, {
      ...
      middleware: [Fo(10), Vo(), No({ padding: 8 }), Wo()]
    });
