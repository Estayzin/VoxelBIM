import { $ as Object3D, B as LineBasicMaterial, H as LineSegments, M as Group, Ot as Vector2, g as BufferGeometry, h as BufferAttribute, j as Frustum, kt as Vector3, q as Matrix4, t as Gr$1, y as Color } from "./dist-_6R08cB9.js";
import { B as IfcLoader, D as FragmentsManager, K as OrthoPerspectiveCamera, O as Grids, ft as Viewpoints, it as SimpleScene, k as Hider, mt as Worlds, n as BCFTopics, rt as SimpleRenderer, st as Topic, v as DataMap } from "./dist-DNZ_D0nA.js";
import { Highlighter as li, RendererWith2D as qd$1 } from "./@thatopen_components-front.js";
...
*/
var yn = globalThis, Cr = yn.ShadowRoot && (yn.ShadyCSS === void 0 || yn.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ar = Symbol(), ba = /* @__PURE__ */ new WeakMap();
var jc = class {
	constructor(t, i, s) {
...
var Nu = (e) => new jc(typeof e == "string" ? e : e + "", void 0, Ar), Mr = (e, ...t) => {
	return new jc(e.length === 1 ? e[0] : t.reduce((s, n, o) => s + ((r) => {
		if (r._$cssResult$ === !0) return r.cssText;
		if (typeof r == "number") return r;
		throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
	})(n) + e[o + 1], e[0]), e, Ar);
}, Hu = (e, t) => {
	if (Cr) e.adoptedStyleSheets = t.map((i) => i instanceof CSSStyleSheet ? i : i.styleSheet);
...
}, ya = Cr ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
	let i = "";
...
* SPDX-License-Identifier: BSD-3-Clause
*/
var { is: Vu, defineProperty: Uu, getOwnPropertyDescriptor: Wu, getOwnPropertyNames: qu, getOwnPropertySymbols: Yu, getPrototypeOf: Gu } = Object, ke = globalThis, va = ke.trustedTypes, Xu = va ? va.emptyScript : "", wo = ke.reactiveElementPolyfillSupport, ts = (e, t) => e, Mn = {
	toAttribute(e, t) {
		switch (t) {
			case Boolean:
				e = e ? Xu : null;
...
var di = class extends HTMLElement {
	...
	static getPropertyDescriptor(t, i, s) {
		const { get: n, set: o } = Wu(this.prototype, t) ?? {
			get() {
				return this[i];
			},
			set(r) {
	...
	static _$Ei() {
		if (this.hasOwnProperty(ts("elementProperties"))) return;
		const t = Gu(this);
		t.finalize(), t.l !== void 0 && (this.l = [...t.l]), this.elementProperties = new Map(t.elementProperties);
	}
	static finalize() {
		if (this.hasOwnProperty(ts("finalized"))) return;
	...
	static finalizeStyles(t) {
		...
		if (Array.isArray(t)) {
			...
			for (const n of s) i.unshift(ya(n));
		} else t !== void 0 && i.push(ya(t));
		return i;
	}
	static _$Eu(t, i) {
		const s = i.attribute;
	...
	requestUpdate(t, i, s, n = !1, o) {
		...
		if (t !== void 0) {
			...
			if (n === !1 && (o = this[t]), s ?? (s = a.getPropertyOptions(t)), !((s.hasChanged ?? Er)(o, i) || s.useDefault && s.reflect && o === ((r = this._$Ej) == null ? void 0 : r.get(t)) && !this.hasAttribute(a._$Eu(t, s)))) return;
			this.C(t, i, s);
		}
...
di.elementStyles = [], di.shadowRootOptions = { mode: "open" }, di[ts("elementProperties")] = /* @__PURE__ */ new Map(), di[ts("finalized")] = /* @__PURE__ */ new Map(), wo?.({ ReactiveElement: di }), (ke.reactiveElementVersions ?? (ke.reactiveElementVersions = [])).push("2.1.2");
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
var es = globalThis, _a = (e) => e, En = es.trustedTypes, wa = En ? En.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Nc = "$lit$", ge = `lit$${Math.random().toFixed(9).slice(2)}$`, Hc = "?" + ge, Zu = `<${Hc}>`, ti = document, gs = () => ti.createComment(""), bs = (e) => e === null || typeof e != "object" && typeof e != "function", Tr = Array.isArray, Ku = (e) => Tr(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", ko = `[ 	
\f\r]`, ji = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ka = /-->/g, $a = />/g, ze = RegExp(`>|${ko}(?:([^\\s"'>=/]+)(${ko}*=${ko}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Sa = /'/g, Ca = /"/g, Vc = /^(?:script|style|textarea|title)$/i, Ju = (e) => (t, ...i) => ({
	_$litType$: e,
	strings: t,
	values: i
}), Pr = Ju(1), vi = Symbol.for("lit-noChange"), at = Symbol.for("lit-nothing"), Aa = /* @__PURE__ */ new WeakMap(), qe = ti.createTreeWalker(ti, 129);
function Uc(e, t) {
...
var Qu = (e, t) => {
	...
	for (let a = 0; a < i; a++) {
		const l = e[a];
		let c, h, d = -1, u = 0;
		for (; u < l.length && (r.lastIndex = u, h = r.exec(l), h !== null);) u = r.lastIndex, r === ji ? h[1] === "!--" ? r = ka : h[1] !== void 0 ? r = $a : h[2] !== void 0 ? (Vc.test(h[2]) && (n = RegExp("</" + h[2], "g")), r = ze) : h[3] !== void 0 && (r = ze) : r === ze ? h[0] === ">" ? (r = n ?? ji, d = -1) : h[1] === void 0 ? d = -2 : (d = r.lastIndex - h[2].length, c = h[1], r = h[3] === void 0 ? ze : h[3] === "\"" ? Ca : Sa) : r === Ca || r === Sa ? r = ze : r === ka || r === $a ? r = ji : (r = ze, n = void 0);
...
var ys = class ys {
	constructor({ strings: t, _$litType$: i }, s) {
		...
		for (; (n = qe.nextNode()) !== null && l.length < a;) {
			if (n.nodeType === 1) {
				if (n.hasAttributes()) for (const d of n.getAttributeNames()) if (d.endsWith(Nc)) {
					...
					l.push({
						...
						name: m[2],
						strings: p,
						ctor: m[1] === "." ? ep : m[1] === "?" ? ip : m[1] === "@" ? sp : Xn
					}), n.removeAttribute(d);
				} else d.startsWith(ge) && (l.push({
					type: 6,
					index: o
				}), n.removeAttribute(d));
				if (Vc.test(n.tagName)) {
					...
					if (u > 0) {
						...
						for (let p = 0; p < u; p++) n.append(d[p], gs()), qe.nextNode(), l.push({
							type: 2,
							index: ++o
						});
						n.append(d[u], gs());
			...
			} else if (n.nodeType === 8) if (n.data === Hc) l.push({
				type: 2,
				index: o
			});
			else {
				let d = -1;
				for (; (d = n.data.indexOf(ge, d + 1)) !== -1;) l.push({
					type: 7,
					index: o
				}), d += ge.length - 1;
			}
...
var Is = class Is {
	...
	k(t) {
		...
		const i = this._$AH;
		let s, n = 0;
		for (const o of t) n === i.length ? i.push(s = new Is(this.O(gs()), this.O(gs()), this, this.options)) : s = i[n], s._$AI(o), n++;
		n < i.length && (this._$AR(s && s._$AB.nextSibling, n), i.length = n);
	}
	_$AR(t = this._$AA.nextSibling, i) {
		var s;
		for ((s = this._$AP) == null || s.call(this, !1, !0, i); t !== this._$AB;) {
...
var Xn = class {
	...
	constructor(t, i, s, n, o) {
		this.type = 1, this._$AH = at, this._$AN = void 0, this.element = t, this.name = i, this._$AM = n, this.options = o, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(/* @__PURE__ */ new String()), this.strings = s) : this._$AH = at;
	}
	_$AI(t, i = this, s, n) {
		const o = this.strings;
		let r = !1;
		if (o === void 0) t = xi(this, t, i, 0), r = !bs(t) || t !== this._$AH && t !== vi, r && (this._$AH = t);
		else {
			const a = t;
			let l, c;
			for (t = o[0], l = 0; l < o.length - 1; l++) c = xi(this, a[s + l], i, l), c === vi && (c = this._$AH[l]), r || (r = !bs(c) || c !== this._$AH[l]), c === at ? t = at : t !== at && (t += (c ?? "") + o[l + 1]), this._$AH[l] = c;
		}
		r && !n && this.j(t);
	}
	j(t) {
...
var sp = class extends Xn {
	...
	_$AI(t, i = this) {
		if ((t = xi(this, t, i, 0) ?? at) === vi) return;
...
$o?.(ys, Is), (es.litHtmlVersions ?? (es.litHtmlVersions = [])).push("3.3.2");
var op = (e, t, i) => {
...
var So = Ze.litElementPolyfillSupport;
So?.({ LitElement: Ke });
...
var hp = class {
	constructor(t, i) {
		...
		this.grids = {
			main: s,
			secondary: n
		}, this._group.add(n, s, this.numbers);
	}
	set scaleX(t) {
	...
	regenerate() {
		...
		const i = this._frustumMat.multiplyMatrices(this._camera.projectionMatrix, this._camera.matrixWorldInverse);
		this._frustum.setFromProjectionMatrix(i);
		const { planes: s } = this._frustum, n = s[0].constant * -s[0].normal.x, o = s[1].constant * -s[1].normal.x, r = s[2].constant * -s[2].normal.y, a = s[3].constant * -s[3].normal.y, l = Math.abs(n - o), c = Math.abs(a - r), { clientWidth: h, clientHeight: d } = this._container, m = Math.max(l, c) / Math.max(h, d), f = Math.ceil(Math.log10(l / this.scaleX)), g = Math.ceil(Math.log10(c / this.scaleY)), b = 10 ** (f - 2) * this.scaleX, y = 10 ** (g - 2) * this.scaleY, x = b * this.gridsFactor, v = y * this.gridsFactor, k = Math.ceil(c / v), $ = Math.ceil(l / x), S = Math.ceil(c / y), C = Math.ceil(l / b), T = b * Math.ceil(o / b), M = y * Math.ceil(r / y), D = x * Math.ceil(o / x), R = v * Math.ceil(r / v), Y = [...this.numbers.children];
		for (const dt of Y) dt.removeFromParent();
		...
		for (let dt = 0; dt < $; dt++) {
			...
			const Bi = ct % zt;
			if (!(x < 1 || v < 1) && Math.abs(Bi) > .01) continue;
	...
	newGrid(t) {
		const s = new LineSegments(new BufferGeometry(), this.material);
...
var dp = Object.defineProperty, up = Object.getOwnPropertyDescriptor, Ls = (e, t, i, s) => {
	for (var n = up(t, i), o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = r(t, i, n) || n);
	return n && dp(t, i, n), n;
};
var pa = class pa extends Ke {
	constructor() {
	...
	set components(t) {
		...
		this._world = s, s.scene = new SimpleScene(t), s.scene.setup(), s.renderer = new qd$1(t, this);
		const n = new OrthoPerspectiveCamera(t);
		s.camera = n;
		const o = new hp(n.threeOrtho, this);
		this._grid = o, s.scene.three.add(o.get()), n.controls.addEventListener("update", () => o.regenerate()), setTimeout(async () => {
			s.camera.updateAspect(), n.set("Plan"), await n.controls.setLookAt(0, 0, 100, 0, 0, 0), await n.projection.set("Orthographic"), n.controls.dollySpeed = 3, n.controls.draggingSmoothTime = .085, n.controls.maxZoom = 1e3, n.controls.zoom(4);
		});
	}
	get world() {
		return this._world;
...
Ls([$t({
	...
	reflect: !0
})], Se.prototype, "gridColor");
Ls([$t({
	type: Number,
	attribute: "grid-scale-x",
	reflect: !0
})], Se.prototype, "gridScaleX");
Ls([$t({
	type: Number,
	attribute: "grid-scale-y",
	reflect: !0
})], Se.prototype, "gridScaleY");
Ls([$t({
	type: Number,
	attribute: "grid-offset-x",
	reflect: !0
})], Se.prototype, "gridOffsetX");
Ls([$t({
	type: Number,
	attribute: "grid-offset-y",
	reflect: !0
})], Se.prototype, "gridOffsetY");
var pp = Object.defineProperty, Te = (e, t, i, s) => {
	for (var n = void 0, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = r(t, i, n) || n);
	return n && pp(t, i, n), n;
};
var fa = class fa extends Ke {
	constructor() {
...
Te([lp()], jt.prototype, "_cssMatrix3D");
/**
* @license
...
var is = (e, t) => {
	...
	for (const n of i) (s = n._$AO) == null || s.call(n, t, !1), is(n, t);
	return !0;
}, Tn = (e) => {
	let t, i;
	do {
...
function vp(e, t = !1, i = 0) {
	...
	if (n !== void 0 && n.size !== 0) if (t) if (Array.isArray(s)) for (let o = i; o < s.length; o++) is(s[o], !1), Tn(s[o]);
	else s != null && (is(s, !1), Tn(s));
	else is(this, e);
}
var xp = (e) => {
...
var _p = class extends bp {
	...
	setValue(t) {
		if (fp(this._$Ct)) this._$Ct._$AI(t, this);
		else {
...
var Xo = () => new wp();
var wp = class {};
var Co = /* @__PURE__ */ new WeakMap(), kp = gp(class extends _p {
	render(e) {
		return at;
	}
	update(e, [t]) {
	...
	rt(e) {
		if (this.isConnected || (e = void 0), typeof this.G == "function") {
			...
			let i = Co.get(t);
			i === void 0 && (i = /* @__PURE__ */ new WeakMap(), Co.set(t, i)), i.get(this.G) !== void 0 && this.G.call(this.ht, void 0), i.set(this.G, e), e !== void 0 && this.G.call(this.ht, e);
		} else this.G.value = e;
	}
	get lt() {
		var e, t;
		return typeof this.G == "function" ? (e = Co.get(this.ht ?? globalThis)) == null ? void 0 : e.get(this.G) : (t = this.G) == null ? void 0 : t.value;
	}
	disconnected() {
...
var $p = Object.defineProperty, Sp = (e, t, i, s) => {
	for (var n = void 0, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = r(t, i, n) || n);
	return n && $p(t, i, n), n;
};
var ma = class ma extends Ke {
	constructor() {
		super(...arguments), this.world = null, this._components = null, this._viewport = Xo();
	}
	set components(t) {
		var i;
		if (this._components = t, this.components) this.world = this.components.get(Worlds).create(), this.world.name = this.name;
		else (i = this.world) == null || i.dispose(), this.world = null;
	}
	get components() {
...
var Cp = Object.defineProperty, Ap = (e, t, i) => t in e ? Cp(e, t, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: i
}) : e[t] = i, A = (e, t, i) => (Ap(e, typeof t != "symbol" ? t + "" : t, i), i);
var _i = Math.min, le = Math.max, Dn = Math.round, Ce = (e) => ({
	x: e,
	y: e
}), Mp = {
	left: "right",
...
var Ea = ["left", "right"], Ta = ["right", "left"], Op = ["top", "bottom"], Ip = ["bottom", "top"];
function Lp(e, t, i) {
	switch (e) {
		case "top":
		case "bottom": return i ? t ? Ta : Ea : t ? Ea : Ta;
		case "left":
		case "right": return t ? Op : Ip;
		default: return [];
	}
}
function Rp(e, t, i, s) {
...
var Fp = async (e, t, i) => {
	const { placement: s = "bottom", strategy: n = "absolute", middleware: o = [], platform: r } = i, a = o.filter(Boolean), l = await (r.isRTL == null ? void 0 : r.isRTL(t));
	let c = await r.getElementRects({
		reference: e,
		floating: t,
		strategy: n
	}), { x: h, y: d } = Pa(c, s, l), u = s, p = {}, m = 0;
	for (let f = 0; f < a.length; f++) {
		const { name: g, fn: b } = a[f], { x: y, y: x, data: v, reset: k } = await b({
			x: h,
			y: d,
			initialPlacement: s,
			placement: u,
...
async function Zc(e, t) {
	var i;
	t === void 0 && (t = {});
	const { x: s, y: n, platform: o, rects: r, elements: a, strategy: l } = e, { boundary: c = "clippingAncestors", rootBoundary: h = "viewport", elementContext: d = "floating", altBoundary: u = !1, padding: p = 0 } = Rs(t, e), m = Xc(p), f = a[u ? d === "floating" ? "reference" : "floating" : d], g = wi(await o.getClippingRect({
...
var Bp = function(e) {
	return e === void 0 && (e = {}), {
		...
		async fn(t) {
			var i, s;
			const { placement: n, middlewareData: o, rects: r, initialPlacement: a, platform: l, elements: c } = t, { mainAxis: h = !0, crossAxis: d = !0, fallbackPlacements: u, fallbackStrategy: p = "bestFit", fallbackAxisSideDirection: m = "none", flipAlignment: f = !0, ...g } = Rs(e, t);
			...
			if (M = [...M, {
				...
				var D, R;
				const P = (((D = o.flip) == null ? void 0 : D.index) || 0) + 1, E = S[P];
				if (E && (!(d === "alignment" && y !== se(E)) || M.every((V) => se(V.placement) === y ? V.overflows[0] > 0 : !0))) return {
					data: {
						index: P,
						overflows: M
					},
				...
				if (n !== O) return { reset: { placement: O } };
			}
			return {};
		}
	};
...
var Np = function(e) {
	return e === void 0 && (e = {}), {
		...
		options: e,
		async fn(t) {
			const { placement: i, elements: s, rects: n, platform: o, strategy: r } = t, { padding: a = 2, x: l, y: c } = Rs(e, t), h = Array.from(await (o.getClientRects == null ? void 0 : o.getClientRects(s.reference)) || []), d = jp(h), u = wi(Kc(h)), p = Xc(a);
			function m() {
				if (d.length === 2 && d[0].left > d[1].right && l != null && c != null) return d.find((g) => l > g.left - p.left && l < g.right + p.right && c > g.top - p.top && c < g.bottom + p.bottom) || u;
				if (d.length >= 2) {
					if (se(i) === "y") {
						const M = d[0], D = d[d.length - 1], R = ce(i) === "top", Y = M.top, P = D.bottom, E = R ? M.left : D.left, O = R ? M.right : D.right;
						return {
							top: Y,
							bottom: P,
							left: E,
					...
					const g = ce(i) === "left", b = le(...d.map((M) => M.right)), y = _i(...d.map((M) => M.left)), x = d.filter((M) => g ? M.left === y : M.right === b), v = x[0].top, k = x[x.length - 1].bottom, $ = y, S = b;
					return {
						top: v,
						bottom: k,
						left: $,
			...
			return n.reference.x !== f.reference.x || n.reference.y !== f.reference.y || n.reference.width !== f.reference.width || n.reference.height !== f.reference.height ? { reset: { rects: f } } : {};
		}
	};
}, Hp = /* @__PURE__ */ new Set(["left", "top"]);
async function Vp(e, t) {
	const { placement: i, platform: s, elements: n } = e, o = await (s.isRTL == null ? void 0 : s.isRTL(n.floating)), r = ce(i), a = Zn(i), l = se(i) === "y", c = Hp.has(r) ? -1 : 1, h = o && l ? -1 : 1, d = Rs(t, e);
	let { mainAxis: u, crossAxis: p, alignmentAxis: m } = typeof d == "number" ? {
		mainAxis: d,
		crossAxis: 0,
		alignmentAxis: null
	} : {
...
var Dr = function(e) {
	return {
		...
		async fn(t) {
			var i, s;
			const { x: n, y: o, placement: r, middlewareData: a } = t, l = await Vp(t, e);
	...
	return e === void 0 && (e = {}), {
		...
		options: e,
		async fn(t) {
			const { x: i, y: s, placement: n } = t, { mainAxis: o = !0, crossAxis: r = !1, limiter: a = { fn: (g) => {
				let { x: b, y } = g;
				return {
					x: b,
					y
...
function zs(e) {
	const { overflow: t, overflowX: i, overflowY: s, display: n } = Ot(e);
...
function ki(e) {
	...
	const t = e.assignedSlot || e.parentNode || Da(e) && e.host || Pe(e);
...
function fi(e) {
	const t = ih(e);
	if (!Zt(t)) return Ce(1);
	const i = t.getBoundingClientRect(), { width: s, height: n, $: o } = eh(t);
...
function hf(e, t) {
	const i = vs(e, !0, t === "fixed"), s = i.top + e.clientTop, n = i.left + e.clientLeft, o = Zt(e) ? fi(e) : Ce(1);
	return {
...
function Oa(e, t, i) {
	let s;
	if (t === "viewport") s = cf(e, i);
	else if (t === "document") s = lf(Pe(e));
	else if (Xt(t)) s = hf(t, i);
	else {
		const n = sh(e);
		s = {
			...t,
...
function ff(e, t, i) {
	...
	const l = Ce(0);
	if (s || !s && !o) if ((Ae(t) !== "body" || zs(n)) && (a = Qn(t)), s) {
		const d = vs(t, !0, o, t);
...
function ah(e, t) {
	const i = Tt(e);
	if (!Zt(e) || nh(e)) return i;
	let s = Ia(e, t);
	for (; s && Yp(s) && Ot(s).position === "static";) s = Ia(s, t);
...
* SPDX-License-Identifier: BSD-3-Clause
*/
var vn = globalThis, Br = vn.ShadowRoot && (vn.ShadyCSS === void 0 || vn.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, jr = Symbol(), La = /* @__PURE__ */ new WeakMap();
var lh = class {
	constructor(e, t, i) {
...
var yf = (e) => new lh(typeof e == "string" ? e : e + "", void 0, jr), H = (e, ...t) => {
	return new lh(e.length === 1 ? e[0] : t.reduce((s, n, o) => s + ((r) => {
		if (r._$cssResult$ === !0) return r.cssText;
		if (typeof r == "number") return r;
		throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
	})(n) + e[o + 1], e[0]), e, jr);
}, vf = (e, t) => {
	if (Br) e.adoptedStyleSheets = t.map((i) => i instanceof CSSStyleSheet ? i : i.styleSheet);
	else for (const i of t) {
...
* SPDX-License-Identifier: BSD-3-Clause
*/
var { is: xf, defineProperty: _f, getOwnPropertyDescriptor: wf, getOwnPropertyNames: kf, getOwnPropertySymbols: $f, getPrototypeOf: Sf } = Object, $i = globalThis, za = $i.trustedTypes, Cf = za ? za.emptyScript : "", Fa = $i.reactiveElementPolyfillSupport, ss = (e, t) => e, In = {
	toAttribute(e, t) {
		switch (t) {
			case Boolean:
				e = e ? Cf : null;
...
var ui = class extends HTMLElement {
	...
	static getPropertyDescriptor(e, t, i) {
		const { get: s, set: n } = wf(this.prototype, e) ?? {
			get() {
				return this[t];
			},
			set(o) {
		...
		return {
			...
			set(o) {
				...
				n?.call(this, o), this.requestUpdate(e, r, i);
			},
			configurable: !0,
			enumerable: !0
		};
	...
	static finalizeStyles(e) {
		const t = [];
		if (Array.isArray(e)) {
			const i = new Set(e.flat(Infinity).reverse());
			for (const s of i) t.unshift(Ra(s));
		} else e !== void 0 && t.push(Ra(e));
		return t;
	}
	static _$Eu(e, t) {
		const i = t.attribute;
	...
	requestUpdate(e, t, i, s = !1, n) {
		...
		if (e !== void 0) {
			...
			if (s === !1 && (n = this[e]), i ?? (i = r.getPropertyOptions(e)), !((i.hasChanged ?? Nr)(n, t) || i.useDefault && i.reflect && n === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(r._$Eu(e, i)))) return;
			this.C(e, t, i);
		}
		this.isUpdatePending === !1 && (this._$ES = this._$EP());
	}
...
ui.elementStyles = [], ui.shadowRootOptions = { mode: "open" }, ui[ss("elementProperties")] = /* @__PURE__ */ new Map(), ui[ss("finalized")] = /* @__PURE__ */ new Map(), Fa?.({ ReactiveElement: ui }), ($i.reactiveElementVersions ?? ($i.reactiveElementVersions = [])).push("2.1.2");
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
var Ln = globalThis, ja = (e) => e, Rn = Ln.trustedTypes, Na = Rn ? Rn.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ch = "$lit$", be = `lit$${Math.random().toFixed(9).slice(2)}$`, hh = "?" + be, Af = `<${hh}>`, ei = document, xs = () => ei.createComment(""), _s = (e) => e === null || typeof e != "object" && typeof e != "function", Hr = Array.isArray, Mf = (e) => Hr(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ao = `[ 	
\f\r]`, Ni = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ha = /-->/g, Va = />/g, Fe = RegExp(`>|${Ao}(?:([^\\s"'>=/]+)(${Ao}*=${Ao}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ua = /'/g, Wa = /"/g, dh = /^(?:script|style|textarea|title)$/i, Ef = (e) => (t, ...i) => ({
	_$litType$: e,
	strings: t,
	values: i
}), _ = Ef(1), ii = Symbol.for("lit-noChange"), W = Symbol.for("lit-nothing"), qa = /* @__PURE__ */ new WeakMap(), Ye = ei.createTreeWalker(ei, 129);
function uh(e, t) {
...
var Tf = (e, t) => {
	...
	for (let a = 0; a < i; a++) {
		const l = e[a];
		let c, h, d = -1, u = 0;
		for (; u < l.length && (r.lastIndex = u, h = r.exec(l), h !== null);) u = r.lastIndex, r === Ni ? h[1] === "!--" ? r = Ha : h[1] !== void 0 ? r = Va : h[2] !== void 0 ? (dh.test(h[2]) && (n = RegExp("</" + h[2], "g")), r = Fe) : h[3] !== void 0 && (r = Fe) : r === Fe ? h[0] === ">" ? (r = n ?? Ni, d = -1) : h[1] === void 0 ? d = -2 : (d = r.lastIndex - h[2].length, c = h[1], r = h[3] === void 0 ? Fe : h[3] === "\"" ? Wa : Ua) : r === Wa || r === Ua ? r = Fe : r === Ha || r === Va ? r = Ni : (r = Fe, n = void 0);
...
var ws = class ws {
	constructor({ strings: t, _$litType$: i }, s) {
		...
		for (; (n = Ye.nextNode()) !== null && l.length < a;) {
			if (n.nodeType === 1) {
				if (n.hasAttributes()) for (const d of n.getAttributeNames()) if (d.endsWith(ch)) {
					...
					l.push({
						...
						name: m[2],
						strings: p,
						ctor: m[1] === "." ? Df : m[1] === "?" ? Of : m[1] === "@" ? If : to
					}), n.removeAttribute(d);
				} else d.startsWith(be) && (l.push({
					type: 6,
					index: o
				}), n.removeAttribute(d));
				if (dh.test(n.tagName)) {
					...
					if (u > 0) {
						...
						for (let p = 0; p < u; p++) n.append(d[p], xs()), Ye.nextNode(), l.push({
							type: 2,
							index: ++o
						});
						n.append(d[u], xs());
			...
			} else if (n.nodeType === 8) if (n.data === hh) l.push({
				type: 2,
				index: o
			});
			else {
				let d = -1;
				for (; (d = n.data.indexOf(be, d + 1)) !== -1;) l.push({
					type: 7,
					index: o
				}), d += be.length - 1;
			}
...
function Si(e, t, i = e, s) {
	var n, o;
	if (t === ii) return t;
	let r = s !== void 0 ? (n = i._$Co) == null ? void 0 : n[s] : i._$Cl;
	const a = _s(t) ? void 0 : t._$litDirective$;
	return (r == null ? void 0 : r.constructor) !== a && ((o = r == null ? void 0 : r._$AO) == null || o.call(r, !1), a === void 0 ? r = void 0 : (r = new a(e), r._$AT(e, i, s)), s !== void 0 ? (i._$Co ?? (i._$Co = []))[s] = r : i._$Cl = r), r !== void 0 && (t = Si(e, r._$AS(e, t.values), r, s)), t;
}
var Pf = class {
	constructor(t, i) {
		this._$AV = [], this._$AN = void 0, this._$AD = t, this._$AM = i;
...
var Fs = class Fs {
	...
	_$AI(t, i = this) {
		t = Si(this, t, i), _s(t) ? t === W || t == null || t === "" ? (this._$AH !== W && this._$AR(), this._$AH = W) : t !== this._$AH && t !== ii && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Mf(t) ? this.k(t) : this._(t);
	}
	O(t) {
		return this._$AA.parentNode.insertBefore(t, this._$AB);
	}
	...
	$(t) {
		...
		if (((i = this._$AH) == null ? void 0 : i._$AD) === o) this._$AH.p(s);
		else {
	...
	k(t) {
		...
		const i = this._$AH;
		let s, n = 0;
		for (const o of t) n === i.length ? i.push(s = new Fs(this.O(xs()), this.O(xs()), this, this.options)) : s = i[n], s._$AI(o), n++;
		n < i.length && (this._$AR(s && s._$AB.nextSibling, n), i.length = n);
	}
	_$AR(t = this._$AA.nextSibling, i) {
		var s;
...
var to = class {
	...
	constructor(t, i, s, n, o) {
		this.type = 1, this._$AH = W, this._$AN = void 0, this.element = t, this.name = i, this._$AM = n, this.options = o, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(/* @__PURE__ */ new String()), this.strings = s) : this._$AH = W;
	}
	_$AI(t, i = this, s, n) {
		const o = this.strings;
		let r = !1;
		if (o === void 0) t = Si(this, t, i, 0), r = !_s(t) || t !== this._$AH && t !== ii, r && (this._$AH = t);
		else {
			const a = t;
			let l, c;
			for (t = o[0], l = 0; l < o.length - 1; l++) c = Si(this, a[s + l], i, l), c === ii && (c = this._$AH[l]), r || (r = !_s(c) || c !== this._$AH[l]), c === W ? t = W : t !== W && (t += (c ?? "") + o[l + 1]), this._$AH[l] = c;
		}
		r && !n && this.j(t);
	}
	j(t) {
...
var If = class extends to {
	...
	_$AI(t, i = this) {
		if ((t = Si(this, t, i, 0) ?? W) === ii) return;
...
Ya?.(ws, Fs), (Ln.litHtmlVersions ?? (Ln.litHtmlVersions = [])).push("3.3.2");
var Ko = (e, t, i) => {
	const s = (i == null ? void 0 : i.renderBefore) ?? t;
	let n = s._$litPart$;
	if (n === void 0) {
...
var ns = (e, t) => {
	...
	for (const n of s) (i = n._$AO) == null || i.call(n, t, !1), ns(n, t);
	return !0;
}, zn = (e) => {
	let t, i;
	do {
...
function jf(e, t = !1, i = 0) {
	const s = this._$AH, n = this._$AN;
	if (n !== void 0 && n.size !== 0) if (t) if (Array.isArray(s)) for (let o = i; o < s.length; o++) ns(s[o], !1), zn(s[o]);
	else s != null && (ns(s, !1), zn(s));
	else ns(this, e);
}
var Nf = (e) => {
...
var Hf = class extends mh {
	...
	setValue(t) {
		if (Ff(this._$Ct)) this._$Ct._$AI(t, this);
		else {
			const i = [...this._$Ct._$AH];
			i[this._$Ci] = t, this._$Ct._$AI(i, this, 0);
		}
...
var Ci = () => new Vf();
var Vf = class {};
var Mo = /* @__PURE__ */ new WeakMap(), tt = fh(class extends Hf {
	render(e) {
		return W;
	}
	update(e, [t]) {
...
function Za(e) {
	const t = { ...vh }, i = (s, n) => e.getAttribute(s) || n;
...
function Gf(e, t) {
	for (const i in vh) if (e[i] !== t[i]) return !0;
	return !1;
}
var xh = /^[a-z0-9]+(-[a-z0-9]+)*$/, js = (e, t, i, s = "") => {
	const n = e.split(":");
	if (e.slice(0, 1) === "@") {
...
function Ka(e, t) {
	const i = Zf(e, t);
	for (const s in Jo) s in Fn ? s in e && !(s in i) && (i[s] = Fn[s]) : s in t ? i[s] = t[s] : s in e && (i[s] = e[s]);
	return i;
}
function Kf(e, t, i) {
...
function Eo(e, t) {
	for (const i in t) if (i in e && typeof e[i] != typeof t[i]) return !1;
	return !0;
}
function wh(e) {
	if (typeof e != "object" || e === null) return null;
	const t = e;
	if (typeof t.prefix != "string" || !e.icons || typeof e.icons != "object" || !Eo(e, Jf)) return null;
	const i = t.icons;
	for (const n in i) {
		const o = i[n];
		if (!n || typeof o.body != "string" || !Eo(o, Jo)) return null;
	}
	const s = t.aliases || /* @__PURE__ */ Object.create(null);
	for (const n in s) {
		const o = s[n], r = o.parent;
		if (!n || typeof r != "string" || !i[r] && !s[r] || !Eo(o, Jo)) return null;
	}
	return t;
}
...
function tm(e, t, i) {
	try {
		if (typeof i.body == "string") return e.icons[t] = { ...i }, !0;
	} catch {}
	return !1;
}
function em(e, t) {
	...
	e.pendingCallbacksFlag || (e.pendingCallbacksFlag = !0, setTimeout(() => {
		...
		t.forEach((o) => {
			...
			r.pending = r.pending.filter((l) => {
				...
				return !1;
			}), r.pending.length !== a && (i || Ch([e], o.id), o.callback(r.loaded.slice(0), r.missing.slice(0), r.pending.slice(0), o.abort));
		});
	}));
}
var om = 0;
function rm(e, t, i) {
	const s = om++, n = Ch.bind(null, i, s);
...
var eo = /* @__PURE__ */ Object.create(null), Ks = ["https://api.simplesvg.com", "https://api.unisvg.com"], er = [];
for (; Ks.length > 0;) Ks.length === 1 || Math.random() > .5 ? er.push(Ks.shift()) : er.push(Ks.pop());
...
function dm(e, t, i, s) {
	...
	if (e.random) {
		...
		for (r = []; $.length > 1;) {
			...
			r.push($[S]), $ = $.slice(0, S).concat($.slice(S + 1));
		}
		r = r.concat($);
	} else r = e.resources.slice(o).concat(e.resources.slice(0, o));
	const a = Date.now();
	...
	function v($, S, C) {
		...
		switch (u = u.filter((M) => M !== $), l) {
			case "pending": break;
			case "failed":
				if (T || !e.dataAfterTimeout) return;
				break;
			default: return;
		}
		if (S === "abort") {
	...
	function k() {
		...
		u.push(S), c++, d = setTimeout(k, e.rotate), i($, t, S.callback);
	}
...
function Mh(e, t, i) {
	...
	if (typeof e == "string") {
		...
		if (o) {
			s = Ah(o);
			const a = tr(e.resources ? e.resources[0] : "");
			a && (n = a.send);
		}
	}
...
function mm(e, t) {
	e.iconsToLoad ? e.iconsToLoad = e.iconsToLoad.concat(t).sort() : e.iconsToLoad = t, e.iconsQueueFlag || (e.iconsQueueFlag = !0, setTimeout(() => {
		...
		if (a.length && Hi(e, a, null), !r.length) return;
...
var vm = /(-?[0-9.]*[0-9]+[0-9.]*)/g, xm = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function ir(e, t, i) {
	if (t === 1) return e;
	if (i = i || 100, typeof e == "number") return Math.ceil(e * t * i) / i;
...
function Cm(e) {
	return "data:image/svg+xml," + Sm(e);
}
function Ph(e) {
	return "url(\"" + Cm(e) + "\")";
}
	...
	if (e) {
		if (e.IconifyPreload !== void 0) {
			...
			typeof t == "object" && t !== null && (t instanceof Array ? t : [t]).forEach((s) => {
				try {
					(typeof s != "object" || s === null || s instanceof Array || typeof s.icons != "object" || typeof s.prefix != "string" || !Ja(s)) && console.error(i);
				} catch {
					console.error(i);
				}
			});
		...
		if (e.IconifyProviders !== void 0) {
			...
			if (typeof t == "object" && t !== null) for (const i in t) {
...
var sr = { "background-color": "currentColor" }, Ih = { "background-color": "transparent" }, rl = {
	image: "var(--svg)",
	repeat: "no-repeat",
	size: "100% 100%"
}, al = {
...
function Bm(e, t, i) {
	...
	const o = e.attributes, a = Ph(Wr(n, {
		...o,
		width: t.width + "",
		height: t.height + ""
	})), l = s.style, c = {
...
function Hm(e) {
	...
	return t.innerHTML = Nm(Wr(e.body, i)), t.firstChild;
}
function nr(e) {
...
function hl(e, t, i) {
	return {
		...
		inline: t,
		icon: e,
		lastRender: i && (i.rendered ? i : i.lastRender)
	};
}
	...
	const n = [
		...
		*/
		constructor() {
			...
			const a = this._shadowRoot = this.attachShadow({ mode: "open" }), l = this.hasAttribute("inline");
			ol(a, l), this._state = hl({ value: "" }, l), this._queueCheck();
		}
		/**
		* Connected to DOM
		*/
		...
		*/
		_iconChanged(a) {
			const l = bm(a, (c, h, d) => {
				const u = this._state;
				if (u.rendered || this.getAttribute("icon") !== c) return;
				const p = {
					value: c,
					name: h,
					data: d
...
var { iconLoaded: Kw, getIcon: Jw, listIcons: Qw, addIcon: t1, addCollection: Wm, calculateSize: e1, buildIcon: i1, iconToHTML: s1, svgToURL: n1, loadIcons: qm, loadIcon: o1, setCustomIconLoader: r1, setCustomIconsLoader: a1, addAPIProvider: l1, _api: c1 } = Vm() || Oh(), De = {
	scrollbar: H`
  ::-webkit-scrollbar {
    width: 0.4rem;
    height: 0.4rem;
...
`
	...
	*/
	static init(t = "", i = !0) {
		B.addGlobalStyles(), B.defineCustomElement("bim-button", eg), B.defineCustomElement("bim-checkbox", Di), B.defineCustomElement("bim-color-input", Oe), B.defineCustomElement("bim-context-menu", rs), B.defineCustomElement("bim-dropdown", Lt), B.defineCustomElement("bim-grid", Hs), B.defineCustomElement("bim-icon", vg), B.defineCustomElement("bim-input", Vs), B.defineCustomElement("bim-label", Oi), B.defineCustomElement("bim-number-input", Pt), B.defineCustomElement("bim-option", rt), B.defineCustomElement("bim-panel", ri), B.defineCustomElement("bim-panel-section", Ii), B.defineCustomElement("bim-selector", Li), B.defineCustomElement("bim-table", Gr), B.defineCustomElement("bim-tabs", de), B.defineCustomElement("bim-tab", Mt), B.defineCustomElement("bim-table-cell", Xh), B.defineCustomElement("bim-table-children", zg), B.defineCustomElement("bim-table-group", Jh), B.defineCustomElement("bim-table-row", Gs), B.defineCustomElement("bim-text-input", St), B.defineCustomElement("bim-toolbar", ho), B.defineCustomElement("bim-toolbar-group", lo), B.defineCustomElement("bim-toolbar-section", zi), B.defineCustomElement("bim-viewport", ld), B.defineCustomElement("bim-chart-legend", hd), B.defineCustomElement("bim-chart", st), B.defineCustomElement("bim-tooltip", B_), i && this.animateOnLoad(t);
	}
	static newRandomId() {
    ...
    `, s = [];
		function n(o, r = document, a = /* @__PURE__ */ new Set()) {
			...
			}), Array.from(r.querySelectorAll("*")).filter((c) => c.shadowRoot).forEach((c) => {
				a.has(c) || (a.add(c), l.push(...n(o, c.shadowRoot, a)));
			}), l;
		}
	...
	static toggleTheme(t = !0) {
		...
		if (t) {
			...
			n.appendChild(o), o.style.setProperty("transition", `background-color ${1e3 / 3200}s`), document.body.appendChild(n), n.style.setProperty("animation", `toggleOverlay ${1e3 / 1e3}s ease-in forwards`), o.style.setProperty("animation", `toggleThemeAnimation ${1e3 / 1e3}s ease forwards`), setTimeout(() => {
				s();
			}, 1e3 / 4), setTimeout(() => {
				document.body.querySelectorAll(".theme-transition-overlay").forEach((r) => {
...
var et = class extends j {
	...
	resetVisibleElements() {
		const t = this.getLazyObserver();
		if (t) {
			for (const i of this.elements) t.unobserve(i);
	...
	*/
	static create(t, i) {
		...
		if (t.length === 0) return Ko(t(), s), s.firstElementChild;
		if (!i) throw new Error("UIComponent: Initial state is required for statefull components.");
		let n = i;
		const o = t, r = (c) => (n = {
			...n,
			...c
...
function dl(e) {
	const t = Xm.find((r) => e.split(r).length === 2), [s, n] = e.split(t).map((r) => r.trim());
	return {
		key: s,
		condition: t,
		value: n.startsWith("'") && n.endsWith("'") ? n.replace(/'/g, "") : so(n)
	};
}
var or = (e) => {
	try {
...
var Zm = class extends Set {
	...
	add(...t) {
		for (const i of t) this.has(i) || !(this.guard ?? (() => !0))(i) || (super.add(i), this.onItemAdded || (this.onItemAdded = new Be()), this.onItemAdded.trigger(i));
	...
	deleteIf(t) {
		for (const i of this) t(i) && this.delete(i);
	}
	getIndex(t) {
		let i = 0;
		for (const s of this) {
...
var Km = Object.defineProperty, Jm = Object.getOwnPropertyDescriptor, Rh = (e, t, i, s) => {
	for (var n = Jm(t, i), o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = r(t, i, n) || n);
	return n && Km(t, i, n), n;
}, ft;
var qr = (ft = class extends j {
	...
	static removeMenus() {
		for (const e of [...ft.dialog.children]) e instanceof ft && (e.remove(), e.visible = !1);
		setTimeout(() => {
	...
	*/
	async updatePosition() {
		...
		const e = this.placement ?? "right", { x: i, y: s } = await Fr(this._previousContainer, this, {
			placement: e,
			middleware: [
				Dr(10),
				zr(),
...
var Qm = Object.defineProperty, tg = Object.getOwnPropertyDescriptor, Nt = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? tg(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
...
var It = (Vi = class extends j {
	constructor() {
		super(), this.labelHidden = !1, this.active = !1, this.disabled = !1, this.vertical = !1, this.tooltipVisible = !1, this._stateBeforeLoading = {
			disabled: !1,
			icon: ""
		}, this._loading = !1, this._parent = Ci(), this._tooltip = Ci(), this._mouseLeave = !1, this.onClick = (e) => {
          ...
          `;
			...
			if (e) {
				...
				for (const s of e.children) s instanceof Vi && s.setAttribute("data-context-group", i);
				e.visible = !0;
			}
		}, this.mouseLeave = !0;
	}
	set loading(e) {
		if (this._loading = e, e) this._stateBeforeLoading = {
	...
	closeNestedContexts() {
		...
		if (e) for (const t of rs.dialog.children) {
			const i = t.getAttribute("data-context-group");
			if (t instanceof rs && i === e) {
				t.visible = !1, t.removeAttribute("data-context-group");
				for (const s of t.children) s instanceof Vi && (s.closeNestedContexts(), s.removeAttribute("data-context-group"));
			}
		}
	}
	click() {
...
var Fh = class extends j {
	constructor() {
		super(...arguments), this.vertical = !1, this.color = "#bcf124", this.disabled = !1, this._colorInput = Ci(), this._textInput = Ci(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
...
var ng = Object.defineProperty, og = Object.getOwnPropertyDescriptor, Ie = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? og(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
...
Ie([w({ converter: { fromAttribute(e) {
	return e && so(e);
...
var rg = Object.defineProperty, ag = Object.getOwnPropertyDescriptor, Ht = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? ag(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
	return s && n && rg(t, i, n), n;
};
var jh = class extends et {
	constructor() {
		super(), this.multiple = !1, this.required = !1, this.vertical = !1, this._visible = !1, this._value = /* @__PURE__ */ new Set(), this._hasVisibleOptions = !0, this.onValueChange = new Event("change"), this._contextMenu = Ci(), this.onOptionClick = (t) => {
			const i = t.target, s = this._value.has(i);
			if (!this.multiple && !this.required && !s) this._value = /* @__PURE__ */ new Set([i]);
			else if (!this.multiple && !this.required && s) this._value = /* @__PURE__ */ new Set([]);
			else if (!this.multiple && this.required && !s) this._value = /* @__PURE__ */ new Set([i]);
			else if (this.multiple && !this.required && !s) this._value = /* @__PURE__ */ new Set([...this._value, i]);
			...
			let s = 0;
			for (const n of this._options) n instanceof rt && ((n.label || n.value || "").toLowerCase().includes(i) ? (n.style.display = "", s++) : n.style.display = "none");
	...
	set visible(t) {
		...
		if (t) {
			...
			for (const n of this._options) n instanceof rt && (n.style.display = "");
	...
	*/
	set value(t) {
		...
		for (const s of t) {
			...
			if (n && (i.add(n), !this.multiple && Object.keys(t).length === 1)) break;
		}
		this._value = i, this.updateOptionsState(), this.dispatchEvent(this.onValueChange);
	}
	get value() {
		return [...this._value].filter((t) => t instanceof rt && t.checked).map((t) => t.value);
	}
	get _options() {
		const t = /* @__PURE__ */ new Set([...this.elements]);
		for (const i of this.children) i instanceof rt && t.add(i);
		return [...t];
	}
	onSlotChange(t) {
	...
	updateOptionsState() {
		for (const t of this._options) t instanceof rt && (t.checked = this._value.has(t));
	}
	findOption(t) {
...
Ht([ue()], Lt.prototype, "_value", 2);
Ht([ue()], Lt.prototype, "_hasVisibleOptions", 2);
function lg(e) {
	const t = [], i = /(["'])(.*?)\1/g;
	let s;
	for (; (s = i.exec(e)) !== null;) {
...
function hg(e) {
	...
	for (let o = 0; o < s; o++) for (let r = 0; r < n - 1; r++) {
		const a = e[o][r], l = e[o][r + 1];
		if (a !== l) {
			const c = i.find((h) => h.type === "vertical" && h.from[0] === r + 1 && h.to[0] === r + 1 && h.from[1] <= o && h.to[1] >= o);
	...
	for (let o = 0; o < s - 1; o++) for (let r = 0; r < n; r++) {
		const a = e[o][r], l = e[o + 1][r];
		if (a !== l) {
			const c = i.find((h) => h.type === "horizontal" && h.from[1] === o + 1 && h.to[1] === o + 1 && h.from[0] <= r && h.to[0] >= r);
...
function dg(e) {
	for (const t of e) t.left && (t.left = [...new Set(t.left)]), t.right && (t.right = [...new Set(t.right)]), t.above && (t.above = [...new Set(t.above)]), t.below && (t.below = [...new Set(t.below)]);
	return e;
}
function ug(e, t, i, s) {
	const n = (parseFloat(e.colSizesComputed[i - 1]) || 0) + t;
	let o;
	return o = (parseFloat(e.colSizesComputed[i]) || 0) - t, {
		left: n,
		right: o
	};
}
function pg(e, t, i, s) {
	...
	let o;
	return o = (parseFloat(e.rowSizesComputed[i]) || 0) - t, {
		top: n,
		bottom: o
	};
}
...
* SPDX-License-Identifier: BSD-3-Clause
*/
var Nh = "important", bg = " !" + Nh, Yt = fh(class extends mh {
	constructor(e) {
		var t;
		if (super(e), e.type !== ph.ATTRIBUTE || e.name !== "style" || ((t = e.strings) == null ? void 0 : t.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
	}
	render(e) {
	...
	update(e, [t]) {
		...
		for (const s of this.ft) t[s] ?? (this.ft.delete(s), s.includes("-") ? i.removeProperty(s) : i[s] = null);
		for (const s in t) {
			const n = t[s];
			if (n != null) {
				this.ft.add(s);
...
var Hh = class extends j {
	constructor() {
		super(...arguments), this.floating = !1, this.resizeableAreas = !1, this.areasResizeExceptions = [], this._layouts = {}, this._elements = {}, this._templateIds = /* @__PURE__ */ new Map(), this._updateFunctions = {}, this._slotNames = {
			...
			if (n.type === "vertical") {
				const a = n.from[0], c = a === this._colSizesRaw.length - 1, h = ug(this._start, i, a);
				if (!fg(h.left, h.right, i, r)) return;
			...
			if (n.type === "horizontal") {
				const a = n.from[1], c = a === this._rowSizesRaw.length - 1, h = pg(this._start, s, a);
				if (!mg(h.top, h.bottom, s, r)) return;
	...
	*/
	...
	setUpdateFunctions() {
		const t = {};
		for (const [i, s] of Object.entries(this.elements)) "template" in s && (t[i] = (n) => {
			var o, r;
	...
	canResizeVerticalDivider(t) {
		...
		for (const n of i) if (!this.isAreaResizeable(n)) return !1;
	...
	computeDividers() {
		...
		if (!i) return;
		const n = hg(lg(i)), o = getComputedStyle(this), r = [];
		for (const a of n) {
			let l = !1;
	...
	cleanUpdateFunctions() {
		...
		for (const s in this.elements) i.includes(s) || delete this._updateFunctions[s];
	}
	clean() {
		this.style.gridTemplate = "";
		for (const t of [...this.children]) Object.values(this._slotNames).some((i) => t.getAttribute("slot") === i) || t.remove();
	...
	createElementFromDefinition(t, i) {
		...
		if ("template" in i) {
			const { template: r, initialState: a } = i, l = this.getTemplateId(r), c = this.querySelector(`[data-grid-template-id="${l}"]`);
			if (c) {
				let u = this._updateFunctions[t];
				if (!u) {
					for (const [, p] of Object.entries(this._updateFunctions)) if (this.querySelector(`[data-grid-template-id="${this.getTemplateId(r)}"]`) === c) {
						u = p;
						break;
					}
				}
		...
		const s = this.getTemplateId(i), n = this.querySelector(`[data-grid-template-id="${s}"]`);
		if (n) return n;
		const o = et.create(i);
		return o.setAttribute("data-grid-template-id", this.getTemplateId(i)), o;
	}
	render() {
		if (this.layout) {
			const t = this.layouts[this.layout];
			if (t) {
				if (!(t.guard ?? (() => !0))()) return this.clean(), _`<slot name=${this._slotNames.notAllowed}></slot>`;
				const i = this.getLayoutAreas(t).map((n) => {
					...
					if (c ? (a = c[1], l = c[2].split(",").map((m) => {
						...
						if (g > -1) return {
							key: f.substring(0, g).trim(),
							label: f.substring(g + 1).trim() || void 0
						};
						return { key: f };
					})) : l = [{ key: n }], !h) {
						const m = l[0].key, f = ((o = t.elements) == null ? void 0 : o[m]) || this.elements[m];
						if (!f) return null;
						const g = this.createElementFromDefinition(m, f);
						return g ? (this.emitElementCreation({
							name: m,
							element: g
						}), g.style.gridArea = n, g) : null;
					}
					const d = `tabs-${a}`;
					let u = this.querySelector(`[data-grid-tabs-id="${d}"]`);
					...
					for (const m of l) {
						...
						if (!b) continue;
						const y = this.createElementFromDefinition(f, b);
						if (!y) continue;
						...
						const x = `tab-${a}-${f}`;
						let v = u.querySelector(`[data-grid-tab-id="${x}"]`);
			...
			} else return this.clean(), _`<slot name=${this._slotNames.notFound}></slot>`;
		} else return this.clean(), this.emitLayoutChange(), _`<slot name=${this._slotNames.emptyLayout}></slot>`;
		return _`
...
rr.styles = H`
  ...
  `, rr.properties = { icon: { type: String } };
var vg = rr;
...
var wg = Object.defineProperty, kg = Object.getOwnPropertyDescriptor, Rt = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? kg(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
	return s && n && wg(t, i, n), n;
};
var Uh = class extends j {
	constructor() {
		super(...arguments), this._value = 0, this.vertical = !1, this.slider = !1, this._input = Ci(), this.onValueChange = new Event("change");
	}
	set value(t) {
	...
	*/
	...
	render() {
      ...
      ${this.suffix ? _`<bim-label
          ...
          >` : null}
    `, i = this.min ?? -Infinity, s = this.max ?? Infinity, o = _`
      <style>
        .slider-indicator {
          width: ${`${100 * (this.value - i) / (s - i)}%`};
        }
      </style>
...
var $g = Object.defineProperty, Sg = Object.getOwnPropertyDescriptor, Ws = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? Sg(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
...
var Wh = class extends j {
	...
	*/
	get value() {
		return Cs(this, this.valueTransform);
	}
	/**
	...
	*/
	collapseSections() {
		...
		for (const i of t) i.collapsed = !0;
	}
	/**
	...
	*/
	expandSections() {
		const t = this.querySelectorAll("bim-panel-section");
		for (const i of t) i.collapsed = !1;
	}
	render() {
...
var Cg = Object.defineProperty, qs = (e, t, i, s) => {
	for (var n = void 0, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = r(t, i, n) || n);
	return n && Cg(t, i, n), n;
};
var qh = class extends j {
	...
	*/
	get value() {
		...
		let i;
		return t instanceof ri && (i = t.valueTransform), Object.values(this.valueTransform).length !== 0 && (i = this.valueTransform), Cs(this, i);
	}
	/**
	...
	*/
	...
	setFlexAfterTransition() {
		var t;
		const i = (t = this.shadowRoot) == null ? void 0 : t.querySelector(".components");
		i && setTimeout(() => {
	...
	animateHeader() {
		...
		this.componentHeight < 0 && (this.collapsed ? this.componentHeight = i.clientHeight : (i.style.setProperty("transition", "none"), i.style.setProperty("height", "auto"), i.style.setProperty("padding", "0.125rem 1rem 1rem"), this.componentHeight = i.clientHeight, requestAnimationFrame(() => {
			i.style.setProperty("height", "0px"), i.style.setProperty("padding", "0 1rem 0"), i.style.setProperty("transition", "height 0.25s cubic-bezier(0.65, 0.05, 0.36, 1), padding 0.25s cubic-bezier(0.65, 0.05, 0.36, 1)");
		}))), this.collapsed ? (i.style.setProperty("height", `${this.componentHeight}px`), requestAnimationFrame(() => {
			...
			i.style.setProperty("height", `${this.componentHeight}px`), i.style.setProperty("padding", "0.125rem 1rem 1rem");
...
var Yh = class extends j {
	constructor() {
		super(...arguments), this.vertical = !1, this.onValueChange = new Event("change"), this._canEmitEvents = !1, this._value = document.createElement("bim-option"), this.onOptionClick = (t) => {
			...
			for (const i of this.children) i instanceof rt && (i.checked = i === t.target);
		};
	}
	get _options() {
	...
	*/
	set value(t) {
		...
		if (i) {
			for (const s of this._options) s.checked = s === i;
	...
	onSlotChange(t) {
		const i = t.target.assignedElements();
		for (const s of i) s instanceof rt && (s.noMark = !0, s.removeEventListener("click", this.onOptionClick), s.addEventListener("click", this.onOptionClick));
	}
	findOption(t) {
		return this._options.find((i) => i instanceof rt ? i.label === t || i.value === t : !1);
	}
	...
	setAnimatedBackgound(t = !1) {
		const i = this.renderRoot.querySelector(".animated-background"), s = this._value;
		requestAnimationFrame(() => {
			var n, o, r, a;
			...
			i?.style.setProperty("width", `${c.width}px`), i?.style.setProperty("height", `${c.height}px`), i?.style.setProperty("top", `${c.top}px`), i?.style.setProperty("left", `${c.left}px`);
		}), t && this.doubleRequestAnimationFrames(() => {
			const n = "ease";
			i?.style.setProperty("transition", `width 0.3s ${n}, height 0.3s ${n}, top 0.3s ${n}, left 0.3s ${n}`);
		});
	}
	firstUpdated() {
		const t = [...this.children].find((i) => i instanceof rt && i.checked);
...
Ys([ue()], Li.prototype, "_value");
function Mg(e, t, i) {
	if (t.length === 0 || e.length === 0) return e;
	return Yr(Gr.flattenData(e), t, i);
}
function Yr(e, t, i) {
...
function Tg(e, t, i, s) {
	const n = new Dg();
	for (const { path: o, rows: r } of e.values()) n.addPath(o, r, t);
...
var Zh = class extends j {
	...
	render() {
      ...
      <slot></slot>
      ${this.data.map((t) => {
			const i = document.createElement("bim-table-group");
...
var Kh = class extends j {
	...
	animateTableChildren(t = !0) {
		if (!t) {
			requestAnimationFrame(() => {
				var r;
				const a = this.renderRoot.querySelector(".caret"), l = this.renderRoot.querySelector(".branch-vertical"), c = (r = this.renderRoot.querySelector("bim-table-children")) == null ? void 0 : r.querySelector(".branch-vertical");
				a.style.setProperty("transform", `translateY(-50%) rotate(${this.childrenHidden ? "0" : "90"}deg)`), l.style.setProperty("transform", `scaleY(${this.childrenHidden ? "0" : "1"})`), c?.style.setProperty("transform", `scaleY(${this.childrenHidden ? "0" : "1"})`);
			});
			return;
		}
		...
		requestAnimationFrame(() => {
			var r;
			const a = this.renderRoot.querySelector("bim-table-children"), l = this.renderRoot.querySelector(".caret"), c = this.renderRoot.querySelector(".branch-vertical"), h = (r = this.renderRoot.querySelector("bim-table-children")) == null ? void 0 : r.querySelector(".branch-vertical"), d = () => {
				var g;
				((g = a == null ? void 0 : a.renderRoot) == null ? void 0 : g.querySelectorAll("bim-table-group"))?.forEach((y, x) => {
				...
				l?.animate([{ transform: "translateY(-50%) rotate(90deg)" }, { transform: "translateY(-50%) rotate(0deg)" }], {
					duration: o,
				...
				h?.animate([{ transform: "scaleY(0)" }, { transform: "scaleY(1)" }], {
					duration: n * 1.2,
					easing: "cubic-bezier(0.4, 0, 0.2, 1)",
					fill: "forwards",
					delay: (s + n) * .7
	...
	firstUpdated() {
		this.renderRoot.querySelectorAll(".caret").forEach((t) => {
			...
			if (!this.childrenHidden) {
				t.style.setProperty("transform", "translateY(-50%) rotate(90deg)");
				const o = (i = t.parentElement) == null ? void 0 : i.querySelector(".branch-horizontal");
				o && o.style.setProperty("transform", "scaleX(0)");
				((n = (s = t.parentElement) == null ? void 0 : s.parentElement) == null ? void 0 : n.querySelectorAll(".branch-vertical"))?.forEach((a) => {
	...
	render() {
		if (!this.table) return _`${W}`;
		const t = this.table.getGroupIndentation(this.data) ?? 0;
		let i;
		if (!this.table.noIndentation) i = _`<div style=${Yt({ left: `${t - 1 + (this.table.selectableRows ? 2.05 : .5625)}rem` })} class="branch branch-horizontal"></div>`;
		const s = _`
    ...
    `;
		...
		if (!this.table.noIndentation) {
			...
			if (r.setAttribute("height", "9.9"), r.setAttribute("width", "7.5"), r.setAttribute("viewBox", "0 0 4.6666672 7.7"), this.table.noCarets) {
				...
				l.setAttribute("d", "m 1.7470835,6.9583848 2.5899999,-2.59 c 0.39,-0.39 0.39,-1.02 0,-1.41 L 1.7470835,0.36838483 c -0.63,-0.62000003 -1.71000005,-0.18 -1.71000005,0.70999997 v 5.17 c 0,0.9 1.08000005,1.34 1.71000005,0.71 z"), r.append(l);
			}
			n = _`<div @click=${(l) => {
				var c;
      ...
      <div class="parent">
        <bim-table-row ${tt((r) => {
			...
			if (!r) return;
			const l = r;
			l.table = this.table, l.group = this, (a = this.table) == null || a.dispatchEvent(new CustomEvent("rowcreated", { detail: { row: l } }));
		})}>
...
var Qh = class extends j {
	constructor() {
		...
		}, { rootMargin: "36px" }), this._onDataSelected = () => {
			var t;
	...
	onSelectionChange(t) {
		...
		if (this.selected = i.value, i.value) {
			let s = [this.data];
			this.isHeader && (s = Gr.flattenData(this.table.data).map((n) => n.data)), this.table.selection.add(...s), this.isHeader && this.table.dispatchEvent(new CustomEvent("rowselected", { detail: { data: this.data } }));
	...
	render() {
		var t, i, s;
		if (!(this.table && this._intersecting)) return _`${W}`;
		...
		if ((t = this.groupData) != null && t._isComputedGroup) {
			...
			for (const l of a) this._columnNames.indexOf(l) !== 0 && (r[l] = "");
		}
		for (const a in r) {
			if (!((i = this.groupData) != null && i._isComputedGroup) && this.hiddenColumns.includes(a)) continue;
...
ro([ue()], Gs.prototype, "_intersecting");
ro([ue()], Gs.prototype, "dataTransform");
var Ng = Object.defineProperty, Hg = Object.getOwnPropertyDescriptor, xt = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? Hg(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
	return s && n && Ng(t, i, n), n;
}, Js;
var vt = (Js = class extends j {
		...
		super(), this._value = [], this.headersHidden = !1, this.minColWidth = "4rem", this._columns = [], this._textDelimiters = {
			...
			for (const n of s) {
				...
				if (a.startsWith("[") && a.endsWith("]")) {
					...
					a = l, i = Object.keys(t.data).filter((c) => c.includes(l)).map((c) => ul(t.data[c], o, r)).some((c) => c);
				} else i = ul(t.data[a], o, r);
				if (!i) break;
			}
			return i;
	...
	static flattenData(e) {
		const t = [];
		for (const i of e) t.push({ data: i.data }), i.children && i.children.length > 0 && t.push(...Js.flattenData(i.children));
		return t;
	}
	set columns(e) {
		const t = [];
	...
	*/
	...
	emitDataSelected(e) {
		this.dispatchEvent(new CustomEvent("dataselected", { detail: e }));
	}
	emitDataDeselected(e) {
		this.dispatchEvent(new CustomEvent("datadeselected", { detail: e }));
	}
	emitDataCleared() {
	...
	computeMissingColumns(e) {
		...
		for (const i of e) {
			...
			for (const o in n) this._columns.map((r) => typeof r == "string" ? r : r.name).includes(o) || (this._columns.push({
				name: o,
				width: `minmax(${this.minColWidth}, 1fr)`
			}), t = !0);
			if (s) {
...
`;
		...
		for (const [a, l] of t.entries()) {
			const { data: c, children: h } = l, p = `${this.indentationInText ? `${i}${a + 1}${n}` : ""}${r.map((m) => c[m] ?? "").join(n)}
`;
			o += p, h && (o += this.generateText(e, l.children, `${i}${a + 1}.`, !1));
		}
		return o;
	}
	/**
	...
	*/
	downloadData(e = "BIM Table Data", t = "json") {
		let i = null;
		if (t === "json" && (i = new File([JSON.stringify(this.value, void 0, 2)], `${e}.json`)), t === "csv" && (i = new File([this.csv], `${e}.csv`)), t === "tsv" && (i = new File([this.tsv], `${e}.tsv`)), !i) return;
	...
	getRowIndentation(e, t = this.value, i = 0) {
		for (const s of t) {
			...
			if (s.children) {
				const n = this.getRowIndentation(e, s.children, i + 1);
				if (n !== null) return n;
			}
		}
		return null;
	...
	getGroupIndentation(e, t = this.value, i = 0) {
		for (const s of t) {
			if (s === e) return i;
			if (s.children) {
				const n = this.getGroupIndentation(e, s.children, i + 1);
				if (n !== null) return n;
			}
		}
		return null;
	...
	*/
	async loadData(e = !1) {
		if (this._value.length !== 0 && !e || !this.loadFunction) return !1;
		this.loading = !0;
		try {
			...
			const i = this.querySelector("[slot='error-loading']"), s = i == null ? void 0 : i.querySelector("[data-table-element='error-message']");
	...
	*/
	getGroupingMessageTemplate() {
		if (this.groupedBy.length === 0) return W;
		return _`
	...
	render() {
		if (this.loading) return Og();
		if (this._errorLoading) return _`<slot name="error-loading"></slot>`;
		if (this._value.length === 0 && this._missingDataElement) return _`<slot name="missing-data"></slot>`;
		const e = (i) => {
			if (!i) return;
			const s = i;
...
xt([w({ attribute: !1 })], vt.prototype, "groupingTransform", 2);
xt([w({
	type: Boolean,
	reflect: !0,
...
xt([ue()], vt.prototype, "_errorLoading", 2);
xt([w({
	type: Boolean,
...
var Vg = Object.defineProperty, Ug = Object.getOwnPropertyDescriptor, Ri = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? Ug(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
...
var td = class extends j {
	...
	set tab(t) {
		this._tab = t;
		const i = [...this.children], s = i.find((n) => n instanceof Mt && n.name === t);
		for (const n of i) {
			if (!(n instanceof Mt)) continue;
			n.hidden = s !== n;
	...
	getTabSwitcher(t) {
		return this._switchers.find((i) => i.getAttribute("data-name") === t);
	}
	createSwitchers() {
		this._switchers = [];
	...
	updateSwitchers() {
		for (const t of this.children) {
			if (!(t instanceof Mt)) continue;
			const i = this._switchers.find((n) => n.getAttribute("data-name") === t.name);
			if (!i) continue;
	...
	setAnimatedBackgound(t = !1) {
		var i;
		const s = this.renderRoot.querySelector(".animated-background"), n = [...((i = this.renderRoot.querySelector(".switchers")) == null ? void 0 : i.querySelectorAll(".switcher")) || []].filter((o) => o.hasAttribute("data-active"))[0];
		requestAnimationFrame(() => {
			var o, r, a, l;
			...
			n ? (s?.style.setProperty("width", `${h.width}px`), s?.style.setProperty("height", `${h.height}px`), s?.style.setProperty("left", `${h.left}px`)) : s?.style.setProperty("width", "0"), this.bottom ? (s?.style.setProperty("top", "100%"), s?.style.setProperty("transform", "translateY(-100%)")) : s?.style.setProperty("top", `${h.top}px`);
		}), t && this.doubleRequestAnimationFrames(() => {
			const o = "ease";
			s?.style.setProperty("transition", `width 0.3s ${o}, height 0.3s ${o}, top 0.3s ${o}, left 0.3s ${o}`);
		});
	}
	firstUpdated() {
		requestAnimationFrame(() => {
...
td.styles = [De.scrollbar, H`
    ...
    `];
var de = td;
Ri([ue()], de.prototype, "_switchers", 2);
Ri([w({
	type: Boolean,
	reflect: !0
...
var Wg = Object.defineProperty, qg = Object.getOwnPropertyDescriptor, ao = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? qg(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
	return s && n && Wg(t, i, n), n;
};
...
var Yg = Object.defineProperty, Gg = Object.getOwnPropertyDescriptor, Vt = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? Gg(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
...
var id = class extends j {
	...
	*/
	...
	focus() {
		setTimeout(() => {
			var t;
			((t = this.shadowRoot) == null ? void 0 : t.querySelector("input"))?.focus();
		});
	}
	render() {
		return _`
...
var Xg = Object.defineProperty, Zg = Object.getOwnPropertyDescriptor, sd = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? Zg(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
...
var nd = class extends j {
	...
	updateChildren() {
		...
		for (const i of t) this.vertical ? i.setAttribute("label-hidden", "") : i.removeAttribute("label-hidden");
	}
	render() {
		return _`
      <style>
...
var Kg = Object.defineProperty, Jg = Object.getOwnPropertyDescriptor, co = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? Jg(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
...
var od = class extends j {
	...
	updateChildren() {
		const t = this.children;
		for (const i of t) i instanceof lo && (i.vertical = this.vertical), i.toggleAttribute("label-hidden", this.vertical);
	}
	render() {
		return _`
      <div class="parent">
...
var Qg = Object.defineProperty, tb = Object.getOwnPropertyDescriptor, Xr = (e, t, i, s) => {
	for (var n = s > 1 ? void 0 : s ? tb(t, i) : t, o = e.length - 1, r; o >= 0; o--) (r = e[o]) && (n = (s ? r(t, i, n) : r(n)) || n);
...
var rd = class extends j {
	...
	updateSections() {
		const t = this.children;
		for (const i of t) i instanceof zi && (i.labelHidden = this.vertical && !ut.config.sectionLabelOnVerticalToolbar, i.vertical = this.vertical);
	}
	render() {
		return _`
      <div class="parent">
...
var cd = class extends j {
	...
	_getHideEventData() {
		...
		for (const s in this.labels) {
			...
			for (const r of Object.values(this._charts[0].inputData.datasets)) o.push((t = r[s]) == null ? void 0 : t.data);
			i[n] = o;
		}
		return i;
	}
	...
	render() {
		if (this._charts.length === 0 || !this._charts[0].data) return _`<slot name="no-chart"></slot>`;
...
var Dt = {
	...
	e: 14,
	f: 15
}, lr = [..."0123456789ABCDEF"], ob = (e) => lr[e & 15], rb = (e) => lr[(e & 240) >> 4] + lr[e & 15], Qs = (e) => (e & 240) >> 4 === (e & 15), ab = (e) => Qs(e.r) && Qs(e.g) && Qs(e.b) && Qs(e.a);
function lb(e) {
	var t = e.length, i;
...
function pb(e, t, i) {
	const s = dd(e, 1, .5);
	let n;
	for (t + i > 1 && (n = 1 / (t + i), t *= n, i *= n), n = 0; n < 3; n++) s[n] *= 1 - t - i, s[n] += t;
	return s;
}
...
function Zr(e) {
	...
	let a, l, c;
	return n !== o && (c = n - o, l = r > .5 ? c / (2 - n - o) : c / (n + o), a = fb(t, i, s, c, n), a = a * 60 + .5), [
		a | 0,
		l || 0,
		r
	];
...
function xb() {
	...
	for (s = 0; s < t.length; s++) {
		for (r = a = t[s], n = 0; n < i.length; n++) o = i[n], a = a.replace(o, fl[o]);
		o = parseInt(ml[r], 16), e[a] = [
			o >> 16 & 255,
			o >> 8 & 255,
			o & 255
		];
...
var Oo = (e) => e <= .0031308 ? e * 12.92 : Math.pow(e, 1 / 2.4) * 1.055 - .055, ci = (e) => e <= .04045 ? e / 12.92 : Math.pow((e + .055) / 1.055, 2.4);
function Sb(e, t, i) {
...
var Ai = class Ai {
	constructor(t) {
		...
		const i = typeof t;
		let s;
		i === "object" ? s = gl(t) : i === "string" && (s = lb(t) || _b(t) || Cb(t)), this._rgb = s, this._valid = !!s;
	}
	get valid() {
		return this._valid;
	}
	...
	mix(t, i) {
		if (t) {
			...
			let o;
			const r = i === o ? .5 : i, a = 2 * r - 1, l = s.a - n.a, c = ((a * l === -1 ? a : (a + l) / (1 + a * l)) + 1) / 2;
			o = 1 - c, s.r = 255 & c * s.r + o * n.r + .5, s.g = 255 & c * s.g + o * n.g + .5, s.b = 255 & c * s.b + o * n.b + .5, s.a = r * s.a + (1 - r) * n.a, this.rgb = s;
		}
		return this;
	}
	interpolate(t, i) {
		return t && (this._rgb = Sb(this._rgb, t._rgb, i)), this;
	}
	clone() {
	...
	greyscale() {
		const t = this._rgb;
		return t.r = t.g = t.b = Xs(t.r * .3 + t.g * .59 + t.b * .11), this;
	}
	opaquer(t) {
		const i = this._rgb;
		return i.a *= 1 + t, this;
...
var Eb = (e, t) => typeof e == "string" && e.endsWith("%") ? parseFloat(e) / 100 : +e / t, fd = (e, t) => typeof e == "string" && e.endsWith("%") ? parseFloat(e) / 100 * t : +e;
function q(e, t, i) {
	if (e && typeof e.call == "function") return e.apply(i, t);
}
function U(e, t, i, s) {
	let n, o, r;
	if (Z(e)) for (o = e.length, n = 0; n < o; n++) t.call(i, e[n], n);
	else if (F(e)) for (r = Object.keys(e), o = r.length, n = 0; n < o; n++) t.call(i, e[r[n]], r[n]);
}
function Nn(e, t) {
	let i, s, n, o;
	if (!e || !t || e.length !== t.length) return !1;
	for (i = 0, s = e.length; i < s; ++i) if (n = e[i], o = t[i], n.datasetIndex !== o.datasetIndex || n.index !== o.index) return !1;
	return !0;
}
function Hn(e) {
	if (Z(e)) return e.map(Hn);
	if (F(e)) {
		const t = /* @__PURE__ */ Object.create(null), i = Object.keys(e), s = i.length;
		let n = 0;
		for (; n < s; ++n) t[i[n]] = Hn(e[i[n]]);
		return t;
	}
	return e;
}
...
function Db(e) {
	const t = e.split("."), i = [];
	let s = "";
	for (const n of t) s += n, s.endsWith("\\") ? s = s.slice(0, -1) + "." : (i.push(s), s = "");
	return i;
}
function Ob(e) {
	const t = Db(e);
...
var As = (e) => typeof e < "u", Ee = (e) => typeof e == "function", yl = (e, t) => {
...
var N = Math.PI, K = 2 * N, Lb = K + N, Vn = Number.POSITIVE_INFINITY, Rb = N / 180, nt = N / 2, je = N / 4, vl = N * 2 / 3, ve = Math.log10, Gt = Math.sign;
function ls(e, t, i) {
...
function zb(e) {
	...
	let s;
	for (s = 1; s < i; s++) e % s === 0 && (t.push(s), t.push(e / s));
...
function gd(e, t, i) {
	let s, n, o;
	for (s = 0, n = e.length; s < n; s++) o = e[s][i], isNaN(o) || (t.min = Math.min(t.min, o), t.max = Math.max(t.max, o));
}
function Ft(e) {
	return e * (N / 180);
}
...
var ia = (e) => e === "start" ? "left" : e === "end" ? "right" : "center", gt = (e, t, i) => e === "start" ? t : e === "end" ? i : (t + i) / 2, qb = (e, t, i, s) => e === (s ? "left" : "right") ? i : e === "center" ? (t + i) / 2 : t;
function wd(e, t, i) {
	const s = t.length;
	let n = 0, o = s;
	if (e._sorted) {
		...
		if (p) {
			if (n = Math.min(oe(l, h, d).lo, i ? s : oe(t, h, r.getPixelForValue(d)).lo), c) {
		...
		if (m) {
			let f = Math.max(oe(l, r.axis, u, !0).hi + 1, i ? 0 : oe(t, h, r.getPixelForValue(u), !0).hi + 1);
			if (c) {
...
function kd(e) {
	...
	if (!s) return e._scaleRanges = n, !0;
	const o = s.xmin !== t.min || s.xmax !== t.max || s.ymin !== i.min || s.ymax !== i.max;
	return Object.assign(s, n), o;
}
var sn = (e) => e === 0 || e === 1, kl = (e, t, i) => -(Math.pow(2, 10 * (e -= 1)) * Math.sin((e - t) * K / i)), $l = (e, t, i) => Math.pow(2, -10 * e) * Math.sin((e - t) * K / i) + 1, cs = {
	linear: (e) => e,
	easeInQuad: (e) => e * e,
	easeOutQuad: (e) => -e * (e - 2),
	...
	easeInOutSine: (e) => -.5 * (Math.cos(N * e) - 1),
	easeInExpo: (e) => e === 0 ? 0 : Math.pow(2, 10 * (e - 1)),
	easeOutExpo: (e) => e === 1 ? 1 : -Math.pow(2, -10 * e) + 1,
	easeInOutExpo: (e) => sn(e) ? e : e < .5 ? .5 * Math.pow(2, 10 * (e * 2 - 1)) : .5 * (-Math.pow(2, -10 * (e * 2 - 1)) + 2),
	easeInCirc: (e) => e >= 1 ? e : -(Math.sqrt(1 - e * e) - 1),
	easeOutCirc: (e) => Math.sqrt(1 - (e -= 1) * e),
	easeInOutCirc: (e) => (e /= .5) < 1 ? -.5 * (Math.sqrt(1 - e * e) - 1) : .5 * (Math.sqrt(1 - (e -= 2) * e) + 1),
	easeInElastic: (e) => sn(e) ? e : kl(e, .075, .3),
	easeOutElastic: (e) => sn(e) ? e : $l(e, .075, .3),
	easeInOutElastic(e) {
		return sn(e) ? e : e < .5 ? .5 * kl(e * 2, .1125, .45) : .5 + .5 * $l(e * 2 - 1, .1125, .45);
	},
	easeInBack(e) {
	...
	easeInOutBounce: (e) => e < .5 ? cs.easeInBounce(e * 2) * .5 : cs.easeOutBounce(e * 2 - 1) * .5 + .5
};
function sa(e) {
...
function Io(e) {
	return sa(e) ? e : new Ai(e).saturate(.5).darken(.1).hexString();
}
var Yb = [
	"x",
	"y",
...
function Kb(e, t) {
	...
	let s = Cl.get(i);
	return s || (s = new Intl.NumberFormat(e, t), Cl.set(i, s)), s;
}
function Zs(e, t, i) {
...
var $d = {
	...
	numeric(e, t, i) {
		...
		if (i.length > 1) {
			...
			(c < 1e-4 || c > 0x38d7ea4c68000) && (n = "scientific"), o = Jb(e, i);
		}
	...
	logarithmic(e, t, i) {
		...
		return [
			...
			10,
			15
		].includes(s) || t > .8 * i.length ? $d.numeric.call(this, e, t, i) : "";
	}
};
function Jb(e, t) {
...
var si = /* @__PURE__ */ Object.create(null), hr = /* @__PURE__ */ Object.create(null);
function hs(e, t) {
	if (!t) return e;
	const i = t.split(".");
...
function iy(e, t, i, s) {
	...
	const a = i.length;
	let l, c, h, d, u;
	for (l = 0; l < a; l++) if (d = i[l], d != null && !Z(d)) r = Un(e, n, o, r, d);
	else if (Z(d)) for (c = 0, h = d.length; c < h; c++) u = d[c], u != null && !Z(u) && (r = Un(e, n, o, r, u));
	e.restore();
	const p = o.length / 2;
	if (p > i.length) {
...
function Ne(e, t, i) {
	const s = e.currentDevicePixelRatio, n = i !== 0 ? Math.max(i / 2, .5) : 0;
	...
	if (!(isNaN(f) || f <= 0)) {
		switch (e.beginPath(), p) {
			...
			case "triangle":
				...
				break;
			case "rectRounded":
				c = f * .516, l = f - c, r = Math.cos(g + je) * l, d = Math.cos(g + je) * (n ? n / 2 - c : l), a = Math.sin(g + je) * l, u = Math.sin(g + je) * (n ? n / 2 - c : l), e.arc(i - d, s - a, c, g - N, g - nt), e.arc(i + u, s - r, c, g - nt, g), e.arc(i + d, s + a, c, g, g + nt), e.arc(i - u, s + r, c, g + nt, g + N), e.closePath();
				break;
			case "rect":
				if (!m) {
...
function ni(e, t, i, s, n, o = {}) {
	...
	let l, c;
	for (e.save(), e.font = n.string, oy(e, o), l = 0; l < r.length; ++l) c = r[l], o.backdrop && ay(e, o.backdrop), a && (o.strokeColor && (e.strokeStyle = o.strokeColor), z(o.strokeWidth) || (e.lineWidth = o.strokeWidth), e.strokeText(c, i, s, o.maxWidth)), e.fillText(c, i, s, o.maxWidth), ry(e, i, s, c, o), s += Number(n.lineHeight);
	e.restore();
}
function Es(e, t) {
...
var ly = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/, cy = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function hy(e, t) {
	const i = ("" + e).match(ly);
...
function X(e, t, i, s) {
	let n, o, r;
	for (n = 0, o = e.length; n < o; ++n) if (r = e[n], r !== void 0 && (t !== void 0 && typeof r == "function" && (r = r(t)), i !== void 0 && Z(r) && (r = r[i % r.length]), r !== void 0)) return r;
}
function uy(e, t, i) {
...
var py = (e, t) => e ? e + Qr(t) : t, ra = (e, t) => F(t) && e !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function Md(e, t, i) {
...
var by = (e, t) => e === !0 ? t : typeof e == "string" ? Me(t, e) : void 0;
...
function aa(e, t, i, s) {
	const n = t._rootScopes, o = Ed(t._fallback, i, s), r = [...e, ...n], a = /* @__PURE__ */ new Set();
	a.add(s);
	let l = Ml(a, r, i, o || i, s);
	return l === null || typeof o < "u" && o !== i && (l = Ml(a, r, o, l, s), l === null) ? !1 : oa(Array.from(a), [""], n, o, () => vy(t, i, s));
}
function Ml(e, t, i, s, n) {
	for (; i;) i = yy(e, t, i, s, n);
	return i;
}
function vy(e, t, i) {
...
function xy(e, t, i, s) {
	let n;
	for (const o of t) if (n = Td(py(o, e), i), typeof n < "u") return ra(e, n) ? aa(i, s, e, n) : n;
}
function Td(e, t) {
	for (const i of t) {
		if (!i) continue;
...
function _y(e) {
	...
	for (const i of e) for (const s of Object.keys(i).filter((n) => !n.startsWith("_"))) t.add(s);
	return Array.from(t);
}
function Pd(e, t, i, s) {
	const { iScale: n } = e, { key: o = "r" } = this._parsing, r = new Array(s);
	let a, l, c, h;
	for (a = 0, l = s; a < l; ++a) c = a + i, h = t[c], r[a] = { r: n.parse(Me(h, o), c) };
	return r;
}
var wy = Number.EPSILON || 1e-14, Ti = (e, t) => t < e.length && !e[t].skip && e[t], Dd = (e) => e === "x" ? "y" : "x";
function ky(e, t, i, s) {
...
function $y(e, t, i) {
	...
	for (let h = 0; h < s - 1; ++h) if (l = c, c = Ti(e, h + 1), !(!l || !c)) {
		if (ls(t[h], 0, wy)) {
			i[h] = i[h + 1] = 0;
			continue;
		}
...
function Sy(e, t, i = "x") {
	...
	let o, r, a, l = Ti(e, 0);
	for (let c = 0; c < n; ++c) {
		if (r = a, a = l, l = Ti(e, c + 1), !a) continue;
		const h = a[i], d = a[s];
...
function Cy(e, t = "x") {
	...
	let r, a, l, c = Ti(e, 0);
	for (r = 0; r < s; ++r) if (a = l, l = c, c = Ti(e, r + 1), !!l) {
		if (c) {
			const h = c[t] - l[t];
			n[r] = h !== 0 ? (c[i] - l[i]) / h : 0;
		}
...
function Ay(e, t) {
	...
	for (i = 0, s = e.length; i < s; ++i) r = o, o = a, a = i < s - 1 && re(e[i + 1], t), o && (n = e[i], r && (n.cp1x = nn(n.cp1x, t.left, t.right), n.cp1y = nn(n.cp1y, t.top, t.bottom)), a && (n.cp2x = nn(n.cp2x, t.left, t.right), n.cp2y = nn(n.cp2y, t.top, t.bottom)));
}
function My(e, t, i, s, n) {
	let o, r, a, l;
	if (t.spanGaps && (e = e.filter((c) => !c.skip)), t.cubicInterpolationMode === "monotone") Cy(e, n);
	else {
		let c = s ? e[e.length - 1] : e[0];
		for (o = 0, r = e.length; o < r; ++o) a = e[o], l = ky(c, a, e[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension), a.cp1x = l.previous.x, a.cp1y = l.previous.y, a.cp2x = l.next.x, a.cp2y = l.next.y, c = a;
	}
...
function zy(e, t, i, s) {
	const n = {
		...
		x: t.cp1x,
		y: t.cp1y
	}, r = We(e, n, i), a = We(n, o, i), l = We(o, t, i);
	return We(We(r, a, i), We(a, l, i), i);
}
var Fy = function(e, t) {
	return {
		x(i) {
...
function Od(e, t) {
	let i, s;
	(t === "ltr" || t === "rtl") && (i = e.canvas.style, s = [i.getPropertyValue("direction"), i.getPropertyPriority("direction")], i.setProperty("direction", t, "important"), e.prevTextDirection = s);
}
function Id(e, t) {
...
function Rd(e, t, i) {
	...
	const v = () => l(n, x, b) && a(n, x) !== 0, k = () => a(o, b) === 0 || l(o, x, b), $ = () => f || v(), S = () => !f || k();
	for (let C = h, T = h; C <= d; ++C) y = t[C % r], !y.skip && (b = c(y[s]), b !== x && (f = l(b, n, o), g === null && $() && (g = a(b, n) === 0 ? C : T), g !== null && S() && (m.push(Dl({
		start: g,
		end: C,
		loop: u,
		count: r,
...
function Ny(e, t, i, s) {
	let n = 0, o = t - 1;
	if (i && !s) for (; n < t && !e[n].skip;) n++;
	for (; n < t && e[n].skip;) n++;
	for (n %= t, i && (o += n); o > n && e[o % t].skip;) o--;
	return o %= t, {
		start: n,
		end: o
	};
...
function Vy(e, t) {
	...
	return Ol(e, Hy(i, r, a < r ? a + n : a, !!e._fullLoop && r === 0 && a === n - 1), i, t);
}
function Ol(e, t, i, s) {
...
var Ll = "transparent", Gy = {
	boolean(e, t, i) {
		return i > .5 ? t : e;
	},
	color(e, t, i) {
		const s = Sl(e || Ll), n = s.valid && Sl(t || Ll);
...
var Xy = class {
	...
	_notify(t) {
		...
		for (let n = 0; n < s.length; n++) s[n][i]();
	}
};
var Bd = class {
	constructor(t, i) {
...
function Ui(e, t) {
	...
	if (s) {
		...
		for (const n of t) {
			const o = n._stacks;
			if (!o || o[s] === void 0 || o[s][i] === void 0) return;
			delete o[s][i], o[s]._visualValues !== void 0 && o[s]._visualValues[i] !== void 0 && delete o[s]._visualValues[i];
		}
	}
}
var Fo = (e) => e === "reset" || e === "none", jl = (e, t) => t ? e : Object.assign({}, e), rv = (e, t, i) => e && !t.hidden && t._stacked && {
	keys: jd(i, !0),
	values: null
};
var Bt = class {
	...
	parse(t, i) {
		...
		if (this._parsing === !1) s._parsed = n, s._sorted = !0, u = n;
			...
			for (h = 0; h < i; ++h) s._parsed[h + t] = d = u[h], l && (p() && (l = !1), c = d);
			s._sorted = l;
		}
		r && Bl(this, u);
	}
	...
	parseArrayData(t, i, s, n) {
		...
		let l, c, h, d;
		for (l = 0, c = n; l < c; ++l) h = l + s, d = i[h], a[l] = {
			x: o.parse(d[0], h),
			y: r.parse(d[1], h)
		};
		return a;
	...
	parseObjectData(t, i, s, n) {
		...
		let h, d, u, p;
		for (h = 0, d = n; h < d; ++h) u = h + s, p = i[u], c[h] = {
			x: o.parse(Me(p, a), u),
			y: r.parse(Me(p, l), u)
		};
		return c;
	...
	applyStack(t, i, s) {
		const n = this.chart, o = this._cachedMeta, r = i[t.axis];
		return zl({
			keys: jd(n, !0),
	...
	getAllParsedValues(t) {
		...
		let n, o, r;
		for (n = 0, o = i.length; n < o; ++n) r = i[n][t.axis], it(r) && s.push(r);
		return s;
	}
	getMaxOverflow() {
		return !1;
	...
	getContext(t, i, s) {
		...
		} else o = this.$context || (this.$context = nv(this.chart.getContext(), this.index)), o.dataset = n, o.index = o.datasetIndex = this.index;
	...
	_resolveElementOptions(t, i = "default", s) {
		...
		const c = this.chart.config, h = c.datasetElementScopeKeys(this._type, t), d = n ? [
			...
			t,
			""
		] : [t, ""], u = c.getOptionScopes(this.getDataset(), h), p = Object.keys(J.elements[t]), m = () => this.getContext(s, n, i), f = c.resolveNamedOptions(u, p, m, d);
	...
	_setStyle(t, i, s, n) {
		...
		this._resolveAnimations(i, s, n).update(t, { options: !n && this.getSharedOptions(o) || o });
	}
...
function av(e, t) {
	if (!e._cache.$bar) {
		...
		let s = [];
		for (let n = 0, o = i.length; n < o; n++) s = s.concat(i[n].controller.getAllParsedValues(e));
...
function lv(e) {
	...
	for (n = 0, o = i.length; n < o; ++n) r = t.getPixelForValue(i[n]), l();
...
function Nl(e, t, i, s) {
	...
	let c, h, d, u;
	for (c = i, h = i + s; c < h; ++c) u = t[c], d = {}, d[n.axis] = a || n.parse(r[c], c), l.push(Nd(u, d, o, c));
	return l;
}
function Bo(e) {
...
var _n = class extends Bt {
	...
	parseObjectData(t, i, s, n) {
		...
		let u, p, m, f;
		for (u = s, p = s + n; u < p; ++u) f = i[u], m = {}, m[o.axis] = o.parse(Me(f, c), u), d.push(Nd(Me(f, h), m, r, u));
		return d;
	}
	updateRangeFromParsed(t, i, s, n) {
	...
	getLabelAndValue(t) {
		const { iScale: s, vScale: n } = this._cachedMeta, o = this.getParsed(t), r = o._custom, a = Bo(r) ? "[" + r.start + ", " + r.end + "]" : "" + n.getLabelForValue(o[n.axis]);
		return {
	...
	_getStacks(t, i) {
		...
		for (const h of n) if (!(i !== void 0 && c(h)) && ((o === !1 || r.indexOf(h.stack) === -1 || o === void 0 && h.stack === void 0) && r.push(h.stack), h.index === t)) break;
	...
	_getAxis() {
		...
		for (const s of this.chart.data.datasets) t[L(this.chart.options.indexAxis === "x" ? s.xAxisID : s.yAxisID, i)] = !0;
	...
	_getRuler() {
		...
		let o, r;
		for (o = 0, r = i.data.length; o < r; ++o) n.push(s.getPixelForValue(this.getParsed(o)[s.axis], o));
	...
	_calculateBarValuePixels(t) {
		...
		if (this.chart.getDataVisibility(t) ? m = i.getPixelForValue(u + p) : m = b, f = m - b, Math.abs(f) < r) {
			...
			const y = i.getPixelForDecimal(0), x = i.getPixelForDecimal(1);
			b = Math.max(Math.min(b, Math.max(y, x)), Math.min(y, x)), m = b + f, s && !h && (l._stacks[i.axis]._visualValues[n] = i.getValueForPixel(m) - i.getValueForPixel(b));
		}
	...
	_calculateBarIndexPixels(t, i) {
		const s = i.scale, n = this.options, o = n.skipNull, r = L(n.maxBarThickness, Infinity);
		let a, l;
		...
		} else a = s.getPixelForValue(this.getParsed(t)[s.axis], t), l = Math.min(r, i.min * i.ratio);
		return {
			base: a - l / 2,
			head: a + l / 2,
			center: a,
	...
	draw() {
		...
		let o = 0;
		for (; o < n; ++o) this.getParsed(o)[i.axis] !== null && !s[o].hidden && s[o].draw(this._ctx);
	}
};
...
var wn = class extends Bt {
	...
	getMaxOverflow() {
		...
		let i = 0;
		for (let s = t.length - 1; s >= 0; --s) i = Math.max(i, t[s].size(this.resolveDataElementOptions(s)) / 2);
		return i > 0 && i;
	}
	getLabelAndValue(t) {
	...
	updateElements(t, i, s, n) {
		...
		for (let u = i; u < i + s; u++) {
			const p = t[u], m = !o && this.getParsed(u), f = {}, g = f[h] = o ? r.getPixelForDecimal(.5) : r.getPixelForValue(m[h]), b = f[d] = o ? a.getBasePixel() : a.getPixelForValue(m[d]);
...
var Ge = class extends Bt {
	...
	parse(t, i) {
		...
		if (this._parsing === !1) n._parsed = s;
			...
			let r, a;
			for (r = t, a = t + i; r < a; ++r) n._parsed[r] = o(r);
		}
	}
	_getRotation() {
	...
	update(t) {
		const { chartArea: s } = this.chart, n = this._cachedMeta, o = n.data, r = this.getMaxBorderWidth() + this.getMaxOffset(o) + this.options.spacing, a = Math.max((Math.min(s.width, s.height) - r) / 2, 0), l = Math.min(Eb(this.options.cutout, a), 1), c = this._getRingWeight(this.index), { circumference: h, rotation: d } = this._getRotationExtents(), { ratioX: u, ratioY: p, offsetX: m, offsetY: f } = bv(d, h, l), g = (s.width - r) / u, b = (s.height - r) / p, y = Math.max(Math.min(g, b) / 2, 0), x = fd(this.options.radius, y), k = (x - Math.max(x * l, 0)) / this._getVisibleDatasetWeightTotal();
	...
	updateElements(t, i, s, n) {
		...
		for (b = 0; b < i; ++b) g += this._circumference(b, o);
		for (b = i; b < i + s; ++b) {
	...
	_getRingWeightOffset(t) {
		let i = 0;
		for (let s = 0; s < t; ++s) this.chart.isDatasetVisible(s) && (i += this._getRingWeight(s));
		return i;
	}
	_getRingWeight(t) {
...
var kn = class extends Bt {
	...
	updateElements(t, i, s, n) {
		...
		for (let k = 0; k < x; ++k) {
			...
			const C = this.getParsed(k), T = z(C[p]), M = S[u] = r.getPixelForValue(C[u], k), D = S[p] = o || T ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, C, l) : C[p], k);
			S.skip = isNaN(M) || isNaN(D) || T, S.stop = k > 0 && Math.abs(C[u] - v[u]) > g, f && (S.parsed = C, S.raw = c.data[k]), d && (S.options = h || this.resolveDataElementOptions(k, $.active ? "active" : n)), b || this.updateElement($, k, S, n), v = C;
		}
	}
	getMaxOverflow() {
...
var ds = class extends Bt {
	...
	_updateRadius() {
		const t = this.chart, i = t.chartArea, s = t.options, n = Math.min(i.right - i.left, i.bottom - i.top), o = Math.max(n / 2, 0), a = (o - Math.max(s.cutoutPercentage ? o / 100 * s.cutoutPercentage : 1, 0)) / t.getVisibleDatasetCount();
		this.outerRadius = o - a * this.index, this.innerRadius = this.outerRadius - a;
	}
	updateElements(t, i, s, n) {
		const o = n === "reset", r = this.chart, a = r.options.animation, l = this._cachedMeta.rScale, c = l.xCenter, h = l.yCenter, d = l.getIndexAngle(0) - .5 * N;
		let u = d, p;
		const m = 360 / this.countVisibleElements();
		for (p = 0; p < i; ++p) u += this._computeAngle(p, n, m);
		for (p = i; p < i + s; p++) {
			const f = t[p];
...
var Sn = class extends Bt {
	...
	updateElements(t, i, s, n) {
		...
		for (let v = i; v < i + s; ++v) {
			const k = t[v], $ = this.getParsed(v), S = y ? k : {}, C = z($[m]), T = S[p] = r.getPixelForValue($[p], v), M = S[m] = o || C ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, $, l) : $[m], v);
			S.skip = isNaN(T) || isNaN(M) || C, S.stop = v > 0 && Math.abs($[p] - x[p]) > b, g && (S.parsed = $, S.raw = c.data[v]), u && (S.options = d || this.resolveDataElementOptions(v, k.active ? "active" : n)), y || this.updateElement(k, v, S, n), x = $;
		}
	...
	getMaxOverflow() {
		...
		if (!this.options.showLine) {
			let a = 0;
			for (let l = i.length - 1; l >= 0; --l) a = Math.max(a, i[l].size(this.resolveDataElementOptions(l)) / 2);
			return a > 0 && a;
		}
...
function wv(e, t, i, s) {
	let n = [];
	function o(r, a, l) {
		const { startAngle: c, endAngle: h } = r.getProps(["startAngle", "endAngle"], s), { angle: d } = bd(r, {
			x: t.x,
			y: t.y
		});
		Ms(d, c, h) && n.push({
...
function kv(e, t, i, s, n, o) {
	...
	function c(h, d, u) {
		...
		if (!(o || e.isPointInArea(m)) && !p) return;
		const f = a(t, m);
		f < l ? (r = [{
			element: h,
			datasetIndex: d,
...
var $v = { modes: {
	...
	point(e, t, i, s) {
		return jo(e, Ue(t, e), i.axis || "xy", s, i.includeInvisible || !1);
	},
	nearest(e, t, i, s) {
		const n = Ue(t, e), o = i.axis || "xy", r = i.includeInvisible || !1;
	...
	x(e, t, i, s) {
		return Ul(e, Ue(t, e), "x", i.intersect, s);
	},
	y(e, t, i, s) {
		return Ul(e, Ue(t, e), "y", i.intersect, s);
	}
} };
var Hd = [
	"left",
...
function Sv(e) {
	const t = [];
	let i, s, n, o, r, a;
	for (i = 0, s = (e || []).length; i < s; ++i) n = e[i], {position: o, options: {stack: r, stackWeight: a = 1}} = n, t.push({
		index: i,
		box: n,
		pos: o,
...
function Av(e, t) {
	const i = Cv(e), { vBoxMaxWidth: s, hBoxMaxHeight: n } = t;
	let o, r, a;
...
function Mv(e) {
	const t = Sv(e), i = qi(t.filter((c) => c.box.fullSize), !0), s = qi(Wi(t, "left"), !0), n = qi(Wi(t, "right")), o = qi(Wi(t, "top"), !0), r = qi(Wi(t, "bottom")), a = Wl(t, "x"), l = Wl(t, "y");
	return {
		fullSize: i,
...
function Iv(e, t) {
	...
	if (Gl(s)) if (e.style.height === "") e.height = e.width / (t || 2);
	else {
		const o = Pl(e, "height");
		o !== void 0 && (e.height = o);
	}
...
function Fv(e, t, i) {
	const s = e.canvas, n = new MutationObserver((o) => {
		let r = !1;
		for (const a of o) r = r || qn(a.addedNodes, s), r = r && !qn(a.removedNodes, s);
		r && i();
	});
...
function Bv(e, t, i) {
	const s = e.canvas, n = new MutationObserver((o) => {
		let r = !1;
		for (const a of o) r = r || qn(a.removedNodes, s), r = r && !qn(a.addedNodes, s);
		r && i();
	});
	return n.observe(document, {
		childList: !0,
...
function qv(e, t) {
	...
	if (r > n) return Zv(t, c, o, r / n), c;
	const h = Gv(o, t, n);
	if (r > 0) {
		let d, u;
		const p = r > 1 ? Math.round((l - a) / (r - 1)) : null;
		for (ln(t, c, h, z(p) ? 0 : a - p, a), d = 0, u = r - 1; d < u; d++) ln(t, c, h, o[d], o[d + 1]);
...
function Xv(e) {
	const t = [];
	let i, s;
	for (i = 0, s = e.length; i < s; i++) e[i].major && t.push(i);
	return t;
}
function Zv(e, t, i, s) {
	let n = 0, o = i[0], r;
	for (s = Math.ceil(s), r = 0; r < e.length; r++) r === o && (t.push(e[r]), n++, o = i[n * s]);
}
function ln(e, t, i, s, n) {
	const o = L(s, 0), r = Math.min(L(n, e.length), e.length);
	let a = 0, l, c, h;
	for (i = Math.ceil(i), n && (l = n - s, i = l / Math.floor(l / i)), h = o; h < 0;) a++, h = Math.round(o + a * i);
...
function Kv(e) {
	...
	let i, s;
	if (t < 2) return !1;
	for (s = e[0], i = 1; i < t; ++i) if (e[i] - e[i - 1] !== s) return !1;
	return s;
}
var Jv = (e) => e === "left" ? "right" : e === "right" ? "left" : e, Zl = (e, t, i) => t === "top" || t === "left" ? e[t] + i : e[t] - i, Kl = (e, t) => Math.min(t || e, e);
function Jl(e, t) {
	const i = [], s = e.length / t, n = e.length;
	let o = 0;
	for (; o < n; o += s) i.push(e[Math.floor(o)]);
	return i;
}
function Qv(e, t, i) {
	const s = e.ticks.length, n = Math.min(t, s - 1), o = e._startPixel, r = e._endPixel, a = 1e-6;
	let l = e.getPixelForTick(n), c;
	if (!(i && (s === 1 ? c = Math.max(l - o, r - l) : t === 0 ? c = (e.getPixelForTick(1) - l) / 2 : c = (l - e.getPixelForTick(n - 1)) / 2, l += n < t ? c : -c, l < o - a || l > r + a))) return l;
}
function t0(e, t) {
	U(e, (i) => {
		...
		let o;
		if (n > t) {
			for (o = 0; o < n; ++o) delete i.data[s[o]];
			s.splice(0, n);
		}
	});
}
...
function n0(e, t, i, s) {
	...
	if (e.isHorizontal()) {
		...
		} else i === "center" ? m = (c.bottom + c.top) / 2 + f - t : m = Zl(e, i, t);
		u = a - o;
	} else {
		if (F(i)) {
			const b = Object.keys(i)[0], y = i[b];
			p = h[b].getPixelForValue(y) - g + t;
		} else i === "center" ? p = (c.left + c.right) / 2 - g + t : p = Zl(e, i, t);
...
var ai = class ai extends pe {
	...
	getUserBounds() {
		...
		return t = Ct(t, Number.POSITIVE_INFINITY), i = Ct(i, Number.NEGATIVE_INFINITY), s = Ct(s, Number.POSITIVE_INFINITY), n = Ct(n, Number.NEGATIVE_INFINITY), {
			min: Ct(t, s),
			max: Ct(i, n),
			minDefined: it(t),
			maxDefined: it(i)
	...
	getMinMax(t) {
		...
		for (let l = 0, c = a.length; l < c; ++l) r = a[l].controller.getMinMax(this, t), n || (i = Math.min(i, r.min)), o || (s = Math.max(s, r.max));
	...
	generateTickLabels(t) {
		...
		let s, n, o;
		for (s = 0, n = t.length; s < n; s++) o = t[s], o.label = q(i.callback, [
			o.value,
			s,
			t
		], this);
	...
	calculateLabelRotation() {
		...
		a = t.offset ? this.maxWidth / s : p / (s - 1), d + 6 > a && (a = p / (s - (t.offset ? .5 : 1)), l = this.maxHeight - Yi(t.grid) - i.padding - Ql(t.title, this.chart.options.font), c = Math.sqrt(d * d + u * u), r = ta(Math.min(Math.asin(ht((h.highest.height + 6) / a, -1, 1)), Math.asin(ht(l / c, -1, 1)) - Math.asin(ht(u / c, -1, 1)))), r = Math.max(n, Math.min(o, r))), this.labelRotation = r;
	}
	...
	_convertTicksToLabels(t) {
		...
		let i, s;
		for (i = 0, s = t.length; i < s; i++) z(t[i].label) && (t.splice(i, 1), s--, i--);
	...
	_computeLabelSizes(t, i, s) {
		...
		for (d = 0; d < i; d += l) {
			if (m = t[d].label, f = this._resolveTickFontOptions(d), n.font = g = f.string, b = o[g] = o[g] || {
				data: {},
				gc: []
			}, y = f.lineHeight, x = v = 0, !z(m) && !Z(m)) x = Un(n, b.data, b.gc, x, m), v = y;
			else if (Z(m)) for (u = 0, p = m.length; u < p; ++u) k = m[u], !z(k) && !Z(k) && (x = Un(n, b.data, b.gc, x, k), v += y);
			r.push(x), a.push(v), c = Math.max(x, c), h = Math.max(v, h);
		}
		t0(o, i);
		const $ = r.indexOf(c), S = a.indexOf(h), C = (T) => ({
			width: r[T] || 0,
			height: a[T] || 0
		});
		return {
	...
	_computeGridLineItems(t) {
		...
		let b, y, x, v, k, $, S, C, T, M, D, R;
		if (r === "top") b = g(this.bottom), $ = this.bottom - d, C = b - f, M = g(t.top) + f, R = t.bottom;
		else if (r === "bottom") b = g(this.top), M = t.top, R = g(t.bottom) - f, $ = b + f, C = this.top + d;
		else if (r === "left") b = g(this.right), k = this.right - d, S = b - f, T = g(t.left) + f, D = t.right;
		else if (r === "right") b = g(this.left), T = t.left, D = g(t.right) - f, k = b + f, S = this.left + d;
		else if (i === "x") {
			if (r === "center") b = g((t.top + t.bottom) / 2 + .5);
			else if (F(r)) {
				const E = Object.keys(r)[0], O = r[E];
				b = g(this.chart.scales[E].getPixelForValue(O));
			}
			M = t.top, R = t.bottom, $ = b + f, C = $ + d;
		} else if (i === "y") {
			if (r === "center") b = g((t.left + t.right) / 2);
			else if (F(r)) {
				const E = Object.keys(r)[0], O = r[E];
				b = g(this.chart.scales[E].getPixelForValue(O));
			}
			k = b - f, S = k - d, T = t.left, D = t.right;
		}
		...
		for (y = 0; y < h; y += P) {
			...
			x = Qv(this, y, l), x !== void 0 && (v = Ne(s, x, Q), c ? k = S = T = D = v : $ = C = M = R = v, u.push({
				tx1: k,
				ty1: $,
				tx2: S,
				ty2: C,
	...
	_computeLabelItems(t) {
		...
		let b, y, x, v, k, $, S, C, T, M, D, R, Y = "middle";
		if (n === "top") $ = this.bottom - m, S = this._getXAxisLabelAlignment();
		else if (n === "bottom") $ = this.top + m, S = this._getXAxisLabelAlignment();
		else if (n === "left") {
			...
			if (n === "center") $ = (t.top + t.bottom) / 2 + p;
			else if (F(n)) {
			...
			if (n === "center") k = (t.left + t.right) / 2 - p;
			else if (F(n)) {
				const E = Object.keys(n)[0], O = n[E];
		...
		for (b = 0, y = a.length; b < y; ++b) {
			...
			C = this.getPixelForTick(b) + o.labelOffset, T = this._resolveTickFontOptions(b), M = T.lineHeight, D = Z(v) ? v.length : 1;
			const O = D / 2, V = E.color, Q = E.textStrokeColor, G = E.textStrokeWidth;
			let Ut = S;
			r ? (k = C, S === "inner" && (b === y - 1 ? Ut = this.options.reverse ? "left" : "right" : b === 0 ? Ut = this.options.reverse ? "right" : "left" : Ut = "center"), n === "top" ? c === "near" || f !== 0 ? R = -D * M + M / 2 : c === "center" ? R = -P.highest.height / 2 - O * M + M : R = -P.highest.height + M / 2 : c === "near" || f !== 0 ? R = M / 2 : c === "center" ? R = P.highest.height / 2 - O * M : R = P.highest.height - D * M, d && (R *= -1), f !== 0 && !E.showLabelBackdrop && (k += M / 2 * Math.sin(f))) : ($ = C, R = (1 - D) * M / 2);
			let Fi;
	...
	drawGrid(t) {
		...
		if (i.display) for (o = 0, r = n.length; o < r; ++o) {
			const l = n[o];
			i.drawOnChartArea && a({
				x: l.x1,
				y: l.y1
	...
	_resolveTickFontOptions(t) {
		return lt(this.options.ticks.setContext(this.getContext(t)).font);
	}
	_maxDigits() {
...
function r0(e, t) {
	Object.keys(t).forEach((i) => {
		const s = i.split("."), n = s.pop(), o = [e].concat(s).join("."), r = t[i].split("."), a = r.pop(), l = r.join(".");
		J.route(o, n, l, a);
	});
}
function a0(e) {
...
var c0 = class {
	...
	notify(t, i, s, n) {
		if (i === "beforeInit" && (this._init = this._createDescriptors(t, !0), this._notify(this._init, t, "install")), this._init === void 0) return;
...
function h0(e) {
	...
	for (let o = 0; o < s.length; o++) i.push(qt.getPlugin(s[o]));
	const n = e.plugins || [];
...
function b0(e, t) {
	if (t.data && t.data.datasets) {
		...
		if (i.length) return ec(e, "x", i[0]) || ec(e, "y", i[0]);
	}
	return {};
}
function y0(e, t) {
	const i = si[e.type] || { scales: {} }, s = t.scales || {}, n = pr(e.type, t), o = /* @__PURE__ */ Object.create(null);
...
var ic = /* @__PURE__ */ new Map(), Xd = /* @__PURE__ */ new Set();
function hn(e, t) {
	let i = ic.get(e);
...
var x0 = class {
	...
	datasetAnimationScopeKeys(t, i) {
		return hn(`${t}.transition.${i}`, () => [[`datasets.${t}.transitions.${i}`, `transitions.${i}`], [`datasets.${t}`, ""]]);
	}
	...
	pluginScopeKeys(t) {
		...
		return hn(`${s}-plugin-${i}`, () => [[`plugins.${i}`, ...t.additionalOptionScopes || []]]);
	}
	_cachedScopes(t, i) {
	...
	resolveNamedOptions(t, i, s, n = [""]) {
		const o = { $shared: !0 }, { resolver: r, subPrefixes: a } = sc(this._resolverCache, t, n);
		let l = r;
		if (w0(r, i)) {
...
function rc(e) {
	...
	t.notifyPlugins("afterRender"), q(i && i.onComplete, [e], t);
}
function S0(e) {
	const t = e.chart, i = t.options.animation;
	q(i && i.onProgress, [e], t);
}
function Zd(e) {
...
var Ps = (me = class {
	...
	constructor(e, t) {
		...
		te.listen(this, "complete", rc), te.listen(this, "progress", S0), this._initialize(), this.attached && this.update();
	}
	get aspectRatio() {
	...
	_resize(e, t) {
		...
		this.width = o.width, this.height = o.height, this._aspectRatio = this.aspectRatio, Tl(this, r, !0) && (this.notifyPlugins("resize", { size: o }), q(i.onResize, [this, o], this), this.attached && this._doResize(a) && this.render());
	}
	ensureScalesHaveIDs() {
		U(this.options.scales || {}, (t, i) => {
			t.id = i;
		});
	}
	buildOrUpdateScales() {
		...
		t && (n = n.concat(Object.keys(t).map((o) => {
			...
			let h = null;
			if (a in i && i[a].type === c) h = i[a];
			else h = new (qt.getScale(c))({
				id: a,
				type: c,
				ctx: this.ctx,
				chart: this
	...
	_updateMetasets() {
		...
		if (e.sort((s, n) => s.index - n.index), i > t) {
			for (let s = t; s < i; ++s) this._destroyDatasetMeta(s);
			e.splice(t, i - t);
		}
	...
	buildOrUpdateControllers() {
		...
		for (this._removeUnreferencedMetasets(), i = 0, s = t.length; i < s; i++) {
			...
			if (o.type && o.type !== r && (this._destroyDatasetMeta(i), o = this.getDatasetMeta(i)), o.type = r, o.indexAxis = n.indexAxis || pr(r, this.options), o.order = n.order || 0, o.index = i, o.label = "" + n.label, o.visible = this.isDatasetVisible(i), o.controller) o.controller.updateIndex(i), o.controller.linkScales();
			else {
	...
	update(e) {
		...
		o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || U(n, (l) => {
			l.reset();
		}), this._updateDatasets(e), this.notifyPlugins("afterUpdate", { mode: e }), this._layers.sort(oc("z", "_idx"));
	...
	_checkEventBindings() {
		...
		(!yl(new Set(Object.keys(this._listeners)), new Set(e.events)) || !!this._responsiveListeners !== e.responsive) && (this.unbindEvents(), this.bindEvents());
	}
	_updateHiddenIndices() {
		const { _hiddenIndices: e } = this, t = this._getUniformDataChanges() || [];
		for (const { method: i, start: s, count: n } of t) C0(e, s, i === "_removeElements" ? -n : n);
	}
	_getUniformDataChanges() {
		...
		for (let n = 1; n < t; n++) if (!yl(s, i(n))) return;
	...
	_updateDatasets(e) {
		if (this.notifyPlugins("beforeDatasetsUpdate", {
			...
			for (let t = 0, i = this.data.datasets.length; t < i; ++t) this.getDatasetMeta(t).controller.configure();
			for (let t = 0, i = this.data.datasets.length; t < i; ++t) this._updateDataset(t, Ee(e) ? e({ datasetIndex: t }) : e);
	...
	render() {
		this.notifyPlugins("beforeRender", { cancelable: !0 }) !== !1 && (te.has(this) ? this.attached && !te.running(this) && te.start(this) : (this.draw(), rc({ chart: this })));
	}
	draw() {
		let e;
	...
	_updateVisibility(e, t, i) {
		...
		As(t) ? (n.data[t].hidden = !i, this.update()) : (this.setDatasetVisibility(e, i), o.update(n, { visible: i }), this.update((r) => r.datasetIndex === e ? s : void 0));
	}
	hide(e, t) {
	...
	_stop() {
		let e, t;
		for (this.stop(), te.remove(this), e = 0, t = this.data.datasets.length; e < t; ++e) this._destroyDatasetMeta(e);
	}
	destroy() {
...
function M0(e, t, i) {
	...
	if (e.beginPath(), e.arc(n, o, r - c / 2, s + d / 2, i - d / 2), a > 0) {
		...
		if (h === "round") e.arc(n, o, u, i - N / 2, s + N / 2, !0);
		else if (h === "bevel") {
...
function Yn(e, t, i, s, n, o) {
	...
	const g = (m - Math.max(.001, m * d - i / N) / d) / 2, b = l + g + p, y = n - g - p, { outerStart: x, outerEnd: v, innerStart: k, innerEnd: $ } = P0(t, u, d, y - b), S = d - x, C = d - v, T = b + x / S, M = y - v / C, D = u + k, R = u + $, Y = b + k / D, P = y - $ / R;
	if (e.beginPath(), o) {
		const E = (T + M) / 2;
...
var pi = class extends pe {
	...
	inRange(t, i, s) {
		const { angle: o, distance: r } = bd(this.getProps(["x", "y"], s), {
			x: t,
			y: i
	...
	draw(t) {
		...
		if (this.pixelMargin = i.borderAlign === "inner" ? .33 : 0, this.fullCircles = s > K ? Math.floor(s / K) : 0, s === 0 || this.innerRadius < 0 || this.outerRadius < 0) return;
		t.save();
		const a = (this.startAngle + this.endAngle) / 2;
		t.translate(Math.cos(a) * n, Math.sin(a) * n);
		const c = n * (1 - Math.sin(Math.min(N, s || 0)));
...
A(pi, "id", "arc"), A(pi, "defaults", {
	...
	circular: !0,
	selfJoin: !1
}), A(pi, "defaultRoutes", { backgroundColor: "backgroundColor" }), A(pi, "descriptors", {
	_scriptable: !0,
...
function R0(e, t, i, s) {
	...
	for (p = 0; p <= c; ++p) m = n[(a + (u ? c - p : p)) % r], !m.skip && (d ? (e.moveTo(m.x, m.y), d = !1) : h(e, f, m, u, o.stepped), f = m);
...
function j0(e, t, i, s) {
	...
	for (const a of n) Kd(e, o, a.style), e.beginPath(), r(e, t, a, {
		start: i,
		end: i + s - 1
...
var _e = class extends pe {
	...
	interpolate(t, i) {
		...
		for (c = 0, h = r.length; c < h; ++c) {
			...
			const g = l(p, m, Math.abs((n - p[i]) / (m[i] - p[i])), s.stepped);
			g[i] = t[i], a.push(g);
		}
...
function cc(e, t, i, s) {
	const n = e.options, { [i]: o } = e.getProps([i], s);
...
var us = class extends pe {
	...
	draw(t, i) {
		const s = this.options;
		this.skip || s.radius < .1 || !re(this, i, this.size(s) / 2) || (t.strokeStyle = s.borderColor, t.lineWidth = s.borderWidth, t.fillStyle = s.backgroundColor, dr(t, s, this.x, this.y));
	}
	getRange() {
...
function V0(e, t, i) {
	const s = e.options.borderWidth, n = e.borderSkipped, o = Cd(s);
	return {
...
function U0(e, t, i) {
	const { enableBorderRadius: s } = e.getProps(["enableBorderRadius"]), n = e.options.borderRadius, o = Je(n), r = Math.min(t, i), a = e.borderSkipped, l = s || F(n);
	return {
...
function ix(e, t, i, s, n) {
	...
	for (r[l++] = e[h], d = 0; d < o - 2; d++) {
		...
		for (y = x; y < v; y++) g += e[y].x, b += e[y].y;
		g /= k, b /= k;
		const $ = Math.floor(d * a) + 1 + t, S = Math.min(Math.floor((d + 1) * a) + 1, i) + t, { x: C, y: T } = e[h];
		for (p = m = -1, y = $; y < S; y++) m = .5 * Math.abs((C - g) * (e[y].y - T) - (C - e[y].x) * (b - T)), m > p && (p = m, u = e[y], f = y);
		r[l++] = u, h = f;
	}
	return r[l++] = e[c], r;
}
function sx(e, t, i, s) {
	...
	for (r = t; r < t + i; ++r) {
		...
		const v = l | 0;
		if (v === h) c < m ? (m = c, d = r) : c > f && (f = c, u = r), n = (o * n + a.x) / ++o;
		else {
			const k = r - 1;
			if (!z(d) && !z(u)) {
				const $ = Math.min(d, u), S = Math.max(d, u);
				$ !== p && $ !== k && g.push({
					...e[$],
					x: n
				}), S !== p && S !== k && g.push({
...
var ox = {
	...
	beforeElementsUpdate: (e, t, i) => {
		...
		e.data.datasets.forEach((n, o) => {
			...
			if (X([a, e.options.indexAxis]) === "y" || !l.controller.supportsDecimation) return;
			const h = e.scales[l.xAxisID];
			if (h.type !== "linear" && h.type !== "time" || e.options.parsing) return;
...
function rx(e, t, i) {
	...
	for (const a of s) {
		...
		for (const u of d) {
			...
			for (const f of m) r.push({
				source: f,
				target: u,
				start: { [i]: pc(h, p, "start", Math.max) },
				end: { [i]: pc(h, p, "end", Math.min) }
			});
		}
	}
	return r;
...
function fx(e) {
	...
	for (let l = 0; l < o.length; l++) {
		const c = o[l];
		for (let h = c.start; h <= c.end; h++) gx(n, r[h], a);
	}
	return new _e({
		points: n,
		options: {}
...
function yx(e) {
	...
	if (it(i)) return vx(t, i);
	if (i === "stack") return fx(e);
	if (i === "shape") return !0;
	const n = xx(e);
...
function Wo(e, t, i) {
	const s = yx(t), { chart: n, index: o, line: r, scale: a, axis: l } = t, c = r.options, h = c.fill, d = c.backgroundColor, { above: u = d, below: p = d } = h || {}, f = Fd(n, n.getDatasetMeta(o));
...
function mc(e, t, i) {
	...
	for (const a of s) {
		...
		o ? (e.moveTo(h.x, h.y), o = !1) : (e.lineTo(h.x, i), e.lineTo(h.x, h.y)), r = !!t.pathSegment(e, a, { move: r }), r ? e.closePath() : e.lineTo(d.x, i);
	}
...
function gc(e, t, i) {
	...
	for (const a of s) {
		const { start: l, end: c } = a, h = n[l], d = n[bo(l, c, n)];
		o ? (e.moveTo(h.x, h.y), o = !1) : (e.lineTo(i, h.y), e.lineTo(h.x, h.y)), r = !!t.pathSegment(e, a, { move: r }), r ? e.closePath() : e.lineTo(i, d.y);
	}
...
var Sx = {
	...
	afterDatasetsUpdate(e, t, i) {
		...
		let o, r, a, l;
		for (r = 0; r < s; ++r) o = e.getDatasetMeta(r), a = o.dataset, l = null, a && a.options && a instanceof _e && (l = {
		...
		for (r = 0; r < s; ++r) l = n[r], !(!l || l.fill === !1) && (l.fill = lx(n, r, i.propagate));
	},
	beforeDraw(e, t, i) {
...
}, Cx = (e, t) => e !== null && t !== null && e.datasetIndex === t.datasetIndex && e.index === t.index;
var vc = class extends pe {
	...
	buildLabels() {
		...
		let i = q(t.generateLabels, [this.chart], this) || [];
	...
	adjustHitBoxes() {
		...
		if (this.isHorizontal()) {
			...
			for (const c of i) a !== c.row && (a = c.row, l = gt(s, this.left + n, this.right - this.lineWidths[a])), c.top += this.top + t + n, c.left = r.leftForLtr(r.x(l), c.width), l += c.width + n;
		} else {
			let a = 0, l = gt(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
			for (const c of i) c.col !== a && (a = c.col, l = gt(s, this.top + t + n, this.bottom - this.columnSizes[a].height)), c.top = l, c.left += this.left + n, c.left = r.leftForLtr(r.x(c.left), c.width), l += c.height + n;
		}
	}
	isHorizontal() {
	...
	_draw() {
		...
		const { boxWidth: m, boxHeight: f, itemHeight: g } = yc(r, d), b = function($, S, C) {
			if (isNaN(m) || m <= 0 || isNaN(f) || f < 0) return;
			n.save();
			const T = L(C.lineWidth, 1);
			if (n.fillStyle = L(C.fillStyle, a), n.lineCap = L(C.lineCap, "butt"), n.lineDashOffset = L(C.lineDashOffset, 0), n.lineJoin = L(C.lineJoin, "miter"), n.lineWidth = T, n.strokeStyle = L(C.strokeStyle, a), n.setLineDash(L(C.lineDash, [])), r.usePointStyle) Sd(n, {
				radius: f * Math.SQRT2 / 2,
				pointStyle: C.pointStyle,
				rotation: C.rotation,
				borderWidth: T
			}, l.xPlus($, m / 2), S + u, r.pointStyleWidth && m);
			else {
				const M = S + Math.max((d - f) / 2, 0), D = l.leftForLtr($, m), R = Je(C.borderRadius);
		...
		this.legendItems.forEach(($, S) => {
			...
			const C = n.measureText($.text).width, T = l.textAlign($.textAlign || ($.textAlign = r.textAlign)), M = m + u + C;
			let D = p.x, R = p.y;
			l.setWidth(this.width), x ? S > 0 && D + M + h > this.right && (R = p.y += k, p.line++, D = p.x = gt(o, this.left + h, this.right - s[p.line])) : S > 0 && R + k > this.bottom && (D = p.x = D + i[p.line].width + h, p.line++, R = p.y = gt(o, this.top + v + h, this.bottom - i[p.line].height));
			if (b(l.x(D), R, $), D = qb(T, D + m + u, x ? D + M : this.right, t.rtl), y(l.x(D), R, $), x) p.x += M + h;
	...
	drawTitle() {
		...
		if (this.isHorizontal()) u = Math.max(...this.lineWidths), h = this.top + c, d = gt(t.align, d, this.right - u);
		else {
	...
	_getLegendItemAt(t, i) {
		...
		if (ne(t, this.left, this.right) && ne(i, this.top, this.bottom)) {
			for (o = this.legendHitBoxes, s = 0; s < o.length; ++s) if (n = o[s], ne(t, n.left, n.left + n.width) && ne(i, n.top, n.top + n.height)) return this.legendItems[s];
		}
		return null;
	}
	handleEvent(t) {
		const i = this.options;
		if (!Tx(t.type, i)) return;
		const s = this._getLegendItemAt(t.x, t.y);
		if (t.type === "mousemove" || t.type === "mouseout") {
			const n = this._hoveredItem, o = Cx(n, s);
			n && !o && q(i.onLeave, [
				t,
				n,
				this
...
function Ax(e, t, i, s, n) {
	return {
		itemWidth: Mx(s, e, t, i),
		itemHeight: Ex(n, s, t.lineHeight)
	};
}
function Mx(e, t, i, s) {
	let n = e.text;
...
var da = class extends pe {
	...
	_drawArgs(t) {
		...
		let l = 0, c, h, d;
		return this.isHorizontal() ? (h = gt(a, s, o), d = i + t, c = o - s) : (r.position === "left" ? (h = s + t, d = gt(a, n, i), l = N * -.5) : (h = o - t, d = gt(a, i, n), l = N * .5), c = n - i), {
			titleX: h,
			titleY: d,
			maxWidth: c,
			rotation: l
...
var ru = {
	...
	title(e) {
		if (e.length > 0) {
			...
			if (s > 0 && t.dataIndex < s) return i[t.dataIndex];
		}
		return "";
	},
	afterTitle: Qt,
...
var Sc = (Yo = class extends pe {
	...
	_createItems(e) {
		...
		let r = [], a, l;
		for (a = 0, l = t.length; a < l; ++a) r.push(Lx(this.chart, t[a]));
	...
	update(e, t) {
		...
		let n, o = [];
		if (!s.length) this.opacity !== 0 && (n = { opacity: 0 });
		else {
	...
	drawTitle(e, t, i) {
		...
		if (n) {
			...
			for (e.x = un(this, i.titleAlign, i), t.textAlign = l.textAlign(i.titleAlign), t.textBaseline = "middle", o = lt(i.titleFont), r = i.titleSpacing, t.fillStyle = i.titleColor, t.font = o.string, a = 0; a < n; ++a) t.fillText(s[a], l.x(e.x), e.y + o.lineHeight / 2), e.y += o.lineHeight + r, a + 1 === n && (e.y += i.titleMarginBottom - r);
		}
	}
	...
	drawBody(e, t, i) {
		...
		const p = gi(i.rtl, this.x, this.width), m = function(S) {
			t.fillText(S, p.x(e.x + u), e.y + d / 2), e.y += d + n;
		}, f = p.textAlign(o);
		let g, b, y, x, v, k, $;
		for (t.textAlign = o, t.textBaseline = "middle", t.font = h.string, e.x = un(this, f, i), t.fillStyle = i.bodyColor, U(this.beforeBody, m), u = r && f !== "right" ? o === "center" ? l / 2 + c : l + 2 + c : 0, x = 0, k = s.length; x < k; ++x) {
			for (g = s[x], b = this.labelTextColors[x], t.fillStyle = b, U(g.before, m), y = g.lines, r && y.length && (this._drawColorBox(t, e, x, p, i), d = Math.max(h.lineHeight, a)), v = 0, $ = y.length; v < $; ++v) m(y[v]), d = h.lineHeight;
			U(g.after, m);
		}
	...
	drawFooter(e, t, i) {
		...
		if (n) {
			...
			for (e.x = un(this, i.footerAlign, i), e.y += i.footerMarginTop, t.textAlign = a.textAlign(i.footerAlign), t.textBaseline = "middle", o = lt(i.footerFont), t.fillStyle = i.footerColor, t.font = o.string, r = 0; r < n; ++r) t.fillText(s[r], a.x(e.x), e.y + o.lineHeight / 2), e.y += o.lineHeight + i.footerSpacing;
		}
	}
	...
	_getActiveElements(e, t, i, s) {
		...
		if (e.type === "mouseout") return [];
		if (!s) return t.filter((r) => this.chart.data.datasets[r.datasetIndex] && this.chart.getDatasetMeta(r.datasetIndex).controller.getParsed(r.index) !== void 0);
...
function Wx(e, t, i, s) {
	const n = e.indexOf(t);
	if (n === -1) return Ux(e, t, i, s);
	return n !== e.lastIndexOf(t) ? i : n;
}
...
var yr = class extends ai {
	...
	init(t) {
		...
		if (i.length) {
			...
			for (const { index: n, label: o } of i) s[n] === o && s.splice(n, 1);
			this._addedLabels = [];
		}
		super.init(t);
	}
	...
	buildTicks() {
		...
		o = t === 0 && i === o.length - 1 ? o : o.slice(t, i + 1), this._valueRange = Math.max(o.length - (s ? 0 : 1), 1), this._startValue = this.min - (s ? .5 : 0);
		for (let r = t; r <= i; r++) n.push({ value: r });
		return n;
	}
	getLabelForValue(t) {
...
A(yr, "id", "category"), A(yr, "defaults", { ticks: { callback: au } });
function Yx(e, t) {
	...
	let v = xl((f - m) / p / u) * u, k, $, S, C;
	if (v < 1e-14 && !g && !b) return [{ value: m }, { value: f }];
	C = Math.ceil(f / v) - Math.floor(m / v), C > p && (v = xl(C * v / p / u) * u), z(a) || (k = Math.pow(10, a), v = Math.ceil(v * k) / k), s === "ticks" ? ($ = Math.floor(m / v) * v, S = Math.ceil(f / v) * v) : ($ = m, S = f), g && b && n && Bb((r - o) / n, v / 1e3) ? (C = Math.round(Math.min((r - o) / v, c)), v = (r - o) / C, $ = o, S = r) : y ? ($ = g ? o : $, S = b ? r : S, C = l - 1, v = (S - $) / C) : (C = (S - $) / v, ls(C, Math.round(C), v / 1e3) ? C = Math.round(C) : C = Math.ceil(C));
	const T = Math.max(_l(v), _l($));
	k = Math.pow(10, z(a) ? T : a), $ = Math.round($ * k) / k, S = Math.round(S * k) / k;
	let M = 0;
	for (g && (d && $ !== o ? (i.push({ value: o }), $ < o && M++, ls(Math.round(($ + M * v) * k) / k, o, Cc(o, x, e)) && M++) : $ < o && M++); M < C; ++M) {
		const D = Math.round(($ + M * v) * k) / k;
		if (b && D > r) break;
		i.push({ value: D });
	}
	return b && d && S !== r ? i.length && ls(i[i.length - 1].value, r, Cc(r, x, e)) ? i[i.length - 1].value = r : i.push({ value: r }) : (!b || S === r) && i.push({ value: S }), i;
}
function Cc(e, t, { horizontal: i, minRotation: s }) {
	const n = Ft(s), o = (i ? Math.sin(n) : Math.cos(n)) || .001, r = .75 * t * ("" + e).length;
...
var Gn = class extends ai {
	...
	getTickLimit() {
		let { maxTicksLimit: i, stepSize: s } = this.options.ticks, n;
...
var vr = class extends Gn {
	...
	computeTickLimit() {
		const t = this.isHorizontal(), i = t ? this.width : this.height, s = Ft(this.options.ticks.minRotation), n = (t ? Math.sin(s) : Math.cos(s)) || .001, o = this._resolveTickFontOptions(0);
...
A(vr, "id", "linear"), A(vr, "defaults", { ticks: { callback: uo.formatters.numeric } });
var Ds = (e) => Math.floor(ve(e)), Ve = (e, t) => Math.pow(10, Ds(e) + t);
function Ac(e) {
...
function Xx(e, { min: t, max: i }) {
	...
	let d = Math.floor((c - h) / Math.pow(10, o)), u = Ct(e.min, Math.round((l + h + d * Math.pow(10, o)) * r) / r);
	for (; u < i;) s.push({
		value: u,
		major: Ac(u),
		significand: d
...
var xr = class extends ai {
	...
	parse(t, i) {
		const s = Gn.prototype.parse.apply(this, [t, i]);
		if (s === 0) {
			this._zero = !0;
			return;
		}
...
A(xr, "id", "logarithmic"), A(xr, "defaults", { ticks: {
...
function Kx(e) {
	...
	for (let l = 0; l < o; l++) {
		...
		s[l] = u;
		const p = bt(e.getIndexAngle(l) + a), m = Math.round(ta(p));
		Jx(i, t, p, Ec(m, h.x, u.w, 0, 180), Ec(m, h.y, u.h, 90, 270));
	}
...
function lu(e, t, i, s) {
	const { ctx: n } = e;
	if (i) n.arc(e.xCenter, e.yCenter, t, 0, K);
	else {
		let o = e.getPointPosition(0, t);
		n.moveTo(o.x, o.y);
		for (let r = 1; r < s; r++) o = e.getPointPosition(r, t), n.lineTo(o.x, o.y);
	}
}
...
var Qi = class extends Gn {
	...
	generateTickLabels(t) {
		Gn.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map((i, s) => {
			const n = q(this.options.pointLabels.callback, [i, s], this);
			return n || n === 0 ? n : "";
	...
	drawLabels() {
		...
		t.save(), t.translate(this.xCenter, this.yCenter), t.rotate(n), t.textAlign = "center", t.textBaseline = "middle", this.ticks.forEach((a, l) => {
			if (l === 0 && this.min >= 0 && !i.reverse) return;
...
A(Qi, "id", "radialLinear"), A(Qi, "defaults", {
	...
	"ticks.color": "color"
}), A(Qi, "descriptors", { angleLines: { _fallback: "grid" } });
var yo = {
	millisecond: {
		common: !0,
		size: 1,
...
function Dc(e, t, i, s) {
	...
	for (let o = kt.indexOf(e); o < n - 1; ++o) {
		...
		if (r.common && Math.ceil((i - t) / (a * r.size)) <= s) return kt[o];
	}
	return kt[n - 1];
}
function c_(e, t, i, s, n) {
	for (let o = kt.length - 1; o >= kt.indexOf(i); o--) {
		const r = kt[o];
		if (yo[r].common && e._adapter.diff(n, s, r) >= t - 1) return r;
	}
	return kt[i ? kt.indexOf(i) : 0];
}
function h_(e) {
	for (let t = kt.indexOf(e) + 1, i = kt.length; t < i; ++t) if (yo[kt[t]].common) return kt[t];
}
function Oc(e, t, i) {
	if (!i) e[t] = !0;
	else if (i.length) {
...
function d_(e, t, i, s) {
	...
	let a, l;
	for (a = o; a <= r; a = +n.add(a, 1, s)) l = i[a], l >= 0 && (t[l].major = !0);
	return t;
}
function Ic(e, t, i) {
...
var Os = class extends ai {
	...
	_generate() {
		...
		let d = i, u, p;
		if (c && (d = +t.startOf(d, "isoWeek", l)), d = +t.startOf(d, c ? "day" : r), t.diff(s, i, r) > 1e5 * a) throw new Error(i + " and " + s + " are too far apart with stepSize of " + a + " " + r);
		const m = n.ticks.source === "data" && this.getDataTimestamps();
		for (u = d, p = 0; u < s; u = +t.add(u, a, r), p++) Oc(h, u, m);
	...
	generateTickLabels(t) {
		let i, s, n;
		for (i = 0, s = t.length; i < s; ++i) n = t[i], n.label = this._tickFormatFunction(n.value, i, t);
	}
	...
	_getLabelCapacity(t) {
		const i = this.options.time, s = i.displayFormats, n = s[i.unit] || s.millisecond, o = this._tickFormatFunction(t, 0, Ic(this, [t], this._majorUnit), n), r = this._getLabelSize(o), a = Math.floor(this.isHorizontal() ? this.width / r.w : this.height / r.h) - 1;
		return a > 0 ? a : 1;
	}
	getDataTimestamps() {
		...
		for (i = 0, s = n.length; i < s; ++i) t = t.concat(n[i].controller.getAllParsedValues(this));
	...
	getLabelTimestamps() {
		...
		for (i = 0, s = n.length; i < s; ++i) t.push(Pc(this, n[i]));
...
var wr = class extends Os {
	...
	buildLookupTable(t) {
		...
		let r, a, l, c, h;
		for (r = 0, a = t.length; r < a; ++r) c = t[r], c >= i && c <= s && n.push(c);
...
var Lc = function() {
	...
	toTextLines: function(e) {
		var t = [], i;
		for (e = [].concat(e); e.length;) i = e.pop(), typeof i == "string" ? t.unshift.apply(t, i.split(`
`)) : Array.isArray(i) ? e.push.apply(e, i) : z(e) || t.unshift("" + i);
		return t;
	},
	textSize: function(e, t, i) {
		var s = [].concat(t), n = s.length, o = e.font, r = 0, a;
		for (e.font = i.string, a = 0; a < n; ++a) r = Math.max(e.measureText(s[a]).width, r);
		return e.font = o, {
	...
	arrayDiff: function(e, t) {
		...
		for (n = 0, r = t.length; n < r; ++n) a = t[n], o = i.indexOf(a), o === -1 ? s.push([a, 1]) : i.splice(o, 1);
...
function g_(e, t) {
	for (var i = e.x0, s = e.y0, n = e.x1, o = e.y1, r = fn(i, s, t), a = fn(n, o, t), l, c, h; !(!(r | a) || r & a);) l = r || a, l & uu ? (c = i + (n - i) * (t.top - s) / (o - s), h = t.top) : l & du ? (c = i + (n - i) * (t.bottom - s) / (o - s), h = t.bottom) : l & hu ? (h = s + (o - s) * (t.right - i) / (n - i), c = t.right) : l & cu && (h = s + (o - s) * (t.left - i) / (n - i), c = t.left), l === r ? (i = c, s = h, r = fn(i, s, t)) : (n = c, o = h, a = fn(n, o, t));
	return {
		x0: i,
		x1: n,
		y0: s,
...
function y_(e, t) {
	...
	if (!i) return null;
	if (i.xCenter !== void 0 && i.yCenter !== void 0) return {
		x: i.xCenter,
		y: i.yCenter
	};
...
function __(e, t, i) {
	...
	!s && (!n || !o) || (e.beginPath(), x_(e, ae(t.x) + o / 2, ae(t.y) + o / 2, ae(t.w) - o, ae(t.h) - o, i.borderRadius), e.closePath(), s && (e.fillStyle = s, e.fill()), n && o && (e.strokeStyle = n, e.lineWidth = o, e.lineJoin = "miter", e.stroke()));
}
function w_(e, t, i) {
...
function $_(e, t, i, s) {
	...
	if (!(!l || !r && !d)) for (i = w_(i, n, a), e.font = a.string, e.textAlign = n, e.textBaseline = "middle", e.shadowBlur = s.textShadowBlur, e.shadowColor = s.textShadowColor, r && (e.fillStyle = o), d && (e.lineJoin = "round", e.lineWidth = h, e.strokeStyle = c), u = 0, l = t.length; u < l; ++u) k_(e, t[u], {
		stroked: d,
		filled: r,
		w: i.w,
		x: i.x,
...
Kt(pu.prototype, {
	...
	draw: function(e, t) {
		...
		this.visible() && (s.save(), n.clip && (r = n.area, s.beginPath(), s.rect(r.left, r.top, r.right - r.left, r.bottom - r.top), s.clip()), s.globalAlpha = fs.bound(0, n.opacity, 1), s.translate(ae(t.x), ae(t.y)), s.rotate(n.rotation), __(s, o.frame, n), $_(s, n.lines, o.text, n), s.restore());
	}
});
var S_ = Number.MIN_SAFE_INTEGER || -9007199254740991, C_ = Number.MAX_SAFE_INTEGER || 9007199254740991;
function Xi(e, t, i) {
...
function Rc(e, t) {
	var i = C_, s = S_, n = t.origin, o, r, a, l, c;
	for (o = 0; o < e.length; ++o) r = e[o], a = r.x - n.x, l = r.y - n.y, c = t.vx * a + t.vy * l, i = Math.min(i, c), s = Math.max(s, c);
	return {
		min: i,
		max: s
	};
...
Kt(fu.prototype, {
	...
	intersects: function(e) {
		var t = this._points(), i = e._points(), s = [bn(t[0], t[1]), bn(t[0], t[3])], n, o, r;
		for (this._rotation !== e._rotation && s.push(bn(i[0], i[1]), bn(i[0], i[3])), n = 0; n < s.length; ++n) if (o = Rc(t, s[n]), r = Rc(i, s[n]), o.max < r.min || r.max < o.min) return !1;
		return !0;
	},
	_points: function() {
...
function A_(e, t) {
	var i, s, n, o;
	for (i = e.length - 1; i >= 0; --i) for (n = e[i].$layout, s = i - 1; s >= 0 && n._visible; --s) o = e[s].$layout, o._visible && n._box.intersects(o._box) && t(n, o);
	return e;
}
function M_(e) {
	var t, i, s, n, o, r, a;
	for (t = 0, i = e.length; t < i; ++t) s = e[t], n = s.$layout, n._visible && (a = new Proxy(s._el, { get: (l, c) => l.getProps([c], !0)[c] }), o = s.geometry(), r = mu(a, s.model(), o), n._box.update(r, o, s.rotation()));
...
var ms = {
	prepare: function(e) {
		var t = [], i, s, n, o, r;
		for (i = 0, n = e.length; i < n; ++i) for (s = 0, o = e[i].length; s < o; ++s) r = e[i][s], t.push(r), r.$layout = {
			_box: new fu(),
			_hidable: !1,
			_visible: !0,
			_set: i,
	...
	update: function(e) {
		var t = !1, i, s, n, o, r;
		for (i = 0, s = e.length; i < s; ++i) n = e[i], o = n.model(), r = n.$layout, r._hidable = o && o.display === "auto", r._visible = n.visible(), t |= r._hidable;
		t && M_(e);
	},
	lookup: function(e, t) {
		var i, s;
		for (i = e.length - 1; i >= 0; --i) if (s = e[i].$layout, s && s._visible && s._box.contains(t)) return e[i];
		return null;
	},
	draw: function(e, t) {
		var i, s, n, o, r, a;
		for (i = 0, s = t.length; i < s; ++i) n = t[i], o = n.$layout, o._visible && (r = n.geometry(), a = mu(n._el, n.model(), r), o._box.update(a, r, n.rotation()), n.draw(e, a));
	}
}, E_ = function(e) {
	if (z(e)) return null;
	var t = e, i, s, n;
	if (F(e)) if (!z(e.label)) t = e.label;
	else if (!z(e.r)) t = e.r;
	else for (t = "", i = Object.keys(e), n = 0, s = i.length; n < s; ++n) t += (n !== 0 ? ", " : "") + i[n] + ": " + e[i[n]];
	return "" + t;
}, T_ = {
	align: "center",
	anchor: "center",
...
function O_(e, t) {
	...
	if (!(!s.enter && !s.leave)) {
		if (t.type === "mousemove") o = ms.lookup(i._labels, t);
...
var L_ = {
	...
	afterDatasetUpdate: function(e, t, i) {
		...
		for (h.save(), d = 0, p = c.length; d < p; ++d) if (b = c[d], b[wt] = [], r && b && e.getDataVisibility(d) && !b.skip) for (u = 0, m = l.labels.length; u < m; ++u) f = l.labels[u], g = f._key, y = new pu(f, h, b, d), y.$groups = {
			_set: s,
			_key: g || gu
		}, y.$context = {
			active: !1,
		...
		h.restore(), Kt(n._listeners, l.listeners, { merger: function(x, v, k) {
	...
	afterEvent: function(e) {
		...
		for (o = 0, r = n.length; o < r; ++o) if (c = n[o], c[1]) for (d = c[0].element[wt] || [], a = 0, l = d.length; a < l; ++a) h = d[a], h.$context.active = c[1] === 1, h.update(h.$context);
...
var bu = class extends j {
	...
	_getDefaultColors(t) {
		...
		return Array.from({ length: i }, (s, n) => this.generateColor(n));
	}
	/**
	...
	*/
	parseInputData(t) {
		const { labels: i } = t, s = this.colors.length < Object.keys(t.datasets).length ? this._getDefaultColors(t) : this.colors;
		return {
			labels: i,
	...
	updateFromTable(t) {
		...
		for (const l of i) {
			const { data: c } = l;
			let h, d;
			for (const [u, p] of Object.entries(c)) u === "name" && typeof p == "string" ? h = p : typeof p == "number" && (d = p);
	...
	filterByValue(t) {
		...
		for (const s of Object.values(i.datasets)) for (const n in s) t(s[n]) || delete s[n];
	...
	updated(t) {
		...
		if (this.chart) {
			if (t.has("type") || t.has("indexAxis") || t.has("linePointStyle") || t.has("pointRadius") || t.has("lineFill")) {
				...
				this.label !== void 0 && (n.plugins || (n.plugins = {}), n.plugins.title = {
					text: this.label,
					display: !0
				}), this.indexAxis !== void 0 && (n.indexAxis = this.indexAxis), this.chart = new Ps(this._canvas, {
					type: this.type,
					data: this.parseInputData(this.inputData),
					options: n
				});
			} else for (const n of t.keys()) switch (n) {
				case "label":
				...
				case "borderColor":
					...
					break;
				case "xStacked":
					this.type === "bar" && (i = this.chart.options.scales) != null && i.x && Object.assign(this.chart.options.scales.x, { stacked: this.xStacked });
					break;
				case "yStacked":
					this.type === "bar" && (s = this.chart.options.scales) != null && s.y && Object.assign(this.chart.options.scales.y, { stacked: this.yStacked });
					break;
	...
	*/
	...
	firstUpdated() {
		this.chart = new Ps(this._canvas, this._chartCfg);
		...
		t && new ResizeObserver(() => this.chart.resize()).observe(t), this._canvas.onclick = (i) => {
			...
			const s = this.chart.getElementsAtEventForMode(i, "point", { intersect: !0 }, !1);
			for (const n of s) {
...
bu.styles = H`
  ...
  `;
var st = bu;
ot([w({ type: Array })], st.prototype, "colors");
ot([w({
	type: String,
	reflect: !0
})], st.prototype, "type");
...
ot([ue()], st.prototype, "_errorLoading");
...
var I1 = class {
	...
	*/
	static init() {
		ut.defineCustomElement("bim-view-cube", jt), ut.defineCustomElement("bim-world-2d", Se), ut.defineCustomElement("bim-world", Pn);
	}
};
var bi = (e, t) => {
  ...
  `;
	...
	dueDate: (e) => {
		if (typeof e == "string" && e.trim() !== "") return new Date(e);
	},
	status: (e) => {
	...
	const { components: t, topic: i, value: s, onCancel: n, onSubmit: o, styles: r } = e, a = o ?? (() => {}), l = t.get(BCFTopics), c = (s == null ? void 0 : s.title) ?? (i == null ? void 0 : i.title) ?? Topic.default.title, h = (s == null ? void 0 : s.status) ?? (i == null ? void 0 : i.status) ?? Topic.default.status, d = (s == null ? void 0 : s.type) ?? (i == null ? void 0 : i.type) ?? Topic.default.type, u = (s == null ? void 0 : s.priority) ?? (i == null ? void 0 : i.priority) ?? Topic.default.priority, p = (s == null ? void 0 : s.assignedTo) ?? (i == null ? void 0 : i.assignedTo) ?? Topic.default.assignedTo, m = (s == null ? void 0 : s.labels) ?? (i == null ? void 0 : i.labels) ?? Topic.default.labels, f = (s == null ? void 0 : s.stage) ?? (i == null ? void 0 : i.stage) ?? Topic.default.stage, g = (s == null ? void 0 : s.description) ?? (i == null ? void 0 : i.description) ?? Topic.default.description, b = i != null && i.dueDate ? i.dueDate.toISOString().split("T")[0] : null, y = /* @__PURE__ */ new Set([...l.config.statuses]);
	h && y.add(h);
	...
	if (m) for (const P of m) $.add(P);
	const S = /* @__PURE__ */ new Set([...l.config.stages]);
	f && S.add(f);
	const C = Xo(), T = async () => {
		const { value: P } = C;
		if (!P) return;
		const E = Cs(P, j_);
		if (i) i.set(E), await a(i);
		else await a(l.create(E));
	}, M = Xo(), D = (P) => {
		const { value: E } = M;
		if (!E) return;
		E.disabled = P.target.value.trim() === "";
	}, R = `btn-${ut.newRandomId()}`, Y = `btn-${ut.newRandomId()}`;
	return _`
    <div ${tt(C)} style="display: flex; flex-direction: column; gap: 0.75rem;">
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-dropdown vertical label="Assignee" name="assignedTo">
          ${[...k].map((P) => {
		const E = r != null && r.users ? r.users[P] : null;
		return _`<bim-option label=${E ? E.name : P} value=${P} .img=${E == null ? void 0 : E.picture} .checked=${p === P}></bim-option>`;
	})}
        </bim-dropdown>
      </div>
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-dropdown vertical label="Stage" name="stage">
          ${[...S].map((P) => _`<bim-option label=${P} .checked=${f === P}></bim-option>`)}
        </bim-dropdown>
      </div>
    ...
    <bim-button
      ...
      @click=${() => {
		...
		a.type = "file", a.accept = ".ifc", a.onchange = async () => {
			...
			const m = await p.load(h, !0, d, { userData: i });
			r.scene.three.add(m.object), m.useCamera(r.camera.three), u.core.update(!0);
		}, a.click();
	}}
    ></bim-button>
  `;
}, H_ = (e) => et.create(N_, e), V_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	loadIfc: H_
    ...
    <bim-button @click=${() => {
		...
		n.type = "file", n.accept = ".frag", n.onchange = async () => {
			...
			const o = n.files[0], r = await o.arrayBuffer(), a = new Uint8Array(r), l = o.name.replace(".frag", ""), c = t.get(FragmentsManager), h = await c.core.load(a, { modelId: l });
			i && (i.scene.three.add(h.object), h.useCamera(i.camera.three), c.core.update(!0));
		}, n.click();
	}}></bim-button>
  `;
}, W_ = (e) => {
	const t = et.create(U_, e), [i] = t;
	...
	const t = [];
	for (const i of e) {
		const n = await $r(i, await i.getSpatialStructure());
		if (!n) continue;
		const o = {
			data: {
				Name: i.modelId,
    ...
    <bim-table @rowcreated=${(a) => {
		...
		const { row: l } = a.detail, c = t.get(li), h = t.get(FragmentsManager);
		l.onclick = async () => {
			if (!s) return;
			const { data: { modelId: d, localId: u, children: p } } = l;
			if (!(d && (u !== void 0 || p))) return;
			const m = h.list.get(d);
			if (m) {
				if (u !== void 0) {
					const f = await m.getItemsChildren([u]), g = { [d]: f.length !== 0 ? new Set(f) : /* @__PURE__ */ new Set([u]) };
					c.highlightByID(s, g, !0, !0);
				} else if (p) {
					const f = JSON.parse(p), g = await m.getItemsChildren(f), b = { [d]: g.length !== 0 ? g : f };
					c.highlightByID(s, b, !0, !0);
				}
			}
		};
	}} @cellcreated=${({ detail: a }) => {
		const { cell: l } = a;
  ...
  `;
	...
	if (s.hiddenColumns = [
		...
		"localId",
		"children"
	], s.columns = ["Name"], s.headersHidden = !0, t) {
		const { components: o } = e, r = o.get(FragmentsManager);
		r.list.onItemSet.add(() => n({ models: r.list.values() })), r.list.onItemDeleted.add(() => n());
	}
	return i;
...
var zc = {
	...
	const o = (l = t[i.defaultItemNameKey]) == null ? void 0 : l.value, r = t._category.value, a = { data: {
		modelId: e,
		localId: n,
		type: "item",
	...
	for (const c in t) {
		const h = t[c];
		if (!Array.isArray(h)) Z_(a, c, h.value, e, n, h.type);
		else {
			const d = { data: {
				Name: c,
				type: "relation"
	...
	for (const o in t) {
		...
		for (const c of l) {
			...
			const [d] = await r.getItemsData([c], i.itemsDataConfig);
			h = xu(o, d, i), n.push(h);
		}
	}
	return n;
	...
	return _`
    <bim-table @cellcreated=${({ detail: l }) => {
  ...
  `;
	...
	if (!s) throw new Error(`ItemsDataUI: model ${t} not found.`);
	let n = J_.get(s.modelId);
	if (!n) {
		const [o] = Object.values(await s.getItemsOfCategories([/UNITASSIGNMENT/])).flat(), [r] = await s.getItemsData([o], { relations: { Units: {
			relations: !1,
			attributes: !0
		} } });
		if (!Array.isArray(r.Units)) return [];
		n = r.Units;
	}
	return n;
}, ew = (e, t) => {
	...
	t.columns = [{
		name: "Name",
		width: "12rem"
	}], t.visibleColumns = ["Name", "Value"], t.headersHidden = !0, t.dataTransform = { Value: (s, n) => {
		...
		return o ? _`<bim-label ${tt(async (l) => {
			...
			if (!d || !(d.Name && "value" in d.Name)) return s;
			l.textContent = `${s.toFixed(2)} ${Q_[d.Name.value] ?? d.Name.value}`;
		})}></bim-label>` : s;
	} };
}, iw = (e) => {
	...
	const { components: t } = e, i = e.missingDataMessage ?? "No models has been loaded yet", s = t.get(FragmentsManager), n = ({ detail: r }) => {
		const { cell: a } = r;
    ...
    <bim-table ${tt(async (r) => {
		if (!r) return;
		const a = r, l = [];
		if (s.initialized) for (const [, c] of s.list) {
			if (!(c && !c.isDeltaModel)) continue;
			const h = await c.getMetadata(), d = { data: {
				Name: c.modelId,
				modelId: c.modelId,
  ...
  `;
	...
	const { components: i, actions: s, metaDataTags: n } = e, o = i.get(FragmentsManager), r = (s == null ? void 0 : s.dispose) ?? !0, a = (s == null ? void 0 : s.download) ?? !0, l = (s == null ? void 0 : s.visibility) ?? !0, c = n ?? [];
	t.hiddenColumns = ["modelId", "metadata"], t.headersHidden = !0, t.noIndentation = !0, t.dataTransform = { Name: (h, d) => {
		if (!o.initialized) return h;
		...
		if (p) {
			...
			for (const v of c) {
				const k = x[v];
				if (!(typeof k == "string" || typeof k == "boolean" || typeof k == "number")) continue;
				const $ = _`
		...
		l && (b = _`<bim-button @click=${async ({ target: v }) => {
			v.loading = !0, await m.setVisible(void 0, v.hasAttribute("data-model-hidden")), await o.core.update(!0), v.toggleAttribute("data-model-hidden"), v.icon = v.hasAttribute("data-model-hidden") ? "mdi:eye-off" : "mdi:eye", v.loading = !1;
  ...
  `;
	...
	t.dataTransform = { Actions: (r, a) => {
		const { Guid: l } = a;
		if (!(l && typeof l == "string")) return r;
		...
		n.selectComponents && (d = _`
          <bim-button label="Select Components" @click=${async ({ target: x }) => {
			const v = i.get(FragmentsManager), k = i.get(li);
			if (!k.isSetup) return;
			x.loading = !0;
			const $ = await v.guidsToModelIdMap([...c.selectionComponents]);
  ...
  `;
	...
	const i = et.create(Su, e), [s, n] = i;
	if (cw(e, s), t) {
		const { components: o, topics: r } = e, a = o.get(BCFTopics), l = () => n();
		if (a.list.onItemUpdated.add(l), a.list.onItemDeleted.add(l), r) for (const c of r) c.relatedTopics.onItemAdded.add(l), c.relatedTopics.onItemDeleted.add(l), c.relatedTopics.onCleared.add(l);
    ...
    <bim-table no-indentation ${tt((r) => {
		...
		s && (l = [...t.comments.values()].filter((c) => c.viewpoint === s.guid)), a.data = [...l].map((c) => ({ data: {
			guid: c.guid,
			Comment: c.comment,
			author: (() => {
				const h = i;
  ...
  `;
	...
	const { topic: i, styles: s } = e, n = {
		delete: !0,
		...e.actions
	};
	t.headersHidden = !0, t.hiddenColumns = ["guid", "author"], t.dataTransform = { Comment: (o, r) => {
		const { guid: a } = r;
  ...
  `;
	...
	return s ? p = yu({
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-label .icon=${u == null ? void 0 : u.icon} style=${Yt({
		...yi,
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-label .icon=${d == null ? void 0 : d.icon} style=${Yt({
		...yi,
      ...
      ${n.priority ? _`
            <div style="display: flex; gap: 0.375rem">
              ...
              <bim-label .icon=${h == null ? void 0 : h.icon} style=${Yt({
		...yi,
  ...
  `;
	...
	const c = () => _`
      <bim-text-input placeholder="Search..." debounce="100" @input=${(p) => {
		const m = p.target;
		m instanceof St && (a.queryString = m.value);
	}}></bim-text-input> 
    `;
	let h, d;
	if (n) {
  ...
  `;
	...
	const { components: i, topic: s, world: n, linking: o } = e, r = {
      ...
      <bim-text-input placeholder="Search..." debounce="100" @input=${(m) => {
		const f = m.target;
		f instanceof St && (l.queryString = f.value);
	}}></bim-text-input> 
    `;
	let d, u;
	if (o) {
  ...
  `, ww = (e) => et.create(_w, e), F1 = { .../* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	topic: ww
}, Symbol.toStringTag, { value: "Module" })) };
async function $w(e, t) {
	const i = t.get(FragmentsManager), s = new DataMap();
	for (const [r, a] of i.list) for (const [l, c] of Object.entries(e)) {
		const h = await a.getItemsData(Array.from(c));
		for (const d of h) {
			if (!d || !("value" in d._category)) continue;
	...
	return {
		labels: [...s.keys()],
		datasets: { Categories: [...s.values()].map((r) => ({ value: r })) }
	};
}
var Sw = (e) => {
	const { type: t, modelIdMap: i, components: s, addLabels: n = !0 } = e, o = s.get(FragmentsManager), r = s.get(li), a = s.get(Hider), l = e.missingDataMessage ?? "No data in this chart.";
	return _`
    <bim-chart ${tt(async (h) => {
		if (!h) return;
		const d = h;
		if (d.loadFunction = async () => $w(i, s), await d.loadData(!0), n) {
			const u = d.querySelector("[slot='labels']");
			u && (u.charts = [d], u.addEventListener("label-click", async (p) => {
				const { label: f, visibility: g } = p.detail, b = [];
		...
		d.addEventListener("sectionclick", async (u) => {
			const { label: m } = u.detail;
			for (const [f, g] of o.list) {
				const b = await g.getItemsOfCategories([new RegExp(m)]), y = Object.values(b).flat(), x = { [f]: new Set(y) };
  ...
  `;
}, Cw = (e) => et.create(Sw, e), Aw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	categoriesChart: Cw
}, Symbol.toStringTag, { value: "Module" })), Ou = "Passed", Iu = "Failed";
async function Mw(e) {
	const t = [], i = [], s = {};
	for (const r of e) for (const [a, l] of r.entries()) {
...
var Ew = (e) => {
	const { type: t, idsResult: i, components: s, addLabels: n = !0 } = e, o = s.get(FragmentsManager), r = s.get(li), a = s.get(Hider);
	r.styles.set(Ou, {
    ...
    <bim-chart ${tt(async (h) => {
			...
			u && (u.charts = [d]), u.addEventListener("label-click", async (p) => {
				...
				for (const y of f) {
					...
					for (const [v, k] of Object.entries(x)) {
						...
						const C = (async () => {
							const T = (await $.getLocalIdsByGuids(S)).filter((D) => D !== null);
		...
		d.addEventListener("sectionclick", async (u) => {
			...
			for (const f of p) {
				...
				const { guids: b } = g;
				for (const [y, x] of o.list) {
					const v = (await x.getLocalIdsByGuids(b)).filter(($) => $ !== null), k = { [y]: new Set(v) };
  ...
  `;
}, Tw = (e) => et.create(Ew, e), Pw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	idsChart: Tw
  ...
  `;
}, Ow = (e) => et.create(Dw, e), Iw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	labels: Ow
}, Symbol.toStringTag, { value: "Module" }));
...
var Rw = (e) => {
	const { components: t, type: i, addLabels: s = !0, grouper: n = "stage" } = e, o = e.filterFunction ?? (() => !0), a = [...t.get(BCFTopics).list.values()].filter(o), l = e.missingDataMessage ?? "No data in this chart.";
	return _`
    <bim-chart ${tt(async (h) => {
		if (!h) return;
		const d = h;
  ...
  `;
}, zw = (e) => et.create(Rw, e), Fw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	topicsChart: zw
}, Symbol.toStringTag, { value: "Module" }));
async function Bw(e, t, i, s) {
	...
	const a = [], l = [];
	for (const [c, h] of Object.entries(r)) for (const { value: d, localIds: u } of Object.values(h)) {
		a.push(d);
		const p = u.length;
		l.push({
			value: p,
	...
	return {
		labels: a,
		datasets: { [e.toString()]: l }
	};
}
var jw = (e) => {
	const { type: t, attribute: i, category: s, modelId: n, components: o, addLabels: r = !0 } = e, a = {
		zoom: !0,
		...e.highlight
	}, l = o.get(FragmentsManager), c = o.get(li), h = o.get(Hider), d = e.missingDataMessage ?? "No data in this chart.";
	return _`
    <bim-chart ${tt(async (p) => {
		if (!p) return;
		const m = p;
		if (m.loadFunction = async () => Bw(i, s, n, o), await m.loadData(!0), r) {
			const f = m.querySelector("[slot='labels']");
			f && (f.charts = [m]), f.addEventListener("label-click", async (g) => {
		...
		m.addEventListener("sectionclick", async (f) => {
			const { values: g } = f.detail, b = [];
			for (const y of g) {
				const { data: x } = y;
				if (!x) continue;
				const { modelIdMap: v } = x;
				b.push(c.highlightByID("select", v, !0, a.zoom));
			}
			await Promise.all(b);
		});
	})} type=${t ?? "bar"}>
  ...
  `;
}, Nw = (e) => et.create(jw, e), Hw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	attributesChart: Nw
...
//#endregion
export { I1 as Manager, jt as ViewCube, Pn as World, Se as World2D, yi as baseTopicTagStyle, L1 as buttons, B1 as charts, bi as createAuthorTag, Et as defaultTopicStyles, F1 as forms, z1 as sections, R1 as tables, yu as topicFormTemplate };
