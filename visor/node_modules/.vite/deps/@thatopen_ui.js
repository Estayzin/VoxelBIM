...
var si = Math.min, Kt = Math.max, Gs = Math.round, ue = (i) => ({
	x: i,
	y: i
}), Gh = {
	left: "right",
...
var Wr = ["left", "right"], Ur = ["right", "left"], td = ["top", "bottom"], ed = ["bottom", "top"];
function id(i, t, e) {
	switch (i) {
		case "top":
		case "bottom": return e ? t ? Ur : Wr : t ? Wr : Ur;
		case "left":
		case "right": return t ? td : ed;
		default: return [];
	}
}
function sd(i, t, e, s) {
...
var od = async (i, t, e) => {
	...
	let c = await r.getElementRects({
		...
		floating: t,
		strategy: n
	}), { x: h, y: d } = qr(c, s, l), u = s, f = {}, p = 0;
	for (let g = 0; g < a.length; g++) {
		const { name: m, fn: b } = a[g], { x: y, y: x, data: w, reset: _ } = await b({
			x: h,
			y: d,
			initialPlacement: s,
			placement: u,
...
async function tc(i, t) {
	var e;
	t === void 0 && (t = {});
	const { x: s, y: n, platform: o, rects: r, elements: a, strategy: l } = i, { boundary: c = "clippingAncestors", rootBoundary: h = "viewport", elementContext: d = "floating", altBoundary: u = !1, padding: f = 0 } = as(t, i), p = Jl(f), m = a[u ? d === "floating" ? "reference" : "floating" : d], b = ni(await o.getClippingRect({
...
var rd = function(i) {
	return i === void 0 && (i = {}), {
		...
		async fn(t) {
			var e, s;
			const { placement: n, middlewareData: o, rects: r, initialPlacement: a, platform: l, elements: c } = t, { mainAxis: h = !0, crossAxis: d = !0, fallbackPlacements: u, fallbackStrategy: f = "bestFit", fallbackAxisSideDirection: p = "none", flipAlignment: g = !0, ...m } = as(i, t);
			...
			if (P = [...P, {
				...
				if (L && (!(d === "alignment" ? y !== Ut(L) : !1) || P.every((U) => Ut(U.placement) === y ? U.overflows[0] > 0 : !0))) return {
					data: {
						index: Z,
						overflows: P
					},
...
var ld = function(i) {
	return i === void 0 && (i = {}), {
		...
		options: i,
		async fn(t) {
			const { placement: e, elements: s, rects: n, platform: o, strategy: r } = t, { padding: a = 2, x: l, y: c } = as(i, t), h = Array.from(await (o.getClientRects == null ? void 0 : o.getClientRects(s.reference)) || []), d = ad(h), u = ni(ec(h)), f = Jl(a);
			function p() {
				if (d.length === 2 && d[0].left > d[1].right && l != null && c != null) return d.find((m) => l > m.left - f.left && l < m.right + f.right && c > m.top - f.top && c < m.bottom + f.bottom) || u;
				if (d.length >= 2) {
					if (Ut(e) === "y") {
						const P = d[0], $ = d[d.length - 1], T = Qt(e) === "top", Q = P.top, Z = $.bottom, L = T ? P.left : $.left, z = T ? P.right : $.right;
						return {
							top: Q,
							bottom: Z,
							left: L,
					...
					const m = Qt(e) === "left", b = Kt(...d.map((P) => P.right)), y = si(...d.map((P) => P.left)), x = d.filter((P) => m ? P.left === y : P.right === b), w = x[0].top, _ = x[x.length - 1].bottom, S = y, k = b;
					return {
						top: w,
						bottom: _,
						left: S,
			...
			return n.reference.x !== g.reference.x || n.reference.y !== g.reference.y || n.reference.width !== g.reference.width || n.reference.height !== g.reference.height ? { reset: { rects: g } } : {};
		}
	};
}, cd = /* @__PURE__ */ new Set(["left", "top"]);
async function hd(i, t) {
	const { placement: e, platform: s, elements: n } = i, o = await (s.isRTL == null ? void 0 : s.isRTL(n.floating)), r = Qt(e), a = yn(e), l = Ut(e) === "y", c = cd.has(r) ? -1 : 1, h = o && l ? -1 : 1, d = as(t, i);
...
var Fo = function(i) {
	return {
		...
		async fn(t) {
			var e, s;
			const { x: n, y: o, placement: r, middlewareData: a } = t, l = await hd(t, i);
	...
	return i === void 0 && (i = {}), {
		...
		options: i,
		async fn(t) {
			const { x: e, y: s, placement: n } = t, { mainAxis: o = !0, crossAxis: r = !1, limiter: a = { fn: (m) => {
				let { x: b, y } = m;
				return {
					x: b,
					y
...
function ls(i) {
	const { overflow: t, overflowX: e, overflowY: s, display: n } = kt(i);
...
function oi(i) {
	if (fe(i) === "html") return i;
	const t = i.assignedSlot || i.parentNode || Yr(i) && i.host || xe(i);
...
function ti(i) {
	const t = rc(i);
	if (!zt(t)) return ue(1);
	const e = t.getBoundingClientRect(), { width: s, height: n, $: o } = oc(t);
...
function $d(i, t) {
	const e = Yi(i, !0, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, o = zt(i) ? ti(i) : ue(1);
	return {
...
function Xr(i, t, e) {
	let s;
	if (t === "viewport") s = Ed(i, e);
	else if (t === "document") s = Pd(xe(i));
	else if (It(t)) s = $d(t, e);
	else {
		const n = ac(i);
		s = {
			...t,
...
function Rd(i, t, e) {
	...
	const l = ue(0);
	if (s || !s && !o) if ((fe(t) !== "body" || ls(n)) && (a = _n(t)), s) {
		const d = Yi(t, !0, o, t);
...
function dc(i, t) {
	const e = wt(i);
	if (!zt(i) || lc(i)) return e;
	let s = Gr(i, t);
	for (; s && pd(s) && kt(s).position === "static";) s = Gr(s, t);
...
*/
var Bs = globalThis, qo = Bs.ShadowRoot && (Bs.ShadyCSS === void 0 || Bs.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Yo = Symbol(), Kr = /* @__PURE__ */ new WeakMap();
var uc = class {
	constructor(t, e, s) {
		if (this._$cssResult$ = !0, s !== Yo) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
var Bd = (i) => new uc(typeof i == "string" ? i : i + "", void 0, Yo), H = (i, ...t) => {
	return new uc(i.length === 1 ? i[0] : t.reduce((s, n, o) => s + ((r) => {
		if (r._$cssResult$ === !0) return r.cssText;
		if (typeof r == "number") return r;
		throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
	})(n) + i[o + 1], i[0]), i, Yo);
}, Fd = (i, t) => {
	if (qo) i.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
	else for (const e of t) {
		const s = document.createElement("style"), n = Bs.litNonce;
...
* SPDX-License-Identifier: BSD-3-Clause
*/
var { is: jd, defineProperty: Hd, getOwnPropertyDescriptor: Nd, getOwnPropertyNames: Vd, getOwnPropertySymbols: Wd, getPrototypeOf: Ud } = Object, he = globalThis, Zr = he.trustedTypes, qd = Zr ? Zr.emptyScript : "", Fn = he.reactiveElementPolyfillSupport, Ri = (i, t) => i, Qs = {
	toAttribute(i, t) {
		switch (t) {
			case Boolean:
				i = i ? qd : null;
...
var Ze = class extends HTMLElement {
	...
	static getPropertyDescriptor(t, e, s) {
		const { get: n, set: o } = Nd(this.prototype, t) ?? {
			get() {
				return this[e];
			},
			set(r) {
	...
	static finalizeStyles(t) {
		...
		if (Array.isArray(t)) {
			...
			for (const n of s) e.unshift(Qr(n));
	...
	createRenderRoot() {
		...
		return Fd(t, this.constructor.elementStyles), t;
	}
	connectedCallback() {
		var t;
	...
	requestUpdate(t, e, s, n = !1, o) {
		...
		if (t !== void 0) {
			...
			if (n === !1 && (o = this[t]), s ?? (s = a.getPropertyOptions(t)), !((s.hasChanged ?? Xo)(o, e) || s.useDefault && s.reflect && o === ((r = this._$Ej) == null ? void 0 : r.get(t)) && !this.hasAttribute(a._$Eu(t, s)))) return;
			this.C(t, e, s);
		}
...
Ze.elementStyles = [], Ze.shadowRootOptions = { mode: "open" }, Ze[Ri("elementProperties")] = /* @__PURE__ */ new Map(), Ze[Ri("finalized")] = /* @__PURE__ */ new Map(), Fn?.({ ReactiveElement: Ze }), (he.reactiveElementVersions ?? (he.reactiveElementVersions = [])).push("2.1.2");
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/
var Li = globalThis, ta = (i) => i, Zs = Li.trustedTypes, ea = Zs ? Zs.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, fc = "$lit$", ne = `lit$${Math.random().toFixed(9).slice(2)}$`, pc = "?" + ne, Yd = `<${pc}>`, je = document, Xi = () => je.createComment(""), Gi = (i) => i === null || typeof i != "object" && typeof i != "function", Go = Array.isArray, Xd = (i) => Go(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", jn = `[ 	
\f\r]`, _i = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ia = /-->/g, sa = />/g, Ae = RegExp(`>|${jn}(?:([^\\s"'>=/]+)(${jn}*=${jn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), na = /'/g, oa = /"/g, gc = /^(?:script|style|textarea|title)$/i, Gd = (i) => (t, ...e) => ({
	_$litType$: i,
	strings: t,
	values: e
}), C = Gd(1), He = Symbol.for("lit-noChange"), V = Symbol.for("lit-nothing"), ra = /* @__PURE__ */ new WeakMap(), Re = je.createTreeWalker(je, 129);
function mc(i, t) {
	if (!Go(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
var Kd = (i, t) => {
	...
	for (let a = 0; a < e; a++) {
		const l = i[a];
		let c, h, d = -1, u = 0;
		for (; u < l.length && (r.lastIndex = u, h = r.exec(l), h !== null);) u = r.lastIndex, r === _i ? h[1] === "!--" ? r = ia : h[1] !== void 0 ? r = sa : h[2] !== void 0 ? (gc.test(h[2]) && (n = RegExp("</" + h[2], "g")), r = Ae) : h[3] !== void 0 && (r = Ae) : r === Ae ? h[0] === ">" ? (r = n ?? _i, d = -1) : h[1] === void 0 ? d = -2 : (d = r.lastIndex - h[2].length, c = h[1], r = h[3] === void 0 ? Ae : h[3] === "\"" ? oa : na) : r === oa || r === na ? r = Ae : r === ia || r === sa ? r = _i : (r = Ae, n = void 0);
...
var Ki = class Ki {
	constructor({ strings: t, _$litType$: e }, s) {
		...
		for (; (n = Re.nextNode()) !== null && l.length < a;) {
			if (n.nodeType === 1) {
				if (n.hasAttributes()) for (const d of n.getAttributeNames()) if (d.endsWith(fc)) {
					...
					l.push({
						...
						name: p[2],
						strings: f,
						ctor: p[1] === "." ? Zd : p[1] === "?" ? Jd : p[1] === "@" ? tu : wn
					}), n.removeAttribute(d);
				} else d.startsWith(ne) && (l.push({
					type: 6,
					index: o
				}), n.removeAttribute(d));
				if (gc.test(n.tagName)) {
					...
					if (u > 0) {
						...
						for (let f = 0; f < u; f++) n.append(d[f], Xi()), Re.nextNode(), l.push({
							type: 2,
							index: ++o
						});
						n.append(d[u], Xi());
			...
			} else if (n.nodeType === 8) if (n.data === pc) l.push({
				type: 2,
				index: o
			});
			else {
				let d = -1;
				for (; (d = n.data.indexOf(ne, d + 1)) !== -1;) l.push({
					type: 7,
					index: o
				}), d += ne.length - 1;
			}
...
var cs = class cs {
	...
	k(t) {
		...
		const e = this._$AH;
		let s, n = 0;
		for (const o of t) n === e.length ? e.push(s = new cs(this.O(Xi()), this.O(Xi()), this, this.options)) : s = e[n], s._$AI(o), n++;
...
var wn = class {
	...
	constructor(t, e, s, n, o) {
		this.type = 1, this._$AH = V, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = o, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(/* @__PURE__ */ new String()), this.strings = s) : this._$AH = V;
	}
	_$AI(t, e = this, s, n) {
		const o = this.strings;
		let r = !1;
		if (o === void 0) t = ri(this, t, e, 0), r = !Gi(t) || t !== this._$AH && t !== He, r && (this._$AH = t);
		else {
			const a = t;
			let l, c;
			for (t = o[0], l = 0; l < o.length - 1; l++) c = ri(this, a[s + l], e, l), c === He && (c = this._$AH[l]), r || (r = !Gi(c) || c !== this._$AH[l]), c === V ? t = V : t !== V && (t += (c ?? "") + o[l + 1]), this._$AH[l] = c;
		}
		r && !n && this.j(t);
	}
	j(t) {
...
var tu = class extends wn {
	...
	_$AI(t, e = this) {
		if ((t = ri(this, t, e, 0) ?? V) === He) return;
...
Hn?.(Ki, cs), (Li.litHtmlVersions ?? (Li.litHtmlVersions = [])).push("3.3.2");
var ho = (i, t, e) => {
...
var Gl;
B._$litElement$ = !0, B.finalized = !0, (Gl = Ie.litElementHydrateSupport) == null || Gl.call(Ie, { LitElement: B });
...
var Ii = (i, t) => {
	...
	for (const n of e) (s = n._$AO) == null || s.call(n, t, !1), Ii(n, t);
	return !0;
}, Js = (i) => {
	let t, e;
	do {
...
function ru(i, t = !1, e = 0) {
	...
	if (n !== void 0 && n.size !== 0) if (t) if (Array.isArray(s)) for (let o = e; o < s.length; o++) Ii(s[o], !1), Js(s[o]);
	else s != null && (Ii(s, !1), Js(s));
	else Ii(this, i);
}
var au = (i) => {
...
var lu = class extends vc {
	...
	setValue(t) {
		if (nu(this._$Ct)) this._$Ct._$AI(t, this);
		else {
...
var ai = () => new cu();
var cu = class {};
var Vn = /* @__PURE__ */ new WeakMap(), Bt = yc(class extends lu {
	render(i) {
		return V;
	}
	update(i, [t]) {
...
function aa(i) {
	const t = { ...Sc }, e = (s, n) => i.getAttribute(s) || n;
...
function pu(i, t) {
	for (const e in Sc) if (i[e] !== t[e]) return !0;
	return !1;
}
var kc = /^[a-z0-9]+(-[a-z0-9]+)*$/, ds = (i, t, e, s = "") => {
	const n = i.split(":");
	if (i.slice(0, 1) === "@") {
	...
	if (e && s === "") {
		...
		return t && !Fs(a, e) ? null : a;
	}
	return null;
}, Fs = (i, t) => i ? !!((t && i.prefix === "" || i.prefix) && i.name) : !1;
function gu(i, t) {
...
function la(i, t) {
	const e = mu(i, t);
	for (const s in uo) s in tn ? s in i && !(s in e) && (e[s] = tn[s]) : s in t ? e[s] = t[s] : s in i && (e[s] = i[s]);
	return e;
}
function bu(i, t, e) {
...
function Ac(i) {
	...
	const t = i;
	if (typeof t.prefix != "string" || !i.icons || typeof i.icons != "object" || !Wn(i, yu)) return null;
	const e = t.icons;
	for (const n in e) {
		const o = e[n];
		if (!n || typeof o.body != "string" || !Wn(o, uo)) return null;
	}
	const s = t.aliases || /* @__PURE__ */ Object.create(null);
	for (const n in s) {
		const o = s[n], r = o.parent;
		if (!n || typeof r != "string" || !e[r] && !s[r] || !Wn(o, uo)) return null;
	}
	return t;
}
...
var Sn = /* @__PURE__ */ Object.create(null), wi = ["https://api.simplesvg.com", "https://api.unisvg.com"], js = [];
for (; wi.length > 0;) wi.length === 1 || Math.random() > .5 ? js.push(wi.shift()) : js.push(wi.pop());
...
function Ou(i, t, e, s) {
	...
	function w(S, k, M) {
		...
		switch (u = u.filter((P) => P !== S), l) {
			case "pending": break;
			case "failed":
				if (E || !i.dataAfterTimeout) return;
				break;
			default: return;
		}
		if (k === "abort") {
...
function Dc(i, t, e) {
	...
	if (typeof i == "string") {
		...
		if (o) {
			s = Oc(o);
			const a = po(i.resources ? i.resources[0] : "");
			a && (n = a.send);
		}
	}
...
function Lu(i, t) {
	i.iconsToLoad ? i.iconsToLoad = i.iconsToLoad.concat(t).sort() : i.iconsToLoad = t, i.iconsQueueFlag || (i.iconsQueueFlag = !0, setTimeout(() => {
		...
		if (a.length && Si(i, a, null), !r.length) return;
...
var Fu = /(-?[0-9.]*[0-9]+[0-9.]*)/g, ju = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function go(i, t, e) {
	if (t === 1) return i;
	...
	if (i) {
		if (i.IconifyPreload !== void 0) {
			...
			typeof e == "object" && e !== null && (e instanceof Array ? e : [e]).forEach((n) => {
				try {
					(typeof n != "object" || n === null || n instanceof Array || typeof n.icons != "object" || typeof n.prefix != "string" || !ca(n)) && console.error(s);
				} catch {
					console.error(s);
				}
			});
...
var mo = { "background-color": "currentColor" }, Bc = { "background-color": "transparent" }, ba = {
	image: "var(--svg)",
	repeat: "no-repeat",
	size: "100% 100%"
}, ya = {
...
function rf(i, t, e) {
	...
	const o = i.attributes, a = Lc(Zo(n, {
		...o,
		width: t.width + "",
		height: t.height + ""
	})), l = s.style, c = {
...
function cf(i) {
	...
	return t.innerHTML = lf(Zo(i.body, e)), t.firstChild;
}
function bo(i) {
	...
	const n = [
		...
		*/
		constructor() {
			...
			ma(l, c), this._state = _a({ value: "" }, c), this._queueCheck();
		}
		/**
		* Connected to DOM
		*/
		...
		*/
		_renderIcon(l, c, h) {
			const d = Bu(l.data.body, h), u = this._state.inline;
...
var { iconLoaded: h0, getIcon: d0, listIcons: u0, addIcon: f0, addCollection: uf, calculateSize: p0, buildIcon: g0, iconToHTML: m0, svgToURL: b0, loadIcons: ff, loadIcon: y0, setCustomIconLoader: v0, setCustomIconsLoader: x0, addAPIProvider: _0, _api: w0 } = hf() || zc(), _e = {
	scrollbar: H`
  ::-webkit-scrollbar {
    width: 0.4rem;
    height: 0.4rem;
...
`
	...
	*/
	static init(t = "", e = !0) {
		I.addGlobalStyles(), I.defineCustomElement("bim-button", wf), I.defineCustomElement("bim-checkbox", pe), I.defineCustomElement("bim-color-input", Ft), I.defineCustomElement("bim-context-menu", Hs), I.defineCustomElement("bim-dropdown", vt), I.defineCustomElement("bim-grid", Ne), I.defineCustomElement("bim-icon", xo), I.defineCustomElement("bim-input", Ve), I.defineCustomElement("bim-label", bi), I.defineCustomElement("bim-number-input", pt), I.defineCustomElement("bim-option", tt), I.defineCustomElement("bim-panel", Jt), I.defineCustomElement("bim-panel-section", ge), I.defineCustomElement("bim-selector", me), I.defineCustomElement("bim-table", er), I.defineCustomElement("bim-tabs", Et), I.defineCustomElement("bim-tab", ft), I.defineCustomElement("bim-table-cell", on), I.defineCustomElement("bim-table-children", wo), I.defineCustomElement("bim-table-group", rn), I.defineCustomElement("bim-table-row", We), I.defineCustomElement("bim-text-input", xt), I.defineCustomElement("bim-toolbar", di), I.defineCustomElement("bim-toolbar-group", hi), I.defineCustomElement("bim-toolbar-section", be), I.defineCustomElement("bim-viewport", an), I.defineCustomElement("bim-chart-legend", ln), I.defineCustomElement("bim-chart", J), I.defineCustomElement("bim-tooltip", n0), e && this.animateOnLoad(t);
	}
	static newRandomId() {
...
var ci = class extends B {
	...
	*/
	static create(t, e) {
		...
		if (t.length === 0) return ho(t(), s), s.firstElementChild;
...
function wa(i) {
	const t = mf.find((a) => i.split(a).length === 2), [s, n] = i.split(t).map((a) => a.trim());
	return {
		key: s,
		condition: t,
		value: n.startsWith("'") && n.endsWith("'") ? n.replace(/'/g, "") : Cn(n)
	};
}
var yo = (i) => {
	try {
...
var bf = class extends Set {
	...
	add(...t) {
		for (const e of t) this.has(e) || !(this.guard ?? (() => !0))(e) || (super.add(e), this.onItemAdded || (this.onItemAdded = new Me()), this.onItemAdded.trigger(e));
...
var yf = Object.defineProperty, vf = Object.getOwnPropertyDescriptor, Fc = (i, t, e, s) => {
	for (var n = vf(t, e), o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = r(t, e, n) || n);
	return n && yf(t, e, n), n;
}, ot;
var Jo = (ot = class extends B {
	constructor() {
	...
	static removeMenus() {
		for (const t of [...ot.dialog.children]) t instanceof ot && (t.remove(), t.visible = !1);
		setTimeout(() => {
	...
	*/
	async updatePosition() {
		...
		const t = this.placement ?? "right", { x: s, y: n } = await Uo(this._previousContainer, this, {
			placement: t,
			middleware: [
				Fo(10),
				Wo(),
...
var xf = Object.defineProperty, _f = Object.getOwnPropertyDescriptor, $t = (i, t, e, s) => {
	for (var n = s > 1 ? void 0 : s ? _f(t, e) : t, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
	return s && n && xf(t, e, n), n;
}, Fe;
var Ct = (Fe = class extends B {
	constructor() {
		super(), this.labelHidden = !1, this.active = !1, this.disabled = !1, this.vertical = !1, this.tooltipVisible = !1, this._stateBeforeLoading = {
          ...
          `;
			...
			if (t) {
				...
				for (const n of t.children) n instanceof Fe && n.setAttribute("data-context-group", s);
				t.visible = !0;
			}
		}, this.mouseLeave = !0;
	}
	...
	closeNestedContexts() {
		...
		if (t) for (const e of Hs.dialog.children) {
			const s = e.getAttribute("data-context-group");
			if (e instanceof Hs && s === t) {
				e.visible = !1, e.removeAttribute("data-context-group");
				for (const n of e.children) n instanceof Fe && (n.closeNestedContexts(), n.removeAttribute("data-context-group"));
			}
		}
	}
	click() {
...
we([v({ converter: { fromAttribute(i) {
	return i && Cn(i);
...
var Mf = Object.defineProperty, Pf = Object.getOwnPropertyDescriptor, Ot = (i, t, e, s) => {
	for (var n = s > 1 ? void 0 : s ? Pf(t, e) : t, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
	return s && n && Mf(t, e, n), n;
};
var Sr = class Sr extends ci {
	constructor() {
...
Ot([te()], vt.prototype, "_value", 2);
Ot([te()], vt.prototype, "_hasVisibleOptions", 2);
function Ef(i) {
	const t = [], e = /(["'])(.*?)\1/g;
	let s;
	for (; (s = e.exec(i)) !== null;) {
...
* SPDX-License-Identifier: BSD-3-Clause
*/
var jc = "important", Bf = " !" + jc, vo = yc(class extends vc {
	constructor(i) {
		var t;
		if (super(i), i.type !== bc.ATTRIBUTE || i.name !== "style" || ((t = i.strings) == null ? void 0 : t.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
	}
	render(i) {
	...
	update(i, [t]) {
		...
		for (const s in t) {
			...
			if (n != null) {
				this.ft.add(s);
				const o = typeof n == "string" && n.endsWith(Bf);
...
var Ff = Object.defineProperty, An = (i, t, e, s) => {
	for (var n = void 0, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = r(t, e, n) || n);
	return n && Ff(t, e, n), n;
};
var kr = class kr extends B {
	constructor() {
		super(...arguments), this.floating = !1, this.resizeableAreas = !1, this.areasResizeExceptions = [], this._layouts = {}, this._elements = {}, this._templateIds = /* @__PURE__ */ new Map(), this._updateFunctions = {}, this._slotNames = {
			...
			if (n.type === "vertical") {
				const a = n.from[0], h = a === this._colSizesRaw.length - 1, d = Tf(this._start, e, a, h);
				if (!Lf(d.left, d.right, e, r)) return;
			...
			if (n.type === "horizontal") {
				const a = n.from[1], h = a === this._rowSizesRaw.length - 1, d = Rf(this._start, s, a, h);
				if (!If(d.top, d.bottom, s, r)) return;
	...
	*/
	...
	computeDividers() {
		...
		if (!t) return;
		const s = Of(Ef(t)), n = getComputedStyle(this), o = [];
		for (const a of s) {
			let l = !1;
			...
			if (t) {
				...
				const o = this.getLayoutAreas(t).map((a) => {
					...
					if (h ? (l = h[1], c = h[2].split(",").map((y) => {
						...
						if (w > -1) return {
							key: x.substring(0, w).trim(),
							label: x.substring(w + 1).trim() || void 0
						};
						return { key: x };
					})) : c = [{ key: a }], !d) {
						const b = c[0].key, y = ((g = t.elements) == null ? void 0 : g[b]) || this.elements[b];
						if (!y) return null;
						const x = this.createElementFromDefinition(b, y);
						return x ? (this.emitElementCreation({
							name: b,
							element: x
						}), x.style.gridArea = a, x) : null;
					}
					const u = `tabs-${l}`;
					let f = this.querySelector(`[data-grid-tabs-id="${u}"]`);
					...
					for (const b of c) {
						...
						if (!w) continue;
						const _ = this.createElementFromDefinition(y, w);
						if (!_) continue;
						...
						const S = `tab-${l}-${y}`;
						let k = f.querySelector(`[data-grid-tab-id="${S}"]`);
...
bn.styles = H`
  ...
  `, bn.properties = { icon: { type: String } };
var xo = bn;
var jf = Object.defineProperty, Mn = (i, t, e, s) => {
	for (var n = void 0, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = r(t, e, n) || n);
	return n && jf(t, e, n), n;
};
var Cr = class Cr extends B {
	constructor() {
...
var Nf = Object.defineProperty, Vf = Object.getOwnPropertyDescriptor, At = (i, t, e, s) => {
	for (var n = s > 1 ? void 0 : s ? Vf(t, e) : t, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
	return s && n && Nf(t, e, n), n;
};
var Ar = class Ar extends B {
	constructor() {
...
var Wf = Object.defineProperty, Uf = Object.getOwnPropertyDescriptor, ps = (i, t, e, s) => {
	for (var n = s > 1 ? void 0 : s ? Uf(t, e) : t, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
	return s && n && Wf(t, e, n), n;
};
var Mr = class Mr extends B {
	constructor() {
	...
	*/
	...
	animateHeader() {
		...
		this.componentHeight < 0 && (this.collapsed ? this.componentHeight = t.clientHeight : (t.style.setProperty("transition", "none"), t.style.setProperty("height", "auto"), t.style.setProperty("padding", "0.125rem 1rem 1rem"), this.componentHeight = t.clientHeight, requestAnimationFrame(() => {
			t.style.setProperty("height", "0px"), t.style.setProperty("padding", "0 1rem 0"), t.style.setProperty("transition", "height 0.25s cubic-bezier(0.65, 0.05, 0.36, 1), padding 0.25s cubic-bezier(0.65, 0.05, 0.36, 1)");
			...
			t.style.setProperty("height", `${this.componentHeight}px`), t.style.setProperty("padding", "0.125rem 1rem 1rem");
...
ms([te()], me.prototype, "_value");
function Xf(i, t, e) {
	if (t.length === 0 || i.length === 0) return i;
	return tr(er.flattenData(i), t, e);
}
function tr(i, t, e) {
...
var Dr = class Dr extends B {
	...
	animateTableChildren(t = !0) {
		...
		requestAnimationFrame(() => {
			var g;
			const r = this.renderRoot.querySelector("bim-table-children"), a = this.renderRoot.querySelector(".caret"), l = this.renderRoot.querySelector(".branch-vertical"), c = (g = this.renderRoot.querySelector("bim-table-children")) == null ? void 0 : g.querySelector(".branch-vertical"), h = () => {
				var b;
				((b = r == null ? void 0 : r.renderRoot) == null ? void 0 : b.querySelectorAll("bim-table-group"))?.forEach((y, x) => {
				...
				if (m) {
					...
					m.animate([{ transform: "scaleX(0)" }, { transform: "scaleX(1)" }], {
						duration: n,
						easing: "cubic-bezier(0.4, 0, 0.2, 1)",
						fill: "forwards",
						direction: this.childrenHidden ? "normal" : "reverse"
	...
	render() {
		if (!this.table) return C`${V}`;
		const t = this.table.getGroupIndentation(this.data) ?? 0;
		let e;
		if (!this.table.noIndentation) e = C`<div style=${vo({ left: `${t - 1 + (this.table.selectableRows ? 2.05 : .5625)}rem` })} class="branch branch-horizontal"></div>`;
		const s = C`
...
var Tr = class Tr extends B {
	...
	onSelectionChange(t) {
		...
		if (this.selected = e.value, e.value) {
			let s = [this.data];
			this.isHeader && (s = er.flattenData(this.table.data).map((n) => n.data)), this.table.selection.add(...s), this.isHeader && this.table.dispatchEvent(new CustomEvent("rowselected", { detail: { data: this.data } }));
	...
	render() {
		var n, o, r;
		if (!(this.table && this._intersecting)) return C`${V}`;
...
Pn([te()], We.prototype, "_intersecting");
Pn([te()], We.prototype, "dataTransform");
var rp = Object.defineProperty, ap = Object.getOwnPropertyDescriptor, gt = (i, t, e, s) => {
	for (var n = s > 1 ? void 0 : s ? ap(t, e) : t, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
	return s && n && rp(t, e, n), n;
}, mi;
var ut = (mi = class extends B {
	constructor() {
    ...
    >`, this._stringFilterFunction = (t, e) => Object.values(e.data).some((n) => String(n).toLowerCase().includes(t.toLowerCase())), this._queryFilterFunction = (t, e) => {
			...
			for (const o of n) {
				...
				if (l.startsWith("[") && l.endsWith("]")) {
					...
					l = c, s = Object.keys(e.data).filter((u) => u.includes(c)).map((u) => Sa(e.data[u], r, a)).some((u) => u);
				} else s = Sa(e.data[l], r, a);
				if (!s) break;
			}
			return s;
	...
	static flattenData(t) {
		const e = [];
		for (const s of t) e.push({ data: s.data }), s.children && s.children.length > 0 && e.push(...mi.flattenData(s.children));
		return e;
	}
	set columns(t) {
		const e = [];
	...
	*/
	...
	filterData(t = this.data) {
		...
		if (this.queryString) {
			...
			s || (s = yo(this.queryString) ? this._queryFilterFunction : this._stringFilterFunction), e = this.filter(this.queryString, s, t), this.preserveStructureOnFilter && (this._expandedBeforeFilter === void 0 && (this._expandedBeforeFilter = this.expanded), this.expanded = !0);
...
`;
		...
		for (const [l, c] of e.entries()) {
			const { data: h, children: d } = c, p = `${this.indentationInText ? `${s}${l + 1}${o}` : ""}${a.map((g) => h[g] ?? "").join(o)}
`;
	...
	*/
	getGroupingMessageTemplate() {
		if (this.groupedBy.length === 0) return V;
		return C`
      <bim-label
	...
	render() {
      ...
      <div class="parent">
        ...
        "
        >
          ${ei(!this.headersHidden, () => C`<bim-table-row
                is-header
...
gt([v({ attribute: !1 })], ut.prototype, "groupingTransform", 2);
gt([v({
	type: Boolean,
	reflect: !0,
...
gt([te()], ut.prototype, "_errorLoading", 2);
gt([v({
	type: Boolean,
...
var lp = Object.defineProperty, cp = Object.getOwnPropertyDescriptor, yi = (i, t, e, s) => {
	for (var n = s > 1 ? void 0 : s ? cp(t, e) : t, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
	return s && n && lp(t, e, n), n;
};
var Rr = class Rr extends B {
	constructor() {
	...
	set tab(t) {
		this._tab = t;
		const e = [...this.children], s = e.find((n) => n instanceof ft && n.name === t);
		for (const n of e) {
	...
	setAnimatedBackgound(t = !1) {
		var n;
		const e = this.renderRoot.querySelector(".animated-background"), s = [...((n = this.renderRoot.querySelector(".switchers")) == null ? void 0 : n.querySelectorAll(".switcher")) || []].filter((o) => o.hasAttribute("data-active"))[0];
		requestAnimationFrame(() => {
			var a, l, c, h;
			...
			s ? (e?.style.setProperty("width", `${r.width}px`), e?.style.setProperty("height", `${r.height}px`), e?.style.setProperty("left", `${r.left}px`)) : e?.style.setProperty("width", "0"), this.bottom ? (e?.style.setProperty("top", "100%"), e?.style.setProperty("transform", "translateY(-100%)")) : e?.style.setProperty("top", `${r.top}px`);
		}), t && this.doubleRequestAnimationFrames(() => {
			const r = "ease";
			e?.style.setProperty("transition", `width 0.3s ${r}, height 0.3s ${r}, top 0.3s ${r}, left 0.3s ${r}`);
		});
	}
	firstUpdated() {
		requestAnimationFrame(() => {
...
Rr.styles = [_e.scrollbar, H`
    ...
    `];
var Et = Rr;
yi([te()], Et.prototype, "_switchers", 2);
yi([v({
	type: Boolean,
	reflect: !0
...
var pp = Object.defineProperty, gp = Object.getOwnPropertyDescriptor, Hc = (i, t, e, s) => {
	for (var n = s > 1 ? void 0 : s ? gp(t, e) : t, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
	return s && n && pp(t, e, n), n;
};
var zr = class zr extends B {
	constructor() {
...
var Br = class Br extends B {
	...
	updateChildren() {
		const t = this.children;
		for (const e of t) e instanceof hi && (e.vertical = this.vertical), e.toggleAttribute("label-hidden", this.vertical);
	}
	render() {
		return C`
      <div class="parent">
...
var Fr = class Fr extends B {
	...
	updateSections() {
		const t = this.children;
		for (const e of t) e instanceof be && (e.labelHidden = this.vertical && !li.config.sectionLabelOnVerticalToolbar, e.vertical = this.vertical);
	}
	render() {
		return C`
      <div class="parent">
...
var St = {
	...
	e: 14,
	f: 15
}, So = [..."0123456789ABCDEF"], kp = (i) => So[i & 15], Cp = (i) => So[(i & 240) >> 4] + So[i & 15], xs = (i) => (i & 240) >> 4 === (i & 15), Ap = (i) => xs(i.r) && xs(i.g) && xs(i.b) && xs(i.a);
function Mp(i) {
	var t = i.length, e;
...
function sr(i) {
	...
	let l, c, h;
	return o !== r && (h = o - r, c = a > .5 ? h / (2 - o - r) : h / (o + r), l = Tp(e, s, n, h, o), l = l * 60 + .5), [
		l | 0,
		c || 0,
		a
	];
...
function Fp() {
	...
	for (s = 0; s < t.length; s++) {
		for (r = a = t[s], n = 0; n < e.length; n++) o = e[n], a = a.replace(o, Ca[o]);
		o = parseInt(Aa[r], 16), i[a] = [
			o >> 16 & 255,
			o >> 8 & 255,
			o & 255
		];
...
var Yn = (i) => i <= .0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - .055, Ke = (i) => i <= .04045 ? i / 12.92 : Math.pow((i + .055) / 1.055, 2.4);
function Wp(i, t, e) {
...
var ui = class ui {
	...
	greyscale() {
		const t = this._rgb;
		return t.r = t.g = t.b = bs(t.r * .3 + t.g * .59 + t.b * .11), this;
	}
	opaquer(t) {
		const e = this._rgb;
		return e.a *= 1 + t, this;
...
var Xp = (i, t) => typeof i == "string" && i.endsWith("%") ? parseFloat(i) / 100 : +i / t, Uc = (i, t) => typeof i == "string" && i.endsWith("%") ? parseFloat(i) / 100 * t : +i;
function W(i, t, e) {
	if (i && typeof i.call == "function") return i.apply(e, t);
}
function N(i, t, e, s) {
	let n, o, r;
	if (X(i)) for (o = i.length, n = 0; n < o; n++) t.call(e, i[n], n);
	else if (R(i)) for (r = Object.keys(i), o = r.length, n = 0; n < o; n++) t.call(e, i[r[n]], r[n]);
}
function cn(i, t) {
	let e, s, n, o;
...
function jt(i, t, e) {
	const s = X(t) ? t : [t], n = s.length;
	if (!R(i)) return i;
	e = e || {};
	const o = e.merger || Gp;
	let r;
	for (let a = 0; a < n; ++a) {
		if (r = s[a], !R(r)) continue;
...
function Bi(i, t) {
	return jt(i, t, { merger: Kp });
}
function Kp(i, t, e) {
	if (!qc(i)) return;
	const s = t[i], n = e[i];
	R(s) && R(n) ? Bi(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = hn(n));
}
var Pa = {
	"": (i) => i,
	x: (i) => i.x,
...
var Ji = (i) => typeof i < "u", ve = (i) => typeof i == "function", Ea = (i, t) => {
...
var F = Math.PI, G = 2 * F, tg = G + F, dn = Number.POSITIVE_INFINITY, eg = F / 180, it = F / 2, Pe = F / 4, $a = F * 2 / 3, re = Math.log10, Lt = Math.sign;
function Fi(i, t, e) {
...
var cr = (i) => i === "start" ? "left" : i === "end" ? "right" : "center", ct = (i, t, e) => i === "start" ? t : i === "end" ? e : (t + e) / 2, dg = (i, t, e, s) => i === (s ? "left" : "right") ? e : i === "center" ? (t + e) / 2 : t;
function Jc(i, t, e) {
	const s = t.length;
	let n = 0, o = s;
	if (i._sorted) {
		...
		if (f) {
			if (n = Math.min(Yt(l, h, d).lo, e ? s : Yt(t, h, r.getPixelForValue(d)).lo), c) {
		...
		if (p) {
			let g = Math.max(Yt(l, r.axis, u, !0).hi + 1, e ? 0 : Yt(t, h, r.getPixelForValue(u), !0).hi + 1);
			if (c) {
...
var Ss = (i) => i === 0 || i === 1, Ra = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin((i - t) * G / e)), La = (i, t, e) => Math.pow(2, -10 * i) * Math.sin((i - t) * G / e) + 1, ji = {
	linear: (i) => i,
	easeInQuad: (i) => i * i,
	easeOutQuad: (i) => -i * (i - 2),
	...
	easeInOutSine: (i) => -.5 * (Math.cos(F * i) - 1),
	easeInExpo: (i) => i === 0 ? 0 : Math.pow(2, 10 * (i - 1)),
	easeOutExpo: (i) => i === 1 ? 1 : -Math.pow(2, -10 * i) + 1,
	easeInOutExpo: (i) => Ss(i) ? i : i < .5 ? .5 * Math.pow(2, 10 * (i * 2 - 1)) : .5 * (-Math.pow(2, -10 * (i * 2 - 1)) + 2),
	easeInCirc: (i) => i >= 1 ? i : -(Math.sqrt(1 - i * i) - 1),
	easeOutCirc: (i) => Math.sqrt(1 - (i -= 1) * i),
	easeInOutCirc: (i) => (i /= .5) < 1 ? -.5 * (Math.sqrt(1 - i * i) - 1) : .5 * (Math.sqrt(1 - (i -= 2) * i) + 1),
	easeInElastic: (i) => Ss(i) ? i : Ra(i, .075, .3),
	easeOutElastic: (i) => Ss(i) ? i : La(i, .075, .3),
	easeInOutElastic(i) {
		return Ss(i) ? i : i < .5 ? .5 * Ra(i * 2, .1125, .45) : .5 + .5 * La(i * 2 - 1, .1125, .45);
	},
	easeInBack(i) {
...
function Xn(i) {
	return hr(i) ? i : new ui(i).saturate(.5).darken(.1).hexString();
}
var ug = [
	"x",
	"y",
...
var eh = {
	...
	numeric(i, t, e) {
		...
		if (e.length > 1) {
			...
			(c < 1e-4 || c > 0x38d7ea4c68000) && (n = "scientific"), o = bg(i, e);
		}
	...
	logarithmic(i, t, e) {
		...
		return [
			...
			10,
			15
		].includes(s) || t > .8 * e.length ? eh.numeric.call(this, i, t, e) : "";
	}
};
function bg(i, t) {
...
var Ue = /* @__PURE__ */ Object.create(null), Co = /* @__PURE__ */ Object.create(null);
function Hi(i, t) {
	if (!t) return i;
	const e = t.split(".");
...
function _g(i, t, e, s) {
	...
	const a = e.length;
	let l, c, h, d, u;
	for (l = 0; l < a; l++) if (d = e[l], d != null && !X(d)) r = un(i, n, o, r, d);
	else if (X(d)) for (c = 0, h = d.length; c < h; c++) u = d[c], u != null && !X(u) && (r = un(i, n, o, r, u));
	i.restore();
	const f = o.length / 2;
	if (f > e.length) {
	...
	if (!(isNaN(g) || g <= 0)) {
		switch (i.beginPath(), f) {
			...
			case "triangle":
				...
				break;
			case "rectRounded":
				c = g * .516, l = g - c, r = Math.cos(m + Pe) * l, d = Math.cos(m + Pe) * (n ? n / 2 - c : l), a = Math.sin(m + Pe) * l, u = Math.sin(m + Pe) * (n ? n / 2 - c : l), i.arc(e - d, s - a, c, m - F, m - it), i.arc(e + u, s - r, c, m - it, m), i.arc(e + d, s + a, c, m, m + it), i.arc(e - u, s + r, c, m + it, m + F), i.closePath();
				break;
			case "rect":
				if (!p) {
...
function qe(i, t, e, s, n, o = {}) {
	const r = X(t) ? t : [t], a = o.strokeWidth > 0 && o.strokeColor !== "";
	let l, c;
	for (i.save(), i.font = n.string, kg(i, o), l = 0; l < r.length; ++l) c = r[l], o.backdrop && Ag(i, o.backdrop), a && (o.strokeColor && (i.strokeStyle = o.strokeColor), D(o.strokeWidth) || (i.lineWidth = o.strokeWidth), i.strokeText(c, e, s, o.maxWidth)), i.fillText(c, e, s, o.maxWidth), Cg(i, e, s, c, o), s += Number(n.lineHeight);
	i.restore();
}
function es(i, t) {
	const { x: e, y: s, w: n, h: o, radius: r } = t;
	i.arc(e + r.topLeft, s + r.topLeft, r.topLeft, 1.5 * F, F, !0), i.lineTo(e, s + o - r.bottomLeft), i.arc(e + r.bottomLeft, s + o - r.bottomLeft, r.bottomLeft, F, it, !0), i.lineTo(e + n - r.bottomRight, s + o), i.arc(e + n - r.bottomRight, s + o - r.bottomRight, r.bottomRight, it, 0, !0), i.lineTo(e + n, s + r.topRight), i.arc(e + n - r.topRight, s + r.topRight, r.topRight, 0, -it, !0), i.lineTo(e + r.topLeft, s);
}
var Mg = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/, Pg = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function Eg(i, t) {
	const e = ("" + i).match(Mg);
...
function Y(i, t, e, s) {
	let n, o, r;
	for (n = 0, o = i.length; n < o; ++n) if (r = i[n], r !== void 0 && (t !== void 0 && typeof r == "function" && (r = r(t)), e !== void 0 && X(r) && (r = r[e % r.length]), r !== void 0)) return r;
}
function Og(i, t, e) {
...
function ur(i, t = [""], e, s, n = () => i[0]) {
	...
	return new Proxy({
		...
		_fallback: s,
		_getTarget: n,
		override: (a) => ur([a, ...i], t, o, s)
	}, {
		deleteProperty(a, l) {
			return delete a[l], delete a._keys, delete i[0][l], !0;
		},
		get(a, l) {
			return oh(a, l, () => Fg(l, t, i, a));
		},
...
var Dg = (i, t) => i ? i + rr(t) : t, fr = (i, t) => R(t) && i !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function oh(i, t, e) {
...
var Ig = (i, t) => i === !0 ? t : typeof i == "string" ? ye(t, i) : void 0;
...
function pr(i, t, e, s) {
	const n = t._rootScopes, o = rh(t._fallback, e, s), r = [...i, ...n], a = /* @__PURE__ */ new Set();
	a.add(s);
	let l = Fa(a, r, e, o || e, s);
	return l === null || typeof o < "u" && o !== e && (l = Fa(a, r, o, l, s), l === null) ? !1 : ur(Array.from(a), [""], n, o, () => Bg(t, e, s));
}
function Fa(i, t, e, s, n) {
	for (; e;) e = zg(i, t, e, s, n);
	return e;
}
function Bg(i, t, e) {
...
function Fg(i, t, e, s) {
	let n;
	for (const o of t) if (n = ah(Dg(o, i), e), typeof n < "u") return fr(i, n) ? pr(e, s, i, n) : n;
}
function ah(i, t) {
	for (const e of t) {
		if (!e) continue;
...
function lh(i, t, e, s) {
	...
	let a, l, c, h;
	for (a = 0, l = s; a < l; ++a) c = a + e, h = t[c], r[a] = { r: n.parse(ye(h, o), c) };
	return r;
}
var Hg = Number.EPSILON || 1e-14, gi = (i, t) => t < i.length && !i[t].skip && i[t], ch = (i) => i === "x" ? "y" : "x";
function Ng(i, t, e, s) {
...
function Vg(i, t, e) {
	...
	for (let h = 0; h < s - 1; ++h) if (l = c, c = gi(i, h + 1), !(!l || !c)) {
		if (Fi(t[h], 0, Hg)) {
			e[h] = e[h + 1] = 0;
			continue;
		}
...
function Wg(i, t, e = "x") {
	...
	let o, r, a, l = gi(i, 0);
	for (let c = 0; c < n; ++c) {
		if (r = a, a = l, l = gi(i, c + 1), !a) continue;
		const h = a[e], d = a[s];
...
function Ug(i, t = "x") {
	...
	let r, a, l, c = gi(i, 0);
	for (r = 0; r < s; ++r) if (a = l, l = c, c = gi(i, r + 1), !!l) {
		if (c) {
			const h = c[t] - l[t];
			n[r] = h !== 0 ? (c[e] - l[e]) / h : 0;
		}
...
function qg(i, t) {
	...
	for (e = 0, s = i.length; e < s; ++e) r = o, o = a, a = e < s - 1 && Xt(i[e + 1], t), o && (n = i[e], r && (n.cp1x = ks(n.cp1x, t.left, t.right), n.cp1y = ks(n.cp1y, t.top, t.bottom)), a && (n.cp2x = ks(n.cp2x, t.left, t.right), n.cp2y = ks(n.cp2y, t.top, t.bottom)));
}
function Yg(i, t, e, s, n) {
	let o, r, a, l;
	if (t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === "monotone") Ug(i, n);
	else {
		let c = s ? i[i.length - 1] : i[0];
		for (o = 0, r = i.length; o < r; ++o) a = i[o], l = Ng(c, a, i[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension), a.cp1x = l.previous.x, a.cp1y = l.previous.y, a.cp2x = l.next.x, a.cp2y = l.next.y, c = a;
	}
...
function De(i, t) {
	...
	const { canvas: e, currentDevicePixelRatio: s } = t, n = Rn(e), o = n.boxSizing === "border-box", r = Be(n, "padding"), a = Be(n, "border", "width"), { x: l, y: c, box: h } = Qg(i, e), d = r.left + (h && a.left), u = r.top + (h && a.top);
...
function Zg(i, t, e) {
	...
	if (t === void 0 || e === void 0) {
		...
		if (!o) t = i.clientWidth, e = i.clientHeight;
			...
			const r = o.getBoundingClientRect(), a = Rn(o), l = Be(a, "border", "width"), c = Be(a, "padding");
...
function Jg(i, t, e, s) {
	const n = Rn(i), o = Be(n, "margin"), r = fn(n.maxWidth, i, "clientWidth") || dn, a = fn(n.maxHeight, i, "clientHeight") || dn, l = Zg(i, t, e);
	let { width: c, height: h } = l;
	if (n.boxSizing === "content-box") {
		const u = Be(n, "border", "width"), f = Be(n, "padding");
...
function im(i, t, e, s) {
	const n = {
		...
		x: t.cp1x,
		y: t.cp1y
	}, r = Te(i, n, e), a = Te(n, o, e), l = Te(o, t, e);
	return Te(Te(r, a, e), Te(a, l, e), e);
}
var sm = function(i, t) {
	return {
		x(e) {
...
function fh(i, t, e) {
	...
	for (let M = h, E = h; M <= d; ++M) y = t[M % r], !y.skip && (b = c(y[s]), b !== x && (g = l(b, n, o), m === null && S() && (m = a(b, n) === 0 ? M : E), m !== null && k() && (p.push(Va({
		start: m,
		end: M,
		loop: u,
		count: r,
...
function lm(i, t) {
	...
	return Wa(i, am(e, r, a < r ? a + n : a, !!i._fullLoop && r === 0 && a === n - 1), e, t);
}
function Wa(i, t, e, s) {
...
var mh = class {
	...
	configure(t) {
		...
		Object.getOwnPropertyNames(t).forEach((n) => {
			...
			(X(o.properties) && o.properties || [n]).forEach((a) => {
...
var Zn = (i) => i === "reset" || i === "none", Qa = (i, t) => t ? i : Object.assign({}, i), Cm = (i, t, e) => i && !t.hidden && t._stacked && {
	keys: bh(e, !0),
	values: null
};
var Pt = class {
	...
	getContext(t, e, s) {
		...
		} else o = this.$context || (this.$context = Sm(this.chart.getContext(), this.index)), o.dataset = n, o.index = o.datasetIndex = this.index;
	...
	_resolveElementOptions(t, e = "default", s) {
		...
		const c = this.chart.config, h = c.datasetElementScopeKeys(this._type, t), d = n ? [
			...
			t,
			""
		] : [t, ""], u = c.getOptionScopes(this.getDataset(), h), f = Object.keys(K.elements[t]), p = () => this.getContext(s, n, e), g = c.resolveNamedOptions(u, f, p, d);
...
function Za(i, t, e, s) {
	...
	let c, h, d, u;
	for (c = e, h = e + s; c < h; ++c) u = t[c], d = {}, d[n.axis] = a || n.parse(r[c], c), l.push(yh(u, d, o, c));
	return l;
}
function Jn(i) {
...
var Ns = class extends Pt {
	...
	parseObjectData(t, e, s, n) {
		...
		let u, f, p, g;
		for (u = s, f = s + n; u < f; ++u) g = e[u], p = {}, p[o.axis] = o.parse(ye(g, c), u), d.push(yh(ye(g, h), p, r, u));
		return d;
	}
	updateRangeFromParsed(t, e, s, n) {
	...
	getLabelAndValue(t) {
		const { iScale: s, vScale: n } = this._cachedMeta, o = this.getParsed(t), r = o._custom, a = Jn(r) ? "[" + r.start + ", " + r.end + "]" : "" + n.getLabelForValue(o[n.axis]);
		return {
	...
	_calculateBarValuePixels(t) {
		...
		if (this.chart.getDataVisibility(t) ? p = e.getPixelForValue(u + f) : p = b, g = p - b, Math.abs(g) < r) {
			...
			b = Math.max(Math.min(b, Math.max(y, x)), Math.min(y, x)), p = b + g, s && !h && (l._stacks[e.axis]._visualValues[n] = e.getValueForPixel(p) - e.getValueForPixel(b));
		}
...
var Vs = class extends Pt {
	...
	updateElements(t, e, s, n) {
		...
		for (let u = e; u < e + s; u++) {
			const f = t[u], p = !o && this.getParsed(u), g = {}, m = g[h] = o ? r.getPixelForDecimal(.5) : r.getPixelForValue(p[h]), b = g[d] = o ? a.getBasePixel() : a.getPixelForValue(p[d]);
...
function Im(i, t, e) {
	let s = 1, n = 1, o = 0, r = 0;
	if (t < G) {
		const a = i, l = a + t, c = Math.cos(a), h = Math.sin(a), d = Math.cos(l), u = Math.sin(l), f = (x, w, _) => ts(x, a, l, !0) ? 1 : Math.max(w, w * e, _, _ * e), p = (x, w, _) => ts(x, a, l, !0) ? -1 : Math.min(w, w * e, _, _ * e), g = f(0, c, d), m = f(it, h, u), b = p(F, c, d), y = p(F + it, h, u);
...
var Le = class extends Pt {
	...
	update(t) {
		const { chartArea: s } = this.chart, n = this._cachedMeta, o = n.data, r = this.getMaxBorderWidth() + this.getMaxOffset(o) + this.options.spacing, a = Math.max((Math.min(s.width, s.height) - r) / 2, 0), l = Math.min(Xp(this.options.cutout, a), 1), c = this._getRingWeight(this.index), { circumference: h, rotation: d } = this._getRotationExtents(), { ratioX: u, ratioY: f, offsetX: p, offsetY: g } = Im(d, h, l), m = (s.width - r) / u, b = (s.height - r) / f, y = Math.max(Math.min(m, b) / 2, 0), x = Uc(this.options.radius, y), _ = (x - Math.max(x * l, 0)) / this._getVisibleDatasetWeightTotal();
...
var Ni = class extends Pt {
	...
	updateElements(t, e, s, n) {
		const o = n === "reset", r = this.chart, l = r.options.animation, c = this._cachedMeta.rScale, h = c.xCenter, d = c.yCenter, u = c.getIndexAngle(0) - .5 * F;
		let f = u, p;
...
function Ln(i, t, e, s, n) {
	...
	for (let a = 0, l = o.length; a < l; ++a) {
		const { index: c, data: h } = o[a], { lo: d, hi: u } = Fm(o[a], t, r, n);
		for (let f = d; f <= u; ++f) {
			const p = h[f];
			p.skip || s(p, c, f);
		}
...
function Hm(i, t, e, s) {
	let n = [];
	function o(r, a, l) {
		const { startAngle: c, endAngle: h } = r.getProps(["startAngle", "endAngle"], s), { angle: d } = Xc(r, {
			x: t.x,
			y: t.y
		});
		ts(d, c, h) && n.push({
...
var Vm = { modes: {
	...
	point(i, t, e, s) {
		return to(i, De(t, i), e.axis || "xy", s, e.includeInvisible || !1);
	},
	nearest(i, t, e, s) {
		const n = De(t, i), o = e.axis || "xy", r = e.includeInvisible || !1;
	...
	x(i, t, e, s) {
		return el(i, De(t, i), "x", e.intersect, s);
	},
	y(i, t, e, s) {
		return el(i, De(t, i), "y", e.intersect, s);
	}
} };
var vh = [
	"left",
...
function Jm(i, t) {
	...
	if (ol(s)) if (i.style.height === "") i.height = i.width / (t || 2);
	else {
		const o = Na(i, "height");
		o !== void 0 && (i.height = o);
	}
...
function sb(i, t, e) {
	const s = i.canvas, n = new MutationObserver((o) => {
		let r = !1;
		for (const a of o) r = r || pn(a.addedNodes, s), r = r && !pn(a.removedNodes, s);
		r && e();
	});
...
function nb(i, t, e) {
	const s = i.canvas, n = new MutationObserver((o) => {
		let r = !1;
		for (const a of o) r = r || pn(a.removedNodes, s), r = r && !pn(a.addedNodes, s);
		r && e();
	});
	return n.observe(document, {
		childList: !0,
...
function db(i, t) {
	...
	if (r > n) return gb(t, c, o, r / n), c;
	const h = fb(o, t, n);
	if (r > 0) {
		let d, u;
		const f = r > 1 ? Math.round((l - a) / (r - 1)) : null;
		for (Ms(t, c, h, D(f) ? 0 : a - f, a), d = 0, u = r - 1; d < u; d++) Ms(t, c, h, o[d], o[d + 1]);
...
var bb = (i) => i === "left" ? "right" : i === "right" ? "left" : i, al = (i, t, e) => t === "top" || t === "left" ? i[t] + e : i[t] - e, ll = (i, t) => Math.min(t || i, i);
function cl(i, t) {
...
function Sb(i, t, e, s) {
	...
	if (i.isHorizontal()) {
		...
		} else e === "center" ? p = (c.bottom + c.top) / 2 + g - t : p = al(i, e, t);
		u = a - o;
	} else {
		if (R(e)) {
			const b = Object.keys(e)[0], y = e[b];
			f = h[b].getPixelForValue(y) - m + t;
		} else e === "center" ? f = (c.left + c.right) / 2 - m + t : f = al(i, e, t);
...
var Xe = class Xe extends ee {
	...
	generateTickLabels(t) {
		...
		let s, n, o;
		for (s = 0, n = t.length; s < n; s++) o = t[s], o.label = W(e.callback, [
			o.value,
			s,
			t
		], this);
	...
	calculateLabelRotation() {
		...
		a = t.offset ? this.maxWidth / s : f / (s - 1), d + 6 > a && (a = f / (s - (t.offset ? .5 : 1)), l = this.maxHeight - Mi(t.grid) - e.padding - hl(t.title, this.chart.options.font), c = Math.sqrt(d * d + u * u), r = ar(Math.min(Math.asin(at((h.highest.height + 6) / a, -1, 1)), Math.asin(at(l / c, -1, 1)) - Math.asin(at(u / c, -1, 1)))), r = Math.max(n, Math.min(o, r))), this.labelRotation = r;
	}
	...
	_computeLabelSizes(t, e, s) {
		...
		for (d = 0; d < e; d += l) {
			if (p = t[d].label, g = this._resolveTickFontOptions(d), n.font = m = g.string, b = o[m] = o[m] || {
				data: {},
				gc: []
			}, y = g.lineHeight, x = w = 0, !D(p) && !X(p)) x = un(n, b.data, b.gc, x, p), w = y;
			else if (X(p)) for (u = 0, f = p.length; u < f; ++u) _ = p[u], !D(_) && !X(_) && (x = un(n, b.data, b.gc, x, _), w += y);
	...
	_computeGridLineItems(t) {
		...
		if (r === "top") y = b(this.bottom), k = this.bottom - u, E = y - m, $ = b(t.top) + m, Q = t.bottom;
		else if (r === "bottom") y = b(this.top), $ = t.top, Q = b(t.bottom) - m, k = y + m, E = this.top + u;
		else if (r === "left") y = b(this.right), S = this.right - u, M = y - m, P = b(t.left) + m, T = t.right;
		else if (r === "right") y = b(this.left), P = t.left, T = b(t.right) - m, S = y + m, M = this.left + u;
		else if (e === "x") {
	...
	_computeLabelItems(t) {
		...
		if (n === "top") S = this.bottom - p, k = this._getXAxisLabelAlignment();
		else if (n === "bottom") S = this.top + p, k = this._getXAxisLabelAlignment();
		else if (n === "left") {
...
function Eb(i) {
	...
	for (let o = 0; o < s.length; o++) e.push(Rt.getPlugin(s[o]));
	const n = i.plugins || [];
...
function Ib(i, t) {
	if (t.data && t.data.datasets) {
		...
		if (e.length) return ul(i, "x", e[0]) || ul(i, "y", e[0]);
	}
	return {};
}
function zb(i, t) {
	const e = Ue[i.type] || { scales: {} }, s = t.scales || {}, n = Po(i.type, t), o = /* @__PURE__ */ Object.create(null);
	return Object.keys(s).forEach((r) => {
		const a = s[r];
		if (!R(a)) return console.error(`Invalid scale configuration for scale: ${r}`);
		...
		o[r] = Bi(/* @__PURE__ */ Object.create(null), [
			{ axis: l },
			a,
			h[l],
			h[c]
		...
		Object.keys(h).forEach((d) => {
			...
			o[f] = o[f] || /* @__PURE__ */ Object.create(null), Bi(o[f], [
				{ axis: u },
				s[f],
				h[d]
			]);
...
var fl = /* @__PURE__ */ new Map(), Ah = /* @__PURE__ */ new Set();
function Es(i, t) {
	let e = fl.get(i);
...
var Fb = class {
	constructor(t) {
		this._config = Bb(t), this._scopeCache = /* @__PURE__ */ new Map(), this._resolverCache = /* @__PURE__ */ new Map();
	}
	get platform() {
	...
	datasetScopeKeys(t) {
		return Es(t, () => [[`datasets.${t}`, ""]]);
	}
	datasetAnimationScopeKeys(t, e) {
		return Es(`${t}.transition.${e}`, () => [[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]]);
	}
	...
	pluginScopeKeys(t) {
		...
		return Es(`${s}-plugin-${e}`, () => [[`plugins.${e}`, ...t.additionalOptionScopes || []]]);
	}
	_cachedScopes(t, e) {
	...
	resolveNamedOptions(t, e, s, n = [""]) {
		const o = { $shared: !0 }, { resolver: r, subPrefixes: a } = pl(this._resolverCache, t, n);
		let l = r;
		if (Hb(r, e)) {
...
function bl(i) {
	...
	t.notifyPlugins("afterRender"), W(e && e.onComplete, [i], t);
}
function Wb(i) {
	const t = i.chart, e = t.options.animation;
	W(e && e.onProgress, [i], t);
}
function Mh(i) {
...
var ss = (se = class {
	...
	constructor(t, e) {
		const s = this.config = new Fb(e), n = Mh(t), o = yl(n);
	...
	clear() {
		return Ba(this.canvas, this.ctx), this;
	}
	stop() {
	...
	_resize(t, e) {
		...
		this.width = r.width, this.height = r.height, this._aspectRatio = this.aspectRatio, Ha(this, a, !0) && (this.notifyPlugins("resize", { size: r }), W(s.onResize, [this, r], this), this.attached && this._doResize(l) && this.render());
	}
	ensureScalesHaveIDs() {
		N(this.options.scales || {}, (s, n) => {
			s.id = n;
		});
	}
	buildOrUpdateScales() {
	...
	buildOrUpdateControllers() {
		...
		for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
			...
			if (r.type && r.type !== a && (this._destroyDatasetMeta(s), r = this.getDatasetMeta(s)), r.type = a, r.indexAxis = o.indexAxis || Po(a, this.options), r.order = o.order || 0, r.index = s, r.label = "" + o.label, r.visible = this.isDatasetVisible(s), r.controller) r.controller.updateIndex(s), r.controller.linkScales();
			else {
	...
	update(t) {
		...
		r = this._minPadding = s.layout.autoPadding ? r : 0, this._updateLayout(r), n || N(o, (c) => {
			c.reset();
		}), this._updateDatasets(t), this.notifyPlugins("afterUpdate", { mode: t }), this._layers.sort(ml("z", "_idx"));
	...
	_checkEventBindings() {
		...
		(!Ea(new Set(Object.keys(this._listeners)), new Set(t.events)) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents());
	}
	_updateHiddenIndices() {
		const { _hiddenIndices: t } = this, e = this._getUniformDataChanges() || [];
		for (const { method: s, start: n, count: o } of e) Ub(t, n, s === "_removeElements" ? -o : o);
	}
	_getUniformDataChanges() {
		...
		for (let o = 1; o < e; o++) if (!Ea(n, s(o))) return;
	...
	_updateDatasets(t) {
		if (this.notifyPlugins("beforeDatasetsUpdate", {
			...
			for (let e = 0, s = this.data.datasets.length; e < s; ++e) this._updateDataset(e, ve(t) ? t({ datasetIndex: e }) : t);
	...
	render() {
		this.notifyPlugins("beforeRender", { cancelable: !0 }) !== !1 && (Nt.has(this) ? this.attached && !Nt.running(this) && Nt.start(this) : (this.draw(), bl({ chart: this })));
	}
	draw() {
		let t;
	...
	_updateVisibility(t, e, s) {
		...
		Ji(e) ? (o.data[e].hidden = !s, this.update()) : (this.setDatasetVisibility(t, s), r.update(o, { visible: s }), this.update((a) => a.datasetIndex === t ? n : void 0));
	}
	hide(t, e) {
	...
	destroy() {
		...
		this._stop(), this.config.clearCache(), t && (this.unbindEvents(), Ba(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete Xs[this.id], this.notifyPlugins("afterDestroy");
	}
	toBase64Image(...t) {
...
function Yb(i, t, e) {
	...
	if (i.beginPath(), i.arc(n, o, r - c / 2, s + d / 2, e - d / 2), a > 0) {
		...
		if (h === "round") i.arc(n, o, u, e - F / 2, s + F / 2, !0);
		else if (h === "bevel") {
...
function gn(i, t, e, s, n, o) {
	...
	const p = n - l;
	if (s) {
		const j = ((h > 0 ? h - s : 0) + (d > 0 ? d - s : 0)) / 2;
		f = (p - (j !== 0 ? p * j / (j + s) : p)) / 2;
	}
	const m = (p - Math.max(.001, p * d - e / F) / d) / 2, b = l + m + f, y = n - m - f, { outerStart: x, outerEnd: w, innerStart: _, innerEnd: S } = Kb(t, u, d, y - b), k = d - x, M = d - w, E = b + x / k, P = y - w / M, $ = u + _, T = u + S, Q = b + _ / $, Z = y - S / T;
	if (i.beginPath(), o) {
		const L = (E + P) / 2;
...
function Zb(i, t, e, s, n) {
	...
	p && Xb(i, t, g), l.selfJoin && g - r >= F && f === 0 && h !== "miter" && Yb(i, t, g), o || (gn(i, t, e, s, g, n), i.stroke());
}
var Je = class extends ee {
	...
	inRange(e, s, n) {
		const { angle: r, distance: a } = Xc(this.getProps(["x", "y"], n), {
			x: e,
			y: s
	...
	draw(e) {
		...
		if (this.pixelMargin = s.borderAlign === "inner" ? .33 : 0, this.fullCircles = n > G ? Math.floor(n / G) : 0, n === 0 || this.innerRadius < 0 || this.outerRadius < 0) return;
		e.save();
		const l = (this.startAngle + this.endAngle) / 2;
		e.translate(Math.cos(l) * o, Math.sin(l) * o);
		const h = o * (1 - Math.sin(Math.min(F, n || 0)));
...
A(Je, "id", "arc"), A(Je, "defaults", {
	...
	circular: !0,
	selfJoin: !1
}), A(Je, "defaultRoutes", { backgroundColor: "backgroundColor" }), A(Je, "descriptors", {
	_scriptable: !0,
...
function oy(i, t, e, s) {
	...
	for (const a of n) Ph(i, o, a.style), i.beginPath(), r(i, t, a, {
		start: e,
		end: e + s - 1
...
var le = class extends ee {
	...
	interpolate(t, e) {
		...
		for (c = 0, h = r.length; c < h; ++c) {
			...
			const m = l(f, p, Math.abs((n - f[e]) / (p[e] - f[e])), s.stepped);
			m[e] = t[e], a.push(m);
		}
...
var Vi = class extends ee {
	...
	draw(e, s) {
		...
		this.skip || n.radius < .1 || !Xt(this, s, this.size(n) / 2) || (e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth, e.fillStyle = n.backgroundColor, Ao(e, n, this.x, this.y));
	}
	getRange() {
...
function cy(i, t, e) {
	const { enableBorderRadius: s } = i.getProps(["enableBorderRadius"]), n = i.options.borderRadius, o = ze(n), r = Math.min(t, e), a = i.borderSkipped, l = s || R(n);
	return {
...
function _y(i, t, e, s, n) {
	...
	for (r[l++] = i[h], d = 0; d < o - 2; d++) {
		...
		for (y = x; y < w; y++) m += i[y].x, b += i[y].y;
		m /= _, b /= _;
		const S = Math.floor(d * a) + 1 + t, k = Math.min(Math.floor((d + 1) * a) + 1, e) + t, { x: M, y: E } = i[h];
		for (f = p = -1, y = S; y < k; y++) p = .5 * Math.abs((M - m) * (i[y].y - E) - (M - i[y].x) * (b - E)), p > f && (f = p, u = i[y], g = y);
		r[l++] = u, h = g;
	}
	return r[l++] = i[c], r;
}
function wy(i, t, e, s) {
	...
	for (r = t; r < t + e; ++r) {
		...
		const _ = l | 0;
		if (_ === h) c < p ? (p = c, d = r) : c > g && (g = c, u = r), n = (o * n + a.x) / ++o;
		else {
			const S = r - 1;
			if (!D(d) && !D(u)) {
...
var ky = {
	...
	beforeElementsUpdate: (i, t, e) => {
		...
		i.data.datasets.forEach((n, o) => {
			...
			if (Y([a, i.options.indexAxis]) === "y" || !l.controller.supportsDecimation) return;
...
function Cy(i, t, e) {
	...
	for (const a of s) {
		...
		for (const u of d) {
			...
			for (const g of p) r.push({
				source: g,
				target: u,
				start: { [e]: kl(h, f, "start", Math.max) },
				end: { [e]: kl(h, f, "end", Math.min) }
			});
		}
	}
	return r;
...
function Py(i, t, e) {
	const s = Dy(i);
	if (R(s)) return isNaN(s.value) ? !1 : s;
	let n = parseFloat(s);
...
function Ty(i) {
	...
	for (let l = 0; l < o.length; l++) {
		const c = o[l];
		for (let h = c.start; h <= c.end; h++) Ly(n, r[h], a);
	}
	return new le({
		points: n,
		options: {}
...
function zy(i) {
	...
	if (et(e)) return By(t, e);
	if (e === "stack") return Ty(i);
	if (e === "shape") return !0;
	const n = Fy(i);
...
function oo(i, t, e) {
	const s = zy(t), { chart: n, index: o, line: r, scale: a, axis: l } = t, c = r.options, h = c.fill, d = c.backgroundColor, { above: u = d, below: f = d } = h || {}, g = gh(n, n.getDatasetMeta(o));
...
var Wy = {
	...
	afterDatasetsUpdate(i, t, e) {
		...
		let o, r, a, l;
		for (r = 0; r < s; ++r) o = i.getDatasetMeta(r), a = o.dataset, l = null, a && a.options && a instanceof le && (l = {
		...
		for (r = 0; r < s; ++r) l = n[r], !(!l || l.fill === !1) && (l.fill = My(n, r, e.propagate));
	},
	beforeDraw(i, t, e) {
...
var $l = class extends ee {
	...
	adjustHitBoxes() {
		...
		if (this.isHorizontal()) {
			...
			for (const c of e) a !== c.row && (a = c.row, l = ct(s, this.left + n, this.right - this.lineWidths[a])), c.top += this.top + t + n, c.left = r.leftForLtr(r.x(l), c.width), l += c.width + n;
		} else {
			let a = 0, l = ct(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
			for (const c of e) c.col !== a && (a = c.col, l = ct(s, this.top + t + n, this.bottom - this.columnSizes[a].height)), c.top = l, c.left += this.left + n, c.left = r.leftForLtr(r.x(c.left), c.width), l += c.height + n;
		}
	}
	isHorizontal() {
	...
	_draw() {
		...
		const { boxWidth: p, boxHeight: g, itemHeight: m } = El(r, d), b = function(S, k, M) {
			...
			if (n.fillStyle = O(M.fillStyle, a), n.lineCap = O(M.lineCap, "butt"), n.lineDashOffset = O(M.lineDashOffset, 0), n.lineJoin = O(M.lineJoin, "miter"), n.lineWidth = E, n.strokeStyle = O(M.strokeStyle, a), n.setLineDash(O(M.lineDash, [])), r.usePointStyle) ih(n, {
				radius: g * Math.SQRT2 / 2,
				pointStyle: M.pointStyle,
				rotation: M.rotation,
				borderWidth: E
			}, l.xPlus(S, p / 2), k + u, r.pointStyleWidth && p);
			else {
		...
		this.legendItems.forEach((S, k) => {
			...
			if (b(l.x($), T, S), $ = dg(E, $ + p + u, x ? $ + P : this.right, t.rtl), y(l.x($), T, S), x) f.x += P + h;
	...
	drawTitle() {
		...
		if (this.isHorizontal()) u = Math.max(...this.lineWidths), h = this.top + c, d = ct(t.align, d, this.right - u);
		else {
	...
	_getLegendItemAt(t, e) {
		...
		if (qt(t, this.left, this.right) && qt(e, this.top, this.bottom)) {
			for (o = this.legendHitBoxes, s = 0; s < o.length; ++s) if (n = o[s], qt(t, n.left, n.left + n.width) && qt(e, n.top, n.top + n.height)) return this.legendItems[s];
		}
		return null;
	}
	handleEvent(t) {
		const e = this.options;
		if (!Gy(t.type, e)) return;
...
function qy(i, t, e, s, n) {
	return {
		itemWidth: Yy(s, i, t, e),
		itemHeight: Xy(n, s, t.lineHeight)
	};
}
function Yy(i, t, e, s) {
	let n = i.text;
...
var yr = class extends ee {
	...
	_drawArgs(t) {
		...
		let l = 0, c, h, d;
		return this.isHorizontal() ? (h = ct(a, s, o), d = e + t, c = o - s) : (r.position === "left" ? (h = s + t, d = ct(a, n, e), l = F * -.5) : (h = o - t, d = ct(a, e, n), l = F * .5), c = n - e), {
			titleX: h,
			titleY: d,
			maxWidth: c,
			rotation: l
...
var Il = (lo = class extends ee {
	...
	_createItems(t) {
		...
		let a = [], l, c;
		for (l = 0, c = e.length; l < c; ++l) a.push(tv(this.chart, e[l]));
	...
	drawTitle(t, e, s) {
		...
		if (o) {
			...
			for (t.x = Os(this, s.titleAlign, s), e.textAlign = c.textAlign(s.titleAlign), e.textBaseline = "middle", r = nt(s.titleFont), a = s.titleSpacing, e.fillStyle = s.titleColor, e.font = r.string, l = 0; l < o; ++l) e.fillText(n[l], c.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + a, l + 1 === o && (t.y += s.titleMarginBottom - a);
		}
	}
	...
	drawBody(t, e, s) {
		...
		for (e.textAlign = r, e.textBaseline = "middle", e.font = d.string, t.x = Os(this, m, s), e.fillStyle = s.bodyColor, N(this.beforeBody, g), f = a && m !== "right" ? r === "center" ? c / 2 + h : c + 2 + h : 0, w = 0, S = n.length; w < S; ++w) {
			for (b = n[w], y = this.labelTextColors[w], e.fillStyle = y, N(b.before, g), x = b.lines, a && x.length && (this._drawColorBox(e, t, w, p, s), u = Math.max(d.lineHeight, l)), _ = 0, k = x.length; _ < k; ++_) g(x[_]), u = d.lineHeight;
			N(b.after, g);
		}
	...
	drawFooter(t, e, s) {
		...
		if (o) {
			...
			for (t.x = Os(this, s.footerAlign, s), t.y += s.footerMarginTop, e.textAlign = l.textAlign(s.footerAlign), e.textBaseline = "middle", r = nt(s.footerFont), e.fillStyle = s.footerColor, e.font = r.string, a = 0; a < o; ++a) e.fillText(n[a], l.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + s.footerSpacing;
		}
	}
...
A(To, "id", "category"), A(To, "defaults", { ticks: { callback: zl } });
function uv(i, t) {
	...
	if (_ < 1e-14 && !b && !y) return [{ value: g }, { value: m }];
	E = Math.ceil(m / _) - Math.floor(g / _), E > p && (_ = Oa(E * _ / p / f) * f), D(l) || (S = Math.pow(10, l), _ = Math.ceil(_ * S) / S), n === "ticks" ? (k = Math.floor(g / _) * _, M = Math.ceil(m / _) * _) : (k = g, M = m), b && y && o && ng((a - r) / o, _ / 1e3) ? (E = Math.round(Math.min((a - r) / _, h)), _ = (a - r) / E, k = r, M = a) : x ? (k = b ? r : k, M = y ? a : M, E = c - 1, _ = (M - k) / E) : (E = (M - k) / _, Fi(E, Math.round(E), _ / 1e3) ? E = Math.round(E) : E = Math.ceil(E));
	const P = Math.max(Da(_), Da(k));
	S = Math.pow(10, D(l) ? P : l), k = Math.round(k * S) / S, M = Math.round(M * S) / S;
	let $ = 0;
	for (b && (u && k !== r ? (e.push({ value: r }), k < r && $++, Fi(Math.round((k + $ * _) * S) / S, r, Bl(r, w, i)) && $++) : k < r && $++); $ < E; ++$) {
		const T = Math.round((k + $ * _) * S) / S;
		if (y && T > a) break;
		e.push({ value: T });
	}
	return y && u && M !== a ? e.length && Fi(e[e.length - 1].value, a, Bl(a, w, i)) ? e[e.length - 1].value = a : e.push({ value: a }) : (!y || M === a) && e.push({ value: M }), e;
}
function Bl(i, t, { horizontal: e, minRotation: s }) {
	const n = Mt(s), o = (e ? Math.sin(n) : Math.cos(n)) || .001, r = .75 * t * ("" + i).length;
...
var Ro = class extends mn {
	...
	computeTickLimit() {
		const t = this.isHorizontal(), e = t ? this.width : this.height, s = Mt(this.options.ticks.minRotation), n = (t ? Math.sin(s) : Math.cos(s)) || .001, o = this._resolveTickFontOptions(0);
...
A(Ro, "id", "linear"), A(Ro, "defaults", { ticks: { callback: On.formatters.numeric } });
var ns = (i) => Math.floor(re(i)), Oe = (i, t) => Math.pow(10, ns(i) + t);
function Fl(i) {
...
var Lo = class extends Xe {
	...
	parse(t, e) {
		const s = mn.prototype.parse.apply(this, [t, e]);
		if (s === 0) {
			this._zero = !0;
			return;
		}
...
A(Lo, "id", "logarithmic"), A(Lo, "defaults", { ticks: {
...
function mv(i) {
	...
	for (let l = 0; l < o; l++) {
		...
		s[l] = u;
		const f = ht(i.getIndexAngle(l) + a), p = Math.round(ar(f));
		bv(e, t, f, Hl(p, h.x, u.w, 0, 180), Hl(p, h.y, u.h, 90, 270));
	}
...
function Av(i, t, e, s, n) {
	...
	!r && !s || !a || !l || e < 0 || (o.save(), o.strokeStyle = a, o.lineWidth = l, o.setLineDash(n.dash || []), o.lineDashOffset = n.dashOffset, o.beginPath(), Bh(i, e, r, s), o.closePath(), o.stroke(), o.restore());
}
function Mv(i, t, e) {
	return Se(i, {
		label: e,
...
var Ti = class extends mn {
	...
	generateTickLabels(t) {
		mn.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map((e, s) => {
			const n = W(this.options.pointLabels.callback, [e, s], this);
			return n || n === 0 ? n : "";
	...
	drawBackground() {
		...
		if (t) {
			const s = this.ctx;
			s.save(), s.beginPath(), Bh(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), s.closePath(), s.fillStyle = t, s.fill(), s.restore();
		}
	}
	drawGrid() {
...
A(Ti, "id", "radialLinear"), A(Ti, "defaults", {
	...
	"ticks.color": "color"
}), A(Ti, "descriptors", { angleLines: { _fallback: "grid" } });
var zn = {
	millisecond: {
		common: !0,
		size: 1,
...
function Wl(i, t, e, s) {
	...
	for (let o = yt.indexOf(i); o < n - 1; ++o) {
		...
		if (r.common && Math.ceil((e - t) / (a * r.size)) <= s) return yt[o];
	}
	return yt[n - 1];
}
function Pv(i, t, e, s, n) {
	for (let o = yt.length - 1; o >= yt.indexOf(e); o--) {
		const r = yt[o];
		if (zn[r].common && i._adapter.diff(n, s, r) >= t - 1) return r;
	}
	return yt[e ? yt.indexOf(e) : 0];
}
function Ev(i) {
	for (let t = yt.indexOf(i) + 1, e = yt.length; t < e; ++t) if (zn[yt[t]].common) return yt[t];
}
function Ul(i, t, e) {
	if (!e) i[t] = !0;
	else if (e.length) {
...
var os = class extends Xe {
	...
	init(t, e = {}) {
		const s = t.time || (t.time = {}), n = this._adapter = new Bm._date(t.adapters.date);
		n.init(e), Bi(s.displayFormats, n.formats()), this._parseOpts = {
			parser: s.parser,
			round: s.round,
	...
	_generate() {
		...
		for (u = d, f = 0; u < s; u = +t.add(u, a, r), f++) Ul(h, u, p);
	...
	_getLabelCapacity(t) {
		const e = this.options.time, s = e.displayFormats, n = s[e.unit] || s.millisecond, o = this._tickFormatFunction(t, 0, ql(this, [t], this._majorUnit), n), r = this._getLabelSize(o), a = Math.floor(this.isHorizontal() ? this.width / r.w : this.height / r.h) - 1;
		return a > 0 ? a : 1;
	}
	getDataTimestamps() {
	...
	getLabelTimestamps() {
		...
		for (e = 0, s = n.length; e < s; ++e) t.push(Vl(this, n[e]));
...
var Rv = 0, Fh = 1, jh = 2, Hh = 4, Nh = 8;
function Ts(i, t, e) {
	var s = Rv;
	return i < e.left ? s |= Fh : i > e.right && (s |= jh), t < e.top ? s |= Nh : t > e.bottom && (s |= Hh), s;
}
function Lv(i, t) {
	for (var e = i.x0, s = i.y0, n = i.x1, o = i.y1, r = Ts(e, s, t), a = Ts(n, o, t), l, c, h; !(!(r | a) || r & a);) l = r || a, l & Nh ? (c = e + (n - e) * (t.top - s) / (o - s), h = t.top) : l & Hh ? (c = e + (n - e) * (t.bottom - s) / (o - s), h = t.bottom) : l & jh ? (h = s + (o - s) * (t.right - e) / (n - e), c = t.right) : l & Fh && (h = s + (o - s) * (t.left - e) / (n - e), c = t.left), l === r ? (e = c, s = h, r = Ts(e, s, t)) : (n = c, o = h, a = Ts(n, o, t));
	return {
		x0: e,
		x1: n,
		y0: s,
...
function jv(i, t, e) {
	...
	!s && (!n || !o) || (i.beginPath(), Fv(i, Gt(t.x) + o / 2, Gt(t.y) + o / 2, Gt(t.w) - o, Gt(t.h) - o, e.borderRadius), i.closePath(), s && (i.fillStyle = s, i.fill()), n && o && (i.strokeStyle = n, i.lineWidth = o, i.lineJoin = "miter", i.stroke()));
}
function Hv(i, t, e) {
...
function Vv(i, t, e, s) {
	...
	if (!(!l || !r && !d)) for (e = Hv(e, n, a), i.font = a.string, i.textAlign = n, i.textBaseline = "middle", i.shadowBlur = s.textShadowBlur, i.shadowColor = s.textShadowColor, r && (i.fillStyle = o), d && (i.lineJoin = "round", i.lineWidth = h, i.strokeStyle = c), u = 0, l = t.length; u < l; ++u) Nv(i, t[u], {
		stroked: d,
		filled: r,
		w: e.w,
		x: e.x,
...
jt(Vh.prototype, {
	...
	draw: function(i, t) {
		...
		this.visible() && (s.save(), n.clip && (r = n.area, s.beginPath(), s.rect(r.left, r.top, r.right - r.left, r.bottom - r.top), s.clip()), s.globalAlpha = Ui.bound(0, n.opacity, 1), s.translate(Gt(t.x), Gt(t.y)), s.rotate(n.rotation), jv(s, o.frame, n), Vv(s, n.lines, o.text, n), s.restore());
	}
});
...
jt(Wh.prototype, {
	...
	intersects: function(i) {
		var t = this._points(), e = i._points(), s = [Is(t[0], t[1]), Is(t[0], t[3])], n, o, r;
		for (this._rotation !== i._rotation && s.push(Is(e[0], e[1]), Is(e[0], e[3])), n = 0; n < s.length; ++n) if (o = Xl(t, s[n]), r = Xl(e, s[n]), o.max < r.min || r.max < o.min) return !1;
		return !0;
	},
	_points: function() {
...
function Yv(i) {
	var t, e, s, n, o, r, a;
	for (t = 0, e = i.length; t < e; ++t) s = i[t], n = s.$layout, n._visible && (a = new Proxy(s._el, { get: (l, c) => l.getProps([c], !0)[c] }), o = s.geometry(), r = Uh(a, s.model(), o), n._box.update(r, o, s.rotation()));
...
var qi = {
	...
	draw: function(i, t) {
		var e, s, n, o, r, a;
		for (e = 0, s = t.length; e < s; ++e) n = t[e], o = n.$layout, o._visible && (r = n.geometry(), a = Uh(n._el, n.model(), r), o._box.update(a, r, n.rotation()), n.draw(i, a));
	}
}, Xv = function(i) {
	if (D(i)) return null;
	var t = i, e, s, n;
	if (R(i)) if (!D(i.label)) t = i.label;
	else if (!D(i.r)) t = i.r;
...
function Zv(i, t) {
	...
	if (!(!s.enter && !s.leave)) {
		if (t.type === "mousemove") o = qi.lookup(e._labels, t);
...
var t0 = {
	...
	afterDatasetUpdate: function(i, t, e) {
		...
		for (h.save(), d = 0, f = c.length; d < f; ++d) if (b = c[d], b[bt] = [], r && b && i.getDataVisibility(d) && !b.skip) for (u = 0, p = l.labels.length; u < p; ++u) g = l.labels[u], m = g._key, y = new Vh(g, h, b, d), y.$groups = {
			_set: s,
			_key: m || qh
		}, y.$context = {
			active: !1,
		...
		h.restore(), jt(n._listeners, l.listeners, { merger: function(x, w, _) {
	...
	afterEvent: function(i) {
		...
		for (o = 0, r = n.length; o < r; ++o) if (c = n[o], c[1]) for (d = c[0].element[bt] || [], a = 0, l = d.length; a < l; ++a) h = d[a], h.$context.active = c[1] === 1, h.update(h.$context);
...
var Nr = class Nr extends B {
	...
	updated(t) {
		...
		if (t.has("type") || t.has("indexAxis") || t.has("linePointStyle") || t.has("pointRadius") || t.has("lineFill")) {
			...
			this.label !== void 0 && (o.plugins || (o.plugins = {}), o.plugins.title = {
				text: this.label,
				display: !0
			}), this.indexAxis !== void 0 && (o.indexAxis = this.indexAxis), this.chart = new ss(this._canvas, {
				type: this.type,
	...
	*/
	...
	firstUpdated() {
		this.chart = new ss(this._canvas, this._chartCfg);
...
Nr.styles = H`
  ...
  `;
var J = Nr;
st([v({ type: Array })], J.prototype, "colors");
st([v({
	type: String,
	reflect: !0
})], J.prototype, "type");
...
st([te()], J.prototype, "_errorLoading");
var s0 = Object.defineProperty, vr = (i, t, e, s) => {
	for (var n = void 0, o = i.length - 1, r; o >= 0; o--) (r = i[o]) && (n = r(t, e, n) || n);
	return n && s0(t, e, n), n;
}, rt;
var Bn = (rt = class extends B {
	constructor() {
...
vr([v({
	type: Boolean,
	reflect: !0
})], Bn.prototype, "visible");
vr([v({
	type: Number,
	reflect: !0
})], Bn.prototype, "timeout");
vr([v({
	type: String,
	reflect: !0
})], Bn.prototype, "placement");
var n0 = Bn;
//#endregion
export { wf as Button, J as Chart, ln as ChartLegend, pe as Checkbox, Ft as ColorInput, ci as Component, Hs as ContextMenu, vt as Dropdown, Ne as Grid, xo as Icon, Ve as Input, bi as Label, li as Manager, pt as NumberInput, tt as Option, Jt as Panel, ge as PanelSection, me as Selector, ft as Tab, er as Table, on as TableCell, wo as TableChildren, rn as TableGroup, We as TableRow, Et as Tabs, xt as TextInput, di as Toolbar, hi as ToolbarGroup, be as ToolbarSection, n0 as Tooltip, an as Viewport, zf as calculateDividerStyles, Rf as calculateHorizontalResize, Tf as calculateVerticalResize, Df as deduplicateDividerAreas, Of as detectDividers, $f as extractUniqueAreas, nn as getElementValue, C as html, e0 as loadingSkeleton, Ef as parseGridTemplate, Bt as ref, vo as styleMap, If as validateHorizontalResize, Lf as validateVerticalResize };
